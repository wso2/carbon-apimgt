...
class SingleClient {
     ...
     */
    _fixSpec(spec) {
        spec.host = window.location.host; //TODO: Set hostname according to the APIM environment selected by user
        return spec;
    }
    ...
    _getSwaggerURL() {
        ...
        return window.location.protocol + "//" + window.location.host + "/api/am/admin_new/v1.0/apis/swagger.yaml";
    }
}
