...
function Delete(props) {
    ...
    const {
        dataRow, subscriptionThrottlingPolicyList, updateList,
    } = props;
...
Delete.propTypes = {
    ...
    subscriptionThrottlingPolicyList: PropTypes.shape({
        subscriptionThrottlingPolicyList: PropTypes.array.isRequired,
    }).isRequired,
};
