...
ConfigManager.ConfigRequestPaths = {
    ENVIRONMENT_CONFIG_PATH: '/store/site/public/theme/temporary_environments_config.json',
    FEATURE_LIST_PATH: '/store/site/public/theme/temporary_features_config.json',
};
