...
class Details extends React.Component {
    ...
    handleMenuSelect = (menuLink) => {
        this.props.history.push({pathname: "/api-products/" + this.props.match.params.api_uuid + "/" + menuLink});
  ...
  render() {
    ...
    let redirect_url = "/api-products/" + this.props.match.params.api_uuid + "/overview";
        ...
        <ApiContext.Provider value={this.state}>
            <style>
             ...
             <div className={classes.LeftMenu}>
                <Link to={"/api-products"} className={classes.leftLInkMainWrapper}>
                    <div className={classes.leftLInkMain}>
                        <CustomIcon width={leftMenuIconMainSize} height={leftMenuIconMainSize} icon="api" />
                        <Typography className={classes.leftLInkMainText}>ALL API Products</Typography>
                    </div>
                </Link>
