...
class BasicInfo extends Component {
    ...
    componentDidMount() {
        ...
        let promised_apiproduct = apiproduct.getAPIProductById(this.api_uuid);
        promised_apiapiproduct.then(
            response => {
        ...
        let promised_applications =apiproduct.getAllApplications();
        ...
        let promised_subscriptions = apiproduct.getSubscriptions(this.api_uuid, null);
