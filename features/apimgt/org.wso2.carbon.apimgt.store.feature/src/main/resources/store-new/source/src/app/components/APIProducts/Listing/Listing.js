...
import ApiProductThumb from './ApiProductThumb';
...
class Listing extends React.Component {
    ...
    componentDidMount() {
        let api_product = new APIProduct();
        let promised_apis_products = api_product.getAllAPIPProducts();
        promised_apis_products.then((response) => {
                ...
                <div className={classes.root}>
                    ...
                    <div className={classes.mainTitleWrapper}>
                        ...
                        <Typography variant="caption" gutterBottom align="left">
                             Displaying {this.state.apis.count} API Products
                        </Typography>
                        }
                    </div>
                            ...
                            this.state.apis ?
                                this.state.listType === "grid" ?
                                    <Grid container className={classes.ListingWrapper} >
                                        {this.state.apis.list.map(api => <ApiProductThumb api={api} key={api.id} />)}
                                    </Grid>
                                    :
                                    <Table>
