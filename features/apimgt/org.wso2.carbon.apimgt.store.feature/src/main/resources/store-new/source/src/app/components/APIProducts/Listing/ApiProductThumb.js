...
class ApiProductThumb extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            active: true,
    ...
    render() {
        let details_link = "/api-products/" + this.props.api.id;
        const {api, classes} = this.props;
        const {name, provider, description} = this.props.api;
...
ApiProductThumb.propTypes = {
    classes: PropTypes.object.isRequired,
    theme: PropTypes.object.isRequired,
};

export default withStyles(styles, { withTheme: true })(ApiProductThumb);
