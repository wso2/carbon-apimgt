...
class InfoBar extends React.Component {
  ...
  componentDidMount() {
    ...
    // Get application
    let promised_application = client.getApplication(this.applicationId);
          ...
          <div className={classes.infoContent}>
            <div className={classes.contentWrapper}>
              <div className={classes.topBar}>
                <div className={classes.infoItem}>
                  <Typography variant="subheading" gutterBottom>
                    {application.throttlingTier} <Typography variant="caption">( {this.state.tierDescription} )</Typography>
                  </Typography>
                  <Typography variant="caption" gutterBottom align="left">
                    Throttling Tier 
                  </Typography>
                ...
                <div className={classes.infoItem}>
                  {application.lifeCycleStatus === "APPROVED" ?
                      <CheckCircle /> 
                      :
                      <Typography variant="subheading" gutterBottom>{this.state.lifeCycleStatus}</Typography> 
                  }
                  <Typography variant="caption" gutterBottom align="left">
                    lifeCycleStatus
                  </Typography>
              ...
              <Typography>
                ...
                ultricies. Mauris vehicula mollis vulputate. Morbi sed velit
                vulputate nisl ullamcorper blandit. Quisque diam orci, ultrices
                at risus vel, auctor vulputate odio. Etiam vel iaculis massa,
