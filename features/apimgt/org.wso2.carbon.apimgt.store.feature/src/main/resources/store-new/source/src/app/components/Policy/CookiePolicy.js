...
const cookieDetails = [
    {name:"JSESSIONID",purpose:"Keeps track of the user session data when you are logged in for providing a better user experience",
    retention:"Session"},
    {name:"goto_url",purpose:"Keeps track of the page that you should be directed to after login", retention: "Session"},
    {name:"workflowCookie",purpose:"Used for authentication purposes when invoking an admin service in the Business Process Server",
    retention:"Session"},
    {name:"csrftoken",purpose:"Used for mitigating Cross Site Request Forgery Attacks to provide you with a secure service",
    retention:"Request"},
    {name:"i18next",purpose:"Used to track the language API-M is served to you",retention:"Session"}
];
