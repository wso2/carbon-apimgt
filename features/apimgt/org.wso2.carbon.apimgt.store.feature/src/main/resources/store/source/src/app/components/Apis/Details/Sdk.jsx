                            ...
                            (language, index) => index < 3 && (
                                <Grid item xs={4}>
                                    <a onClick={event => this.handleClick(event, language)} style={{ cursor: 'pointer' }}>
                                        <img alt={language} src={'/store/public/app/images/sdks/' + new String(language) + '.svg'} style={{ width: 80, height: 80, margin: 15 }} />
                                    </a>
                                </Grid>
                            ),
                        )}
                            ...
                            <Grid key={index} item>
                                <div style={{ width: 'auto', textAlign: 'center' }}>
                                    <Card>
                                        ...
                                        <Divider />
                                        <CardMedia title={language.toString().toUpperCase()} src={'/store/public/app/images/sdks/' + new String(language) + '.svg'}>
