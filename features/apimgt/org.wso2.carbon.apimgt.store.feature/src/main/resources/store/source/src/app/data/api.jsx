...
export default class API extends Resource {
    ...
    getFileForDocument(api_id, docId) {
        const promised_getDocContent = this.client.then((client) => {
            ...
            return client.apis['API (Individual)'].get_apis__apiId__documents__documentId__content(payload, this._requestMetaData({ 'Content-Type': 'multipart/form-data' }));
        });
    ...
    getAllTiers(tierLevel, callback = null) {
        const promise_get_all = this.client.then((client) => {
            return client.apis['Tier (Collection)'].get_policies__tierLevel_({ tierLevel }, this._requestMetaData());
        });
        if (callback) {
            return promise_get_all.then(callback);
        } else {
    ...
    createApplication(application, callback = null) {
        const promise_create = this.client.then((client) => {
            const payload = { body: application };
            return client.apis['Application (Individual)'].post_applications(payload, { 'Content-Type': 'application/json' });
        });
        if (callback) {
    ...
    updateApplication(application, callback = null) {
        const promise_get = this.client.then((client) => {
            ...
            return client.apis['Application (Individual)'].put_applications__applicationId_(payload, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
    ...
    addComment(apiId, commentInfo, callback = null) {
        const promise = this.client
            .then((client) => {
                return client.apis['Comment (Individual)'].post_apis__apiId__comments({ apiId, body: commentInfo }, this._requestMetaData());
            })
            .catch((error) => {
                console.error(error);
            });
    ...
    deleteComment(apiId, commentId, callback = null) {
        const promise = this.client
            .then((client) => {
                return client.apis['Comment (Individual)'].delete_apis__apiId__comments__commentId_({ apiId, commentId }, this._requestMetaData());
            })
            .catch((error) => {
                console.error(error);
            });
    ...
    updateComment(apiId, commentId, commentInfo, callback = null) {
        const promise = this.client
            .then((client) => {
                return client.apis['Comment (Individual)'].put_apis__apiId__comments__commentId_({ apiId, commentId, body: commentInfo }, this._requestMetaData());
            })
            .catch((error) => {
                console.error(error);
            });
    ...
    getRatingFromUser(api_id, callback = null) {
        const promise_get = this.client
            .then((client) => {
                return client.apis['API (Individual)'].get_apis__apiId__ratings({ apiId: api_id }, this._requestMetaData());
            })
            .catch((error) => {
                console.error(error);
            });
    ...
    addRating(api_id, ratingInfo, callback = null) {
        const promise = this.client
            .then((client) => {
                return client.apis['API (Individual)'].put_apis__apiId__user_rating({ apiId: api_id, body: ratingInfo }, this._requestMetaData());
            })
            .catch((error) => {
    ...
    generateKeys(applicationId, request_content, callback = null) {
        const promise_get = this.client.then((client) => {
            ...
            return client.apis['Application (Individual)'].post_applications__applicationId__generate_keys(payload, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
    ...
    generateToken(applicationId, request_content, callback = null) {
        const promise_get = this.client.then((client) => {
            const payload = { applicationId, body: request_content };
            return client.apis['Application (Individual)'].post_applications__applicationId__generate_token(payload, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
    ...
    getKeys(applicationId, callback = null) {
        const promise_get = this.client.then((client) => {
            return client.apis['Application (Individual)'].get_applications__applicationId__keys({ applicationId }, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
    ...
    getSubscriptions(apiId, applicationId, callback = null) {
        const promise_get = this.client.then((client) => {
            return client.apis['Subscription (Collection)'].get_subscriptions({ apiId, applicationId }, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
    ...
    subscribe(apiId, applicationId, policy, callback = null) {
        const promise_create_subscription = this.client.then((client) => {
            const subscriptionData = { apiIdentifier: apiId, applicationId, policy };
            const payload = { body: subscriptionData };
            return client.apis['Subscription (Individual)'].post_subscriptions(payload, { 'Content-Type': 'application/json' });
        });
        if (callback) {
     ...
     */
    getSdkLanguages() {
        const promise_languages = this.client.then((client) => {
    ...
    getSdk(apiId, language) {
        ...
        const promise_sdk = this.client.then((client) => {
    ...
    getTierByName(name, level, callback = null) {
        const promise_get = this.client.then((client) => {
            return client.apis['Tier (Individual)'].get_policies__tierLevel___tierName_({ tierName: name, tierLevel: level }, this._requestMetaData());
        });
        if (callback) {
            return promise_get.then(callback);
        } else {
