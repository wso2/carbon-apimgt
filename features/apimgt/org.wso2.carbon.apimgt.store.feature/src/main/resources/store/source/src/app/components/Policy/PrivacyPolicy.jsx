            ...
            <div>
                    ...
                    <AppBar position='absolute'>
                        <ToolBar>
                            <Typography variant='title' noWrap>
                                <img src='/store/public/app/images/logo.png' alt='wso2-logo' />
                ...
                <Grid container spacing={24}>
                        ...
                        <MenuList>
                            ...
                            <MenuItem>
                                ...
                                <a style={{ textDecoration: 'none' }} href='#storageOfInfo'>
                                    How API-M keeps your information
                                </a>
                            </MenuItem>
                            <MenuItem>
                                <ListItemIcon>
                    ...
                    <Grid item xs={8}>
                        ...
                        <p>API-M considers anything related to you as your personal information. This includes, but is not limited to, However API-M does not consider the following as your personal information, and uses this only for analytical purposes, since this information cannot be used to track you.</p>
                        <ul>
