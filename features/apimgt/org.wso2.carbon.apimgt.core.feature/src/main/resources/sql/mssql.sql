...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_PRODUCT]') AND TYPE IN (N'U'))

CREATE TABLE AM_API_PRODUCT (
	API_PRODUCT_ID INTEGER IDENTITY(1,1),
...
CREATE TABLE AM_SUBSCRIPTION (
    ...
    FOREIGN KEY(API_PRODUCT_ID) REFERENCES AM_API_PRODUCT(API_PRODUCT_ID) ON UPDATE CASCADE,
