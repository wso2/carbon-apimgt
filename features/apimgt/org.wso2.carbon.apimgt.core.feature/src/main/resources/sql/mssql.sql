...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_PLATFORM_GATEWAY]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_PLATFORM_GATEWAY_TOKEN]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_PLATFORM_GATEWAY_API_ARTIFACT]') AND TYPE IN (N'U'))
