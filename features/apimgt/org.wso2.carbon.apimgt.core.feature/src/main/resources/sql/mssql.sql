...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_DEVPORTAL_TEMPLATE]') AND type IN (N'U'))
CREATE TABLE GOV_DEVPORTAL_TEMPLATE (
    TEMPLATE_ID VARCHAR(36) NOT NULL,
    NAME VARCHAR(256) NOT NULL,
    DESCRIPTION VARCHAR(1024),
    FORM_CONFIG VARCHAR(MAX) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_TEMPLATE_RULESET_BINDING]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_TEMPLATE_RULESET_KM_SCOPE]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_APP_GOVERNANCE_SNAPSHOT]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_APP_RULESET_SNAPSHOT]') AND type IN (N'U'))
CREATE TABLE GOV_APP_RULESET_SNAPSHOT (
    ...
    YAML_CONTENT VARCHAR(MAX) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[GOV_APP_RULE_SNAP_KM_SCOPE]') AND type IN (N'U'))
