...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_THROTTLE_LIMIT]') AND TYPE IN (N'U'))

CREATE TABLE AM_API_THROTTLE_LIMIT (
    API_UUID VARCHAR(256),
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_REVISION_THROTTLE_LIMIT]') AND TYPE IN (N'U'))

CREATE TABLE AM_API_REVISION_THROTTLE_LIMIT (
  API_UUID VARCHAR(64),
  REVISION_UUID VARCHAR(255),
