...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_OPERATION_POLICY_TEMPLATES]') AND TYPE IN (N'U'))
CREATE TABLE IF NOT EXISTS AM_OPERATION_POLICY_TEMPLATES (
    TEMPLATE_ID INTEGER IDENTITY(1,1),
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_OPERATION_POLICY_DEFINITIONS]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_RESOURCE_ENDPOINTS]') AND TYPE IN (N'U'))
CREATE TABLE IF NOT EXISTS AM_API_RESOURCE_ENDPOINTS (
   RESOURCE_ENDPOINT_ID INTEGER IDENTITY(1,1),
   API_UUID VARCHAR(256),
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_RESOURCE_ENDPOINT_MAPPING]') AND TYPE IN (N'U'))
CREATE TABLE IF NOT EXISTS AM_API_RESOURCE_ENDPOINT_MAPPING (
   OPERATION_ENDPOINT_MAPPING_ID INTEGER IDENTITY(1,1),
