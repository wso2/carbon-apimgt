...
(SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_ENDPOINTS]') AND TYPE IN (N'U'))
CREATE TABLE AM_API_ENDPOINTS (
 ENDPOINT_ID INTEGER IDENTITY,
 API_ID INTEGER NOT NULL,
...
(SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_OPERATION_ENDPOINT_MAPPING]') AND TYPE IN (N'U'))
...
(SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_API_PRIMARY_ENDPOINT_MAPPING]') AND TYPE IN (N'U'))
