...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_GW_PLATFORM_DEPLOYMENT_EVENT]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM SYS.INDEXES WHERE NAME = 'AM_GW_PLATFORM_DEPLOYMENT_EVENT_PENDING')
