...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_INTERNAL_TOKEN_REVOCATION_CONSUMER_KEY_EVENTS]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_INTERNAL_TOKEN_REVOCATION_USER_EVENTS]') AND TYPE IN (N'U'))
