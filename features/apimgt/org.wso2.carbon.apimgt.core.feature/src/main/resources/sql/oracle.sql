...
-- API MinHash for semantic deduplication
...
/
CREATE OR REPLACE TRIGGER TRG_AM_API_MINHASH_UPD BEFORE UPDATE ON AM_API_MINHASH FOR EACH ROW BEGIN :NEW.UPDATED_TIME := SYSTIMESTAMP; END;
/
