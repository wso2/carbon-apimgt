...
CREATE TABLE GOV_POLICY (
    ...
    POLICY_CATEGORY VARCHAR2(128) NOT NULL,
    POLICY_TYPE VARCHAR2(128) NOT NULL,
...
CREATE TABLE GOV_POLICY_CONTENT (
     POLICY_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_RULE (
    POLICY_RULE_ID VARCHAR2(36) NOT NULL,
    POLICY_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_ATTACHMENT (
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
    NAME VARCHAR2(256) NOT NULL,
    DESCRIPTION VARCHAR2(1024),
    ORGANIZATION VARCHAR2(128) NOT NULL,
    CREATED_BY VARCHAR2(256),
...
CREATE TABLE GOV_POLICY_ATTACHMENT_LABEL (
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE (
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_ATTACHMENT_ACTION (
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
    STATE VARCHAR2(128) NOT NULL,
    SEVERITY VARCHAR2(32) NOT NULL,
...
CREATE TABLE GOV_POLICY_ATTACHMENT_POLICY (
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
    POLICY_ID VARCHAR2(36) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT (POLICY_ATTACHMENT_ID),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY (POLICY_ID),
...
CREATE TABLE GOV_REQUEST_POLICY_ATTACHMENT (
    REQ_ID VARCHAR2(36) NOT NULL,
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_ATTACHMENT_RUN (
    ARTIFACT_KEY VARCHAR2(36) NOT NULL,
    POLICY_ATTACHMENT_ID VARCHAR2(36) NOT NULL,
...
CREATE TABLE GOV_POLICY_RUN (
    POLICY_RUN_ID VARCHAR2(36) NOT NULL,
    ARTIFACT_KEY VARCHAR2(36) NOT NULL,
    POLICY_ID VARCHAR2(36) NOT NULL,
