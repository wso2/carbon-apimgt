...
CREATE TABLE AM_GW_VHOST (
            ...
            GRAPHQL_HTTP_PORT VARCHAR(5) NOT NULL,
            GRAPHQL_HTTPS_PORT VARCHAR(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS AM_OPERATION_POLICY (
    ...
    POLICY_NAME VARCHAR(45) DEFAULT 'v1',
...
CREATE SEQUENCE AM_OPERATION_POLICY_DEFINITIONS_SEQ START WITH 1 INCREMENT BY 1
/
