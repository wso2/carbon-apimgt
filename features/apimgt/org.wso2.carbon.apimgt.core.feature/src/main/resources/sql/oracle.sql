...
/
CREATE INDEX IDX_IDN_SESSION_STORE_TIME ON IDN_AUTH_SESSION_STORE (TIME_CREATED)
/
...
/
CREATE INDEX IDX_IDN_TEMP_STORE_TIME ON IDN_AUTH_TEMP_SESSION_STORE (TIME_CREATED)
/
CREATE TABLE SP_APP (
            ID INTEGER,
            TENANT_ID INTEGER NOT NULL,
