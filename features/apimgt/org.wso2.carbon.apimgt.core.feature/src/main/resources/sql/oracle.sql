...
CREATE TABLE IF NOT EXISTS AM_SHARED_OPERATION_POLICY (
    SHARED_POLICY_ID VARCHAR(45) NOT NULL,
    SHARED_POLICY_NAME VARCHAR(300) NOT NULL,
    ...
    MULTIPLE_ALLOWED CHAR(1) DEFAULT 1,
    UNIQUE (TENANT_DOMAIN, SHARED_POLICY_NAME),
    PRIMARY KEY(SHARED_POLICY_ID)
)
/

CREATE TABLE IF NOT EXISTS AM_API_OPERATION_POLICY_DEFINITIONS (
    POLICY_ID VARCHAR(45) NOT NULL,
    SHARED_POLICY_NAME VARCHAR(300),
