...
CREATE SEQUENCE IDN_OAUTH2_DEVICE_FLOW_SCOPES_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_OAUTH2_DEVICE_FLOW_SCOPES_TRIG
            BEFORE INSERT
            ON IDN_OAUTH2_DEVICE_FLOW_SCOPES
            REFERENCING NEW AS NEW
            FOR EACH ROW
              BEGIN
                SELECT IDN_OAUTH2_DEVICE_FLOW_SCOPES_SEQ.nextval INTO :NEW.ID FROM dual;
              END;
/
...
CREATE TABLE AM_GRAPHQL_QUERY_ANALYSIS (
    API_ID INTEGER NOT NULL,
    DEPTH_ENABLED CHAR(1) DEFAULT 0,
    COMPLEXITY_ENABLED CHAR(1) DEFAULT 0,
