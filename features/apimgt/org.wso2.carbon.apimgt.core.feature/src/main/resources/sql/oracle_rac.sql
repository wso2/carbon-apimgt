...
CREATE TABLE AM_DEVPORTAL_ORG_CONTENT (
    ...
    CONSTRAINT FK_DRAFTED_ORG FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE,
    CONSTRAINT FK_PUBLISHED_ORG FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE
)
/
...
CREATE TABLE AM_DEVPORTAL_API_CONTENT (
    ...
    CONSTRAINT FK_DRAFTED_API FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE,
    CONSTRAINT FK_PUBLISHED_API FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE
)
/
