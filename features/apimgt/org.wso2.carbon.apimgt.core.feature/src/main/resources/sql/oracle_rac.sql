...
/
CREATE SEQUENCE IDN_OAUTH_CONSUMER_SECRETS_SEQ START WITH 1 INCREMENT BY 1 CACHE 20
/
...
/
CREATE SEQUENCE AM_SCOPE_BINDING_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER AM_SCOPE_BINDING_TRIG
            BEFORE INSERT
            ON AM_SCOPE_BINDING
            REFERENCING NEW AS NEW
            FOR EACH ROW
                BEGIN
                    SELECT AM_SCOPE_BINDING_SEQ.nextval INTO :NEW.ID FROM dual;
                END;
/
...
/
CREATE SEQUENCE AM_API_REVISION_METADATA_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER AM_API_REVISION_METADATA_TRIG
            BEFORE INSERT
            ON AM_API_REVISION_METADATA
            REFERENCING NEW AS NEW
            FOR EACH ROW
                BEGIN
                    SELECT AM_API_REVISION_METADATA_SEQ.nextval INTO :NEW.ID FROM dual;
                END;
/
...
CREATE TABLE AM_WEBHOOKS_UNSUBSCRIPTION (
        ...
        PRIMARY KEY (ID))
/
CREATE SEQUENCE AM_WEBHOOKS_UNSUBSCRIPTION_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER AM_WEBHOOKS_UNSUBSCRIPTION_TRIG
            BEFORE INSERT
            ON AM_WEBHOOKS_UNSUBSCRIPTION
            REFERENCING NEW AS NEW
            FOR EACH ROW
                BEGIN
                    SELECT AM_WEBHOOKS_UNSUBSCRIPTION_SEQ.nextval INTO :NEW.ID FROM dual;
                END;
/
