...
CREATE SEQUENCE AM_KM_MGT_APPLICATION_SEQUENCE START WITH 1 INCREMENT BY 1 CACHE 20
/

CREATE OR REPLACE TRIGGER AM_KM_MGT_APPLICATION_TRIGGER
		            BEFORE INSERT
                    ON AM_KM_MGT_APPLICATION
                    REFERENCING NEW AS NEW
                    FOR EACH ROW
                    BEGIN
                    SELECT AM_KM_MGT_APPLICATION_SEQUENCE.nextval INTO :NEW.ID FROM dual;
                    END;
/
