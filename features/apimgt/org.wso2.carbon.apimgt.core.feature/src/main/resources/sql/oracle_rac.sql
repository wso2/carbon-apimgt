...
CREATE TABLE AM_PLATFORM_GATEWAY (
    ID VARCHAR2(50) NOT NULL,
    ORGANIZATION_ID VARCHAR2(128) NOT NULL,
    NAME VARCHAR2(255) NOT NULL,
    DISPLAY_NAME VARCHAR2(255) NOT NULL,
    DESCRIPTION VARCHAR2(1023),
    VHOST VARCHAR2(255) NOT NULL,
    IS_CRITICAL NUMBER(1) NOT NULL DEFAULT 0,
    FUNCTIONALITY_TYPE VARCHAR2(255) NOT NULL,
...
CREATE TABLE AM_PLATFORM_GATEWAY_TOKEN (
    ID VARCHAR2(255) NOT NULL,
    ...
    PRIMARY KEY (ID),
    FOREIGN KEY (GATEWAY_ID) REFERENCES AM_PLATFORM_GATEWAY(ID) ON DELETE CASCADE
)
/

CREATE TABLE AM_PLATFORM_GATEWAY_API_ARTIFACT (
    API_UUID VARCHAR2(256) NOT NULL,
    ORGANIZATION_ID VARCHAR2(128) NOT NULL,
    YAML_CONTENT CLOB NOT NULL,
    CREATED_AT TIMESTAMP NOT NULL,
    UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (API_UUID, ORGANIZATION_ID),
    CONSTRAINT fk_platform_artifact_api FOREIGN KEY (API_UUID) REFERENCES AM_API(API_UUID) ON DELETE CASCADE
)
/
...
/
create index IDX_APG_ORG_ACTIVE on AM_PLATFORM_GATEWAY (ORGANIZATION_ID, IS_ACTIVE)
/
create index IDX_APGT_TOKEN_HASH on AM_PLATFORM_GATEWAY_TOKEN (TOKEN_HASH)
/
