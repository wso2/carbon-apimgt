...
CREATE TABLE MGW_DASHBOARD_DATA (
  MGWDATA_ID VARCHAR2(50) NOT NULL,
  APIVERSION VARCHAR2(255) ,
  MGWVERSION VARCHAR2(1024),
  GATEWAY_URL VARCHAR2(255),
  PROJECT_NAME VARCHAR2(255),
  UPTIME INTEGER,
  STATUS VARCHAR2(255),
  SERVICES VARCHAR2(255),
  PRIMARY KEY (MGWDATA_ID)
)
/
