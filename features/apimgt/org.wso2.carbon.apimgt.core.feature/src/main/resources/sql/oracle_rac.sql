...
CREATE TABLE AM_API_METADATA (
    API_UUID        VARCHAR2(256),
    REVISION_UUID   VARCHAR2(255) NOT NULL DEFAULT 'Current API',
    METADATA_KEY    VARCHAR2(256) NOT NULL,
    METADATA_VALUE  VARCHAR2(1024) NOT NULL,
...
CREATE TABLE AM_GW_INSTANCES (
    GATEWAY_ID NUMBER DEFAULT AM_GW_INSTANCES_SEQ.NEXTVAL NOT NULL,
