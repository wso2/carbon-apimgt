...
CREATE SEQUENCE GOV_RULE_VIOLATION_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/

CREATE OR REPLACE TRIGGER GOV_RULE_VIOLATION_TRIG
    BEFORE INSERT
    ON GOV_RULE_VIOLATION
    REFERENCING NEW AS NEW
    FOR EACH ROW
BEGIN
    SELECT GOV_RULE_VIOLATION_SEQ.nextval INTO :NEW.ID FROM dual;
END;
/
