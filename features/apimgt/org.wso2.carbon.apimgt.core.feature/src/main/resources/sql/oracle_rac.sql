...
CREATE SEQUENCE AM_API_ENDPOINTS_seq START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
...
-- Generate ID using sequence and trigger
CREATE SEQUENCE AM_API_PRIMARY_ENDPOINT_MAPPING_seq START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
