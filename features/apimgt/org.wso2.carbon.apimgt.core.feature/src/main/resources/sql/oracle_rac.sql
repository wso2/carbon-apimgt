...
CREATE TABLE AM_APPLICATION (
    ...
    UNIQUE (NAME,SUBSCRIBER_ID,ORGANIZATION_ID),
    UNIQUE (UUID)
)
/
...
CREATE TABLE AM_API (
    ...
    STATUS VARCHAR2(30),
    PRIMARY KEY(API_ID),
    UNIQUE (API_PROVIDER,API_NAME,API_VERSION,ORGANIZATION_ID),
    UNIQUE (API_UUID)
)
/
...
CREATE TABLE AM_API_COMMENTS (
    ...
    API_ID INTEGER,
    PARENT_COMMENT_ID VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE AM_GATEWAY_ENVIRONMENT (
            ...
            PRIMARY KEY (ID))
/
CREATE SEQUENCE AM_GATEWAY_ENVIRONMENT_SEQUENCE START WITH 1 INCREMENT BY 1 CACHE 20 ORDER
/
CREATE OR REPLACE TRIGGER AM_GATEWAY_ENVIRONMENT_TRIGGER
            ...
            FOR EACH ROW
            BEGIN
                SELECT AM_GATEWAY_ENVIRONMENT_SEQUENCE.nextval INTO :NEW.ID FROM dual;
            END;
/
...
CREATE OR REPLACE TRIGGER AM_WEBHOOKS_SUBSCRIPTION_TRIGGER
    BEFORE INSERT
