...
/
-- Platform gateway deployment events (multi-CP WebSocket sync: pending events pushed on connect) --
CREATE TABLE AM_GW_PLATFORM_DEPLOYMENT_EVENT (
  ID VARCHAR2(36) NOT NULL,
  GATEWAY_ID VARCHAR2(255) NOT NULL,
...
/
CREATE INDEX AM_GW_PLATFORM_DEPLOYMENT_EVENT_PENDING ON AM_GW_PLATFORM_DEPLOYMENT_EVENT (GATEWAY_ID, DELIVERED_AT)
/
...
-- Platform gateway metadata is in AM_GATEWAY_ENVIRONMENT (GATEWAY_TYPE='api-platform'); tokens reference env UUID.
