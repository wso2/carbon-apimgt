...
CREATE TABLE IF NOT EXISTS AM_ALERT_TYPES_VALUES (
	    ...
	    STAKE_HOLDER VARCHAR(100) NOT NULL ,	    
	    UNIQUE INDEX AM_ALERT_TYPES_VALUES_INDEX (ALERT_TYPE_ID,USER_NAME,STAKE_HOLDER)
);
...
CREATE TABLE IF NOT EXISTS AM_ALERT_EMAILLIST (  
	    ...
	    STAKE_HOLDER VARCHAR(100) NOT NULL ,
    	    ...
    	    UNIQUE INDEX AM_ALERT_EMAILLIST_INDEX (EMAIL_LIST_ID,USER_NAME,STAKE_HOLDER)
);

CREATE TABLE IF NOT EXISTS  AM_ALERT_EMAILLIST_DETAILS (             
            EMAIL_LIST_ID INTEGER,
	    EMAIL VARCHAR(255),	    
	    UNIQUE INDEX AM_ALERT_EMAILLIST_DETAILS_INDEX (EMAIL_LIST_ID,EMAIL)
);
