...
CREATE TABLE AM_LLM_PROVIDERS
(
    UUID            VARCHAR(255)    NOT NULL,
    NAME            VARCHAR(255)    NOT NULL,
    API_VERSION     VARCHAR(50)     NOT NULL,
    ORGANIZATION    VARCHAR(255)    NOT NULL,
    BUILT_IN_SUPPORT SMALLINT       NOT NULL,
    DESCRIPTION     VARCHAR(1023),
...
(
    ...
    API_UUID            VARCHAR(255)    NOT NULL,
    API_REVISION_UUID     VARCHAR(50)     NOT NULL,
    LLM_PROVIDER_NAME    VARCHAR(255)    NOT NULL,
    LLM_PROVIDER_API_VERSION    VARCHAR(255)    NOT NULL,
    ENDPOINT_CONFIGURATION   BLOB            NOT NULL,
    THROTTLING_CONFIGURATIONS  BLOB            NOT NULL,
    UNIQUE (NAME, API_VERSION, ORGANIZATION),
    PRIMARY KEY (UUID)
)
/
