...
CREATE TABLE IF NOT EXISTS AM_GW_INSTANCES (
    ...
    ENV_LABELS VARCHAR(255) NOT NULL,
...
ALTER TABLE AM_GW_REVISION_DEPLOYMENT
    ADD CONSTRAINT am_gw_revision_deployment_gateway_id_foreign FOREIGN KEY (GATEWAY_ID) REFERENCES AM_GW_INSTANCES(GATEWAY_ID)
/
