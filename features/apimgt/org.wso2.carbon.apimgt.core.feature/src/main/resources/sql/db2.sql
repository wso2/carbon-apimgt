...
CREATE TABLE CHOREO_API_ASGARDEO_MAPPING
(
...
CREATE TABLE CHOREO_SUBSCRIPTION_ASGARDEO_MAPPING
(
...
CREATE TABLE CHOREO_GW_ENV_DATA_PLANE_MAPPING (
            GATEWAY_ENV_UUID VARCHAR(45) NOT NULL,
            DATA_PLANE_ID VARCHAR(255) NOT NULL,
            FOREIGN KEY (GATEWAY_ENV_UUID) REFERENCES AM_GATEWAY_ENVIRONMENT(UUID) ON DELETE CASCADE,
...
CREATE TABLE CHOREO_AM_API_REVISION_METADATA (
  API_UUID VARCHAR(64),
  REVISION_UUID VARCHAR(255),
  API_THROTTLE_LIMIT VARCHAR(256),
  FOREIGN KEY(REVISION_UUID) REFERENCES AM_REVISION(REVISION_UUID) ON DELETE CASCADE,
