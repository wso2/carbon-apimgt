...
CREATE TABLE AM_OPERATION_POLICY_DEFINITION (
   DEFINITION_ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
   POLICY_UUID VARCHAR(45) NOT NULL,
...
CREATE TABLE AM_API_ENDPOINTS (
 ENDPOINT_ID INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
 API_ID INTEGER NOT NULL,
