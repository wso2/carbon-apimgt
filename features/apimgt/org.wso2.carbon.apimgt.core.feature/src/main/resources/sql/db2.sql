...
REFERENCING NEW AS NEW FOR EACH ROW MODE DB2SQL
  BEGIN ATOMIC
    SET (NEW.ID)
    = (NEXTVAL FOR IDN_OAUTH_CONSUMER_SECRETS_SEQ);
  END
/
...
CREATE TABLE IDN_INVALID_TOKENS (
 	...
 	TOKEN_IDENTIFIER VARCHAR(511) NOT NULL,
 	CONSUMER_KEY VARCHAR(255) NOT NULL,
 	TIME_CREATED TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE AM_API_SEQUENCE_BACKEND (
  ...
  API_UUID VARCHAR(256) NOT NULL,
  REVISION_UUID VARCHAR(256) NOT NULL DEFAULT '0',
...
CREATE TABLE AM_BACKEND_OPERATION_MAPPING (
    MAPPING_ID       INTEGER  GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
...
CREATE TABLE AM_LLM_PROVIDER (
    ...
    API_DEFINITION      BLOB(10M)       NOT NULL,
...
CREATE TABLE AM_LABEL (
    ...
    NAME            VARCHAR(255)    NOT NULL,
    DESCRIPTION     VARCHAR(1024),
    TENANT_DOMAIN   VARCHAR(255) NOT NULL  DEFAULT 'carbon.super',
...
CREATE TABLE AM_GW_INSTANCES (
    GATEWAY_ID INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
CREATE TABLE AM_API_KEY (
            API_KEY_UUID VARCHAR(64) NOT NULL PRIMARY KEY,
            NAME VARCHAR(512) NOT NULL,
