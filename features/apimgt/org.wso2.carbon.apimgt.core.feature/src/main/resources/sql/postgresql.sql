...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT;
...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT_LABEL;
...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE;
...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT_ACTION;
...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT_RULESET;
CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_RULESET (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    RULESET_ID VARCHAR(36) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    FOREIGN KEY (RULESET_ID) REFERENCES GOV_RULESET(RULESET_ID),
    PRIMARY KEY (POLICY_ATTACHMENT_ID, RULESET_ID)
);
...
DROP TABLE IF EXISTS GOV_REQUEST_POLICY_ATTACHMENT;
...
DROP TABLE IF EXISTS GOV_POLICY_ATTACHMENT_RUN;
