...
DROP TABLE IF EXISTS CHOREO_GW_ENV_DATA_PLANE_MAPPING;
...
DROP TABLE IF EXISTS CHOREO_AM_API;
...
DROP TABLE IF EXISTS CHOREO_AM_API_REVISION_METADATA;
...
DROP TABLE IF EXISTS CHOREO_API_ASGARDEO_MAPPING;
...
DROP TABLE IF EXISTS CHOREO_SUBSCRIPTION_ASGARDEO_MAPPING;
