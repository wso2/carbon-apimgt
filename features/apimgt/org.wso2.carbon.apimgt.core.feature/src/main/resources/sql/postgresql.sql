...
CREATE TABLE IF NOT EXISTS AM_API_PRODUCT (
	API_PRODUCT_ID INTEGER DEFAULT nextval('am_api_product_sequence'),
...
DROP TABLE IF EXISTS AM_BOT_DATA;
...
DROP TABLE IF EXISTS HONEYPOT_EMAIL_LIST;
CREATE SEQUENCE HONEYPOT_EMAIL_LIST_seq;

CREATE TABLE IF NOT EXISTS HONEYPOT_EMAIL_LIST (
    EMAIL_LIST_ID INTEGER DEFAULT NEXTVAL ('HONEYPOT_EMAIL_LIST_seq'),
    TENANT_DOMAIN VARCHAR(255) NOT NULL ,
