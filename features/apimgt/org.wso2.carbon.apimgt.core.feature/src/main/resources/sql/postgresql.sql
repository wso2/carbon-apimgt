...
CREATE TABLE AM_API_RESOURCES (
  ...
  PRIMARY KEY (UUID),
  FOREIGN KEY (API_ID) REFERENCES AM_API(API_UUID) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE AM_API_DOC_META_DATA (
  ...
  LAST_UPDATED_TIME TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (UUID),
  FOREIGN KEY (RESOURCE_UUID) REFERENCES AM_API_RESOURCES(UUID) ON UPDATE CASCADE ON DELETE CASCADE
 );
