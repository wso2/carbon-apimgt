...
CREATE SEQUENCE AM_API_ENDPOINTS_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE AM_API_ENDPOINTS (
 ENDPOINT_ID INTEGER DEFAULT nextval('AM_API_ENDPOINTS_SEQUENCE'),
 API_ID INTEGER NOT NULL,
...
DROP TABLE IF EXISTS AM_API_OPERATION_ENDPOINT_MAPPING;
CREATE SEQUENCE AM_API_OPERATION_ENDPOINT_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 1;
CREATE TABLE AM_API_OPERATION_ENDPOINT_MAPPING (
 MAPPING_ID INTEGER DEFAULT nextval('AM_API_OPERATION_ENDPOINT_MAPPING_SEQUENCE'),
 URL_MAPPING_ID INTEGER NOT NULL,
...
DROP TABLE IF EXISTS AM_API_PRIMARY_ENDPOINT_MAPPING;
CREATE SEQUENCE AM_API_PRIMARY_ENDPOINT_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 1;
