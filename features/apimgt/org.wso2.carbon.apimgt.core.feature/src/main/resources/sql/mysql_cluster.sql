...
CREATE TABLE IF NOT EXISTS AM_API_ENDPOINTS (
 ENDPOINT_ID INTEGER AUTO_INCREMENT,
 API_ID INTEGER NOT NULL,
...
-- API Endpoints' Operation Mapping Table --
...
-- API Primary Endpoints' mapping Table --
CREATE TABLE IF NOT EXISTS AM_API_PRIMARY_ENDPOINT_MAPPING (
 MAPPING_ID INTEGER NOT NULL AUTO_INCREMENT,
 API_ID INTEGER NOT NULL,
 ENDPOINT_ID INTEGER NOT NULL,
 ENVIRONMENT ENUM ('SANDBOX', 'PRODUCTION'),
