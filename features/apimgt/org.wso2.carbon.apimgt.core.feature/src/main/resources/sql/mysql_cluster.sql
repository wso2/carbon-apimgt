...
CREATE TABLE IF NOT EXISTS AM_API_EXTERNAL_API_MAPPING (
    ...
    FOREIGN KEY (API_ID) REFERENCES AM_API(API_UUID),
...
CREATE TABLE IF NOT EXISTS AM_PLATFORM_GATEWAY (
...
CREATE TABLE IF NOT EXISTS AM_PLATFORM_GATEWAY_TOKEN (
    ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS AM_PLATFORM_GATEWAY_API_ARTIFACT (
    API_UUID VARCHAR(256) NOT NULL,
    ORGANIZATION_ID VARCHAR(128) NOT NULL,
...
CREATE TRIGGER DELETE_AM_API_CASCADE
...
BEGIN
  ...
  DELETE FROM AM_API_ENDPOINTS WHERE API_UUID = OLD.API_UUID;
  DELETE FROM AM_API_POLICY_MAPPING WHERE API_UUID = OLD.API_UUID;
  DELETE FROM AM_API_EXTERNAL_API_MAPPING WHERE API_ID = OLD.API_UUID;
END;//
...
CREATE TRIGGER DELETE_AM_OPERATION_POLICY_CASCADE
...
BEGIN
  ...
  DELETE FROM AM_API_POLICY_MAPPING WHERE POLICY_UUID = OLD.POLICY_UUID;
END;//

CREATE TRIGGER DELETE_AM_APPLICATION_REGISTRATION
BEFORE DELETE ON AM_APPLICATION
FOR EACH ROW
BEGIN
  DELETE FROM AM_APPLICATION_REGISTRATION WHERE APP_ID = OLD.APPLICATION_ID;
END;//

CREATE TRIGGER DELETE_AM_API_OPERATION_POLICY_MAPPING_URL_MAPPING
BEFORE DELETE ON AM_API_URL_MAPPING
FOR EACH ROW
BEGIN
    DELETE FROM AM_API_OPERATION_POLICY_MAPPING WHERE URL_MAPPING_ID = OLD.URL_MAPPING_ID;
END;//
