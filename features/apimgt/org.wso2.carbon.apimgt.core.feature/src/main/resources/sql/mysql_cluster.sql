...
CREATE TRIGGER DELETE_AM_API_ENDPOINTS
BEFORE DELETE ON AM_API
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DELETE_AM_API_OPERATION_POLICY_MAPPING_POLICY
BEFORE DELETE ON AM_OPERATION_POLICY
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DELETE_AM_API_POLICY_MAPPING_API
BEFORE DELETE ON AM_API
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DELETE_AM_API_POLICY_MAPPING_POLICY
BEFORE DELETE ON AM_OPERATION_POLICY
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DELETE_AM_API_EXTERNAL_API_MAPPING
BEFORE DELETE ON AM_API
FOR EACH ROW
BEGIN
