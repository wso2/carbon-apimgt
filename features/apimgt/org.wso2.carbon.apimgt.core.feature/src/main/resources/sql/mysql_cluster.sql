...
CREATE TABLE IF NOT EXISTS AM_API_PRODUCT (
	API_PRODUCT_ID INTEGER AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS AM_SUBSCRIPTION (
    ...
    FOREIGN KEY(API_PRODUCT_ID) REFERENCES AM_API_PRODUCT(API_PRODUCT_ID) ON UPDATE CASCADE ON DELETE RESTRICT,
