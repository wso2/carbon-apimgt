...
CREATE TABLE IF NOT EXISTS GOV_POLICY_CONTENT (
    POLICY_ID VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS GOV_POLICY_RULE (
    ...
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
    CONSTRAINT POLICY_RULE_CONSTRAINT UNIQUE (POLICY_ID, RULE_NAME),
    PRIMARY KEY (POLICY_RULE_ID)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    NAME VARCHAR(256) NOT NULL,
    DESCRIPTION VARCHAR(1024),
    ORGANIZATION VARCHAR(128) NOT NULL,
    CREATED_BY VARCHAR(256),
    ...
    CONSTRAINT POLICY_ATTACHMENT_CONSTRAINT UNIQUE (NAME, ORGANIZATION),
    PRIMARY KEY (POLICY_ATTACHMENT_ID)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_LABEL (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    LABEL VARCHAR(128) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    PRIMARY KEY (POLICY_ATTACHMENT_ID, LABEL)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    STATE VARCHAR(128) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    PRIMARY KEY (POLICY_ATTACHMENT_ID, STATE)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_ACTION (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    STATE VARCHAR(128) NOT NULL,
    SEVERITY VARCHAR(32) NOT NULL,
    TYPE VARCHAR(32) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID, STATE) REFERENCES GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE(POLICY_ATTACHMENT_ID, STATE),
    PRIMARY KEY (POLICY_ATTACHMENT_ID, STATE, SEVERITY, TYPE)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_POLICY (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    POLICY_ID VARCHAR(36) NOT NULL,
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
    PRIMARY KEY (POLICY_ATTACHMENT_ID, POLICY_ID)
) ENGINE=NDB;
...
CREATE TABLE IF NOT EXISTS GOV_REQUEST_POLICY_ATTACHMENT (
    REQ_ID VARCHAR(36) NOT NULL,
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    FOREIGN KEY (REQ_ID) REFERENCES GOV_REQUEST(REQ_ID),
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    PRIMARY KEY (REQ_ID, POLICY_ATTACHMENT_ID)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_RUN (
    ARTIFACT_KEY VARCHAR(36) NOT NULL,
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
    RUN_TIMESTAMP DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (ARTIFACT_KEY) REFERENCES GOV_ARTIFACT(ARTIFACT_KEY),
    FOREIGN KEY (POLICY_ATTACHMENT_ID) REFERENCES GOV_POLICY_ATTACHMENT(POLICY_ATTACHMENT_ID),
    PRIMARY KEY (ARTIFACT_KEY, POLICY_ATTACHMENT_ID)
) ENGINE=NDB;

CREATE TABLE IF NOT EXISTS GOV_POLICY_RUN (
    POLICY_RUN_ID VARCHAR(36) NOT NULL,
    ARTIFACT_KEY VARCHAR(36) NOT NULL,
    POLICY_ID VARCHAR(36) NOT NULL,
    RESULT INT NOT NULL, -- 1 - Pass, 0 - Fail
    RUN_TIMESTAMP DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT POLICY_RESULT UNIQUE (ARTIFACT_KEY, POLICY_ID),
    FOREIGN KEY (ARTIFACT_KEY) REFERENCES GOV_ARTIFACT(ARTIFACT_KEY),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
    PRIMARY KEY (POLICY_RUN_ID)
) ENGINE=NDB;
...
CREATE TABLE IF NOT EXISTS GOV_RULE_VIOLATION (
    ...
    PRIMARY KEY (ID),
    FOREIGN KEY (POLICY_RUN_ID) REFERENCES GOV_POLICY_RUN(POLICY_RUN_ID),
    FOREIGN KEY (POLICY_ID, RULE_NAME) REFERENCES GOV_POLICY_RULE(POLICY_ID, RULE_NAME)
) ENGINE=NDB;
