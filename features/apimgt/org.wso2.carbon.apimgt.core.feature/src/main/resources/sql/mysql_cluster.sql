...
CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_STATE (
    POLICY_ATTACHMENT_ID VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS GOV_POLICY_ATTACHMENT_ACTION (
    ...
    FOREIGN KEY (POLICY_ATTACHMENT_ID, STATE) REFERENCES GOV_POLICY_ATTACHMENT_STATE(POLICY_ATTACHMENT_ID, STATE),
