...
CREATE TABLE IF NOT EXISTS GOV_RULE_VIOLATION (
    ...
    FOREIGN KEY (ARTIFACT_ID, ARTIFACT_TYPE, POLICY_ID, RULESET_ID) REFERENCES GOV_EVALUATION_RESULT(ARTIFACT_ID, ARTIFACT_TYPE, POLICY_ID, RULESET_ID) ON UPDATE CASCADE ON DELETE CASCADE,
