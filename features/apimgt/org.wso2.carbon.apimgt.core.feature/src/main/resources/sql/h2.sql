...
CREATE TABLE IF NOT EXISTS AM_DEVPORTAL_ORG_CONTENT (
    ...
    FOREIGN KEY (DRAFTED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE,
    FOREIGN KEY (PUBLISHED_ARTIFACT) REFERENCES AM_ARTIFACT(UUID) ON DELETE CASCADE
);
