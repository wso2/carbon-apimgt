...
CREATE TABLE IF NOT EXISTS ENDPOINT_REG_ENTRY (
  ...
  CREATE TABLE IF NOT EXISTS AM_KEYMGT_MAPPING (
  API_ID INT(11) NOT NULL,
  KEY_MANAGER_ID VARCHAR(50) NULL,
  FOREIGN KEY (API_ID) REFERENCES AM_API (API_ID) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (KEY_MANAGER_ID) REFERENCES AM_KEY_MANAGER (UUID) ON DELETE RESTRICT ON UPDATE RESTRICT
  );
