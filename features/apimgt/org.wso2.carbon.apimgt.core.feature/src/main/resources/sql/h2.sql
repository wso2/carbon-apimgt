...
CREATE TABLE IF NOT EXISTS AM_API (
    ...
    UPDATED_BY VARCHAR(100),
    UPDATED_TIME TIMESTAMP,
    API_POLICY VARCHAR(256) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS AM_POLICY_SUBSCRIPTION (
            ...
            QUOTA_POLICY_TYPE VARCHAR(25) NOT NULL,
            QUOTA INT(11) NOT NULL,
            QUOTA_UNIT VARCHAR(3) NULL,
            UNIT_TIME INT(11) NOT NULL,
            TIME_UNIT VARCHAR(25) NOT NULL,
            RATE_LIMIT_COUNT INT(11) NULL DEFAULT NULL,
            RATE_LIMIT_TIME_UNIT VARCHAR(25) NULL DEFAULT NULL,
            IS_CONTENT_AWARE TINYINT(1) DEFAULT 0,
            PRIMARY KEY (POLICY_ID),
            UNIQUE INDEX SUB_NAME_TENANT (NAME, TENANT_ID)
);
...
CREATE TABLE IF NOT EXISTS AM_POLICY_APPLICATION (
            ...
            QUOTA_POLICY_TYPE VARCHAR(25) NOT NULL,
            QUOTA INT(11) NOT NULL,
            QUOTA_UNIT VARCHAR(3) NULL DEFAULT NULL,
            UNIT_TIME INT(11) NOT NULL,
            TIME_UNIT VARCHAR(25) NOT NULL,
            IS_CONTENT_AWARE TINYINT(1) DEFAULT 0,
            PRIMARY KEY (POLICY_ID),
...
CREATE TABLE IF NOT EXISTS AM_POLICY_API (
            POLICY_ID INT(11) NOT NULL AUTO_INCREMENT,
            NAME VARCHAR(512) NOT NULL,
            TENANT_ID INT(11) NOT NULL,
            DESCRIPTION VARCHAR (1024),
            DEFAULT_QUOTA_POLICY_TYPE VARCHAR(25) NOT NULL,
            DEFAULT_QUOTA INTEGER NOT NULL,
            DEFAULT_QUOTA_UNIT VARCHAR(3) NULL,
...
CREATE TABLE IF NOT EXISTS AM_CONDITION (
            CONDITION_ID INTEGER NOT NULL AUTO_INCREMENT,
            POLICY_ID INTEGER NOT NULL,
            STARTING_IP VARCHAR(25) DEFAULT NULL,
            ENDING_IP VARCHAR(25) DEFAULT NULL,
            SPECIFIC_IP VARCHAR(25) DEFAULT NULL,
            HTTP_VERB VARCHAR(25) DEFAULT NULL,
            STARTING_DATE TIMESTAMP NULL,
            ENDING_DATE TIMESTAMP NULL,
            SPECIFIC_DATE TIMESTAMP NULL,
            QUOTA_POLICY_TYPE VARCHAR(25),
            QUOTA INTEGER NOT NULL,
            QUOTA_UNIT VARCHAR(3) NULL DEFAULT NULL,
            UNIT_TIME INTEGER NOT NULL,
            TIME_UNIT VARCHAR(25) NOT NULL,
            PRIMARY KEY (CONDITION_ID),
            FOREIGN KEY (POLICY_ID) REFERENCES AM_POLICY_API(POLICY_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS AM_QUERY_PARAMETER_CONDITION (
            ...
            FOREIGN KEY (CONDITION_ID) REFERENCES AM_CONDITION(CONDITION_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS AM_JWT_CLAIM_CONDITION (
            ...
            CONDITION_ID INTEGER NOT NULL,
            CLAIM_URL VARCHAR(512) DEFAULT NULL,
            CLAIM_ATTRIBUTE VARCHAR(1024) DEFAULT NULL,
