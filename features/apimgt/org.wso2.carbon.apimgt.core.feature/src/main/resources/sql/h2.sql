...
CREATE TABLE IF NOT EXISTS AM_BACKEND (
...
CREATE TABLE IF NOT EXISTS AM_BACKEND_OPERATION_MAPPING (
...
CREATE TABLE IF NOT EXISTS AM_API_OPERATION_MAPPING (
    MAPPING_ID          INTEGER AUTO_INCREMENT,
    URL_MAPPING_ID      INTEGER NOT NULL,
...
CREATE INDEX IF NOT EXISTS IDX_GW_PLATFORM_ARTIFACT_API_ID ON AM_GW_PLATFORM_API_ARTIFACTS (API_ID);
...
CREATE INDEX IF NOT EXISTS AM_GW_PLATFORM_EVENT_PENDING ON AM_GW_PLATFORM_EVENT (GATEWAY_ID, DELIVERED_AT);
...
CREATE TABLE IF NOT EXISTS GOV_DEVPORTAL_TEMPLATE (
    TEMPLATE_ID VARCHAR(36) NOT NULL,
    NAME VARCHAR(256) NOT NULL,
    DESCRIPTION VARCHAR(1024),
    FORM_CONFIG CLOB NOT NULL,
    FORM_CONFIG_HASH VARCHAR(64),
...
CREATE TABLE IF NOT EXISTS GOV_TEMPLATE_RULESET_BINDING (
...
CREATE TABLE IF NOT EXISTS GOV_TEMPLATE_RULESET_KM_SCOPE (
    BINDING_ID VARCHAR(36) NOT NULL,
    KEY_MANAGER_UUID VARCHAR(50) NOT NULL,
    ORGANIZATION VARCHAR(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS GOV_APP_GOVERNANCE_SNAPSHOT (
    SNAPSHOT_ID VARCHAR(36) NOT NULL,
    APPLICATION_ID INTEGER NOT NULL,
    APPLICATION_UUID VARCHAR(256) NOT NULL,
    SOURCE_TEMPLATE_ID VARCHAR(36) NOT NULL,
    TEMPLATE_NAME VARCHAR(256) NOT NULL,
    TEMPLATE_DESCRIPTION VARCHAR(1024),
    FORM_CONFIG CLOB NOT NULL,
    FORM_CONFIG_HASH VARCHAR(64),
    ORGANIZATION VARCHAR(128) NOT NULL,
    CAPTURED_BY VARCHAR(256),
...
CREATE TABLE IF NOT EXISTS GOV_APP_RULESET_SNAPSHOT (
    SNAPSHOT_RULESET_ID VARCHAR(36) NOT NULL,
    SNAPSHOT_ID VARCHAR(36) NOT NULL,
    SOURCE_RULESET_ID VARCHAR(36) NOT NULL,
    RULESET_NAME VARCHAR(256) NOT NULL,
    RULESET_DESCRIPTION VARCHAR(1024),
    ARTIFACT_TYPE VARCHAR(128) NOT NULL,
    RULESET_TYPE VARCHAR(128),
...
CREATE TABLE IF NOT EXISTS GOV_APP_RULE_SNAP_KM_SCOPE (
    SNAPSHOT_RULESET_ID VARCHAR(36) NOT NULL,
    KEY_MANAGER_UUID VARCHAR(50) NOT NULL,
    KEY_MANAGER_NAME VARCHAR(256),
...
CREATE TABLE IF NOT EXISTS AM_DEVPORTAL_ORG_CONTENT (
    ...
    DRAFTED_ARTIFACT CHARACTER VARYING(45),
    PUBLISHED_ARTIFACT CHARACTER VARYING(45),
    PRIMARY KEY (ORGANIZATION)
);

CREATE TABLE IF NOT EXISTS AM_DEVPORTAL_API_CONTENT (
    API_UUID CHARACTER VARYING(256),
    ORGANIZATION CHARACTER VARYING(100),
    DRAFTED_ARTIFACT CHARACTER VARYING(45),
    PUBLISHED_ARTIFACT CHARACTER VARYING(45),
...
CREATE TABLE IF NOT EXISTS AM_DEVPORTAL_API_REFERENCE (
    ...
    REFERENCE_APIID CHARACTER VARYING(256) NOT NULL,
    PRIMARY KEY (API_UUID, ORGANIZATION)
);
...
CREATE TABLE IF NOT EXISTS AM_TASK_LOCK (
...
CREATE INDEX IF NOT EXISTS IDX_APGT_TOKEN_HASH ON AM_GATEWAY_TOKEN (TOKEN_HASH);
