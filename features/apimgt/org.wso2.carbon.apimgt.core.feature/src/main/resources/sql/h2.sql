...
CREATE TABLE IF NOT EXISTS AM_GATEWAY_ENVIRONMENT (
           ...
           DESCRIPTION VARCHAR(1023) NULL,
           EXTERNAL_GATEWAY_ENVIRONMENT BOOLEAN DEFAULT 0,
           UNIQUE (NAME, TENANT_DOMAIN),
           UNIQUE (UUID),
           PRIMARY KEY (ID)
);
...
CREATE TABLE IF NOT EXISTS GB_WEBHOOKS_SUBSCRIPTION (
    WH_SUBSCRIPTION_ID INTEGER NOT NULL AUTO_INCREMENT,
    WH_SUBSCRIBER_NAME VARCHAR(255) NOT NULL,
    WH_CALLBACK_URL VARCHAR(1024) NOT NULL,
    WH_TOPIC VARCHAR(255) NOT NULL,
    UPDATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    EXPIRY_AT LONG,
    PRIMARY KEY (WH_SUBSCRIPTION_ID)
    );
