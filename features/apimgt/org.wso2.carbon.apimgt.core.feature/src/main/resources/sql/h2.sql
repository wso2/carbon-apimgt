...
CREATE TABLE IF NOT EXISTS AM_API_OPERATION_ENDPOINTS (
  OPERATION_ENDPOINT_ID INTEGER AUTO_INCREMENT,
  API_ID INTEGER NOT NULL,
  OPERATION_ENDPOINT_UUID VARCHAR (256) NOT NULL,
  REVISION_UUID VARCHAR(255),
  ...
  FOREIGN KEY (API_ID) REFERENCES AM_API(API_ID) ON DELETE CASCADE,
  FOREIGN KEY (REVISION_UUID) REFERENCES AM_REVISION(REVISION_UUID) ON DELETE CASCADE,
  PRIMARY KEY(OPERATION_ENDPOINT_ID),
  UNIQUE (OPERATION_ENDPOINT_UUID, REVISION_UUID)
);

CREATE TABLE IF NOT EXISTS AM_API_OPERATION_ENDPOINT_MAPPING (
  MAPPING_ID INTEGER NOT NULL AUTO_INCREMENT,
  URL_MAPPING_ID INTEGER NOT NULL,
  OPERATION_ENDPOINT_ID INTEGER NOT NULL,
  PRODUCTION_ENV ENUM ('NONE', 'DEFAULT', 'ACTIVE'),
  SANDBOX_ENV ENUM ('NONE', 'DEFAULT', 'ACTIVE'),
  FOREIGN KEY (OPERATION_ENDPOINT_ID) REFERENCES AM_API_OPERATION_ENDPOINTS(OPERATION_ENDPOINT_ID) ON DELETE CASCADE,
