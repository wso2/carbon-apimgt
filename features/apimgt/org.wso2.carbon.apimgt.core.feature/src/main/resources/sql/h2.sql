...
CREATE TABLE IF NOT EXISTS GOV_RULESET_RULE (
    ...
    CONSTRAINT RULESET_RULE_UNIQUE_CONSTRAINT UNIQUE (RULESET_ID, RULE_NAME),
...
CREATE TABLE IF NOT EXISTS GOV_REQUEST (
    ...
    CONSTRAINT EVALUATION_TRACKER_UNIQUE_CONSTRAINT UNIQUE (ARTIFACT_ID, ARTIFACT_TYPE, POLICY_ID, EVALUATION_STATUS, ORGANIZATION),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
...
CREATE TABLE IF NOT EXISTS GOV_EVALUATION_RESULT (
    ...
    EVALUATED_TIMESTAMP TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT EVALUATION_RESULT_UNIQUE_CONSTRAINT UNIQUE (ARTIFACT_ID, ARTIFACT_TYPE, POLICY_ID, RULESET_ID),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID),
    FOREIGN KEY (RULESET_ID) REFERENCES GOV_RULESET(RULESET_ID),
...
CREATE TABLE IF NOT EXISTS GOV_RULE_VIOLATION (
    ...
    CONSTRAINT RULE_VIOLATION_UNIQUE_CONSTRAINT UNIQUE (RESULT_ID, RULE_NAME, VIOLATED_PATH),
