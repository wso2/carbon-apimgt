...
CREATE TABLE IF NOT EXISTS SERVICE_CATALOG (
  ...
  UNIQUE (UUID),
  UNIQUE (CATALOG_NAME, TENANT_ID),
  UNIQUE (CATALOG_TYPE, TENANT_ID),
  UNIQUE (DISPLAY_NAME, TENANT_ID),
  PRIMARY KEY(ID)
);

CREATE TABLE IF NOT EXISTS SERVICE_CATALOG_ENTRY (
  UUID VARCHAR(255) NOT NULL,
  ...
  UPDATED_BY VARCHAR(255),
  PRIMARY KEY(UUID),
  UNIQUE (ENTRY_NAME, ENTRY_VERSION, CATALOG_ID),
  UNIQUE (DISPLAY_NAME, ENTRY_VERSION, CATALOG_ID),
