...
CREATE TABLE IF NOT EXISTS GOV_RULE_VIOLATION (
    ...
    CONSTRAINT RULE_VIOLATION_UNIQUE_CONSTRAINT UNIQUE (RESULT_ID, RULE_CODE, VIOLATED_PATH),
    FOREIGN KEY (RESULT_ID) REFERENCES GOV_EVALUATION_RESULT(RESULT_ID),
    FOREIGN KEY (RULESET_ID, RULE_CODE) REFERENCES GOV_RULESET_RULE(RULESET_ID, RULE_CODE),
