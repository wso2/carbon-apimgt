...
CREATE TABLE IF NOT EXISTS AM_BACKEND_API (
    BACKEND_API_ID              VARCHAR(40) NOT NULL,
    BACKEND_API_NAME            VARCHAR(255) NOT NULL,
    ENDPOINT_CONFIG             BLOB,
    API_DEFINITION              LONGBLOB,
    REFERENCE_API_UUID          VARCHAR(255) DEFAULT NULL,
    REFERENCE_API_REVISION_UUID VARCHAR(255) DEFAULT NULL,
    ORGANIZATION                VARCHAR(100),
    FOREIGN KEY (REFERENCE_API_UUID) REFERENCES AM_API(API_UUID),
    UNIQUE (REFERENCE_API_UUID, REFERENCE_API_REVISION_UUID, BACKEND_API_NAME),
...
CREATE TABLE IF NOT EXISTS AM_API_BACKEND_OPERATION_MAPPING (
    MAPPING_ID       INTEGER AUTO_INCREMENT,
    URL_MAPPING_ID   INTEGER NOT NULL,
    BACKEND_API_ID   VARCHAR(256) NOT NULL,
    TARGET           VARCHAR(256) NOT NULL,
    VERB             VARCHAR(10) NOT NULL,
    FOREIGN KEY (URL_MAPPING_ID)
        REFERENCES AM_API_URL_MAPPING (URL_MAPPING_ID),
    FOREIGN KEY (BACKEND_API_ID)
            REFERENCES AM_BACKEND_API (BACKEND_API_ID),
    PRIMARY KEY (MAPPING_ID)
);
