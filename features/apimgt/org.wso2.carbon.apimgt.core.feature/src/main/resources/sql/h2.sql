...
CREATE TABLE IF NOT EXISTS AM_GRAPHQL_COMPLEXITY (
    ...
    PRIMARY KEY(UUID),
    UNIQUE (API_ID,TYPE,FIELD,REVISION_UUID)
);
...
CREATE TABLE IF NOT EXISTS AM_API_CLIENT_CERTIFICATE (
  ...
  REVISION_UUID VARCHAR(255) NOT NULL DEFAULT 'Working Copy',
...
CREATE TABLE IF NOT EXISTS AM_REVISION (
            ...
            FOREIGN KEY (API_UUID) REFERENCES AM_API(API_UUID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS AM_SERVICE_CATALOG (
            ...
            DISPLAY_NAME VARCHAR(255) NOT NULL,
            ENTRY_VERSION VARCHAR(30) NOT NULL,
            TENANT_ID INTEGER NOT NULL,
            ...
            ENDPOINT_DEFINITION BLOB NOT NULL,
