...
CREATE TABLE IF NOT EXISTS AM_IP_CONDITION (
  ...
  WITHIN_IP_RANGE TINYINT(1) NULL DEFAULT 1,
  CONDITION_ID INT NULL,
  PRIMARY KEY (AM_IP_CONDITION_ID),
  INDEX fk_AM_IP_CONDITION_1_idx (CONDITION_ID ASC),
  CONSTRAINT fk_AM_IP_CONDITION_1
    FOREIGN KEY (CONDITION_ID)
    REFERENCES AM_CONDITION (CONDITION_ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
