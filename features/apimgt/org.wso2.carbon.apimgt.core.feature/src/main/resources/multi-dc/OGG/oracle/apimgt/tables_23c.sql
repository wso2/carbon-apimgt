...
CREATE TABLE IDN_OAUTH_CONSUMER_APPS (
            ...
            PKCE_MANDATORY BOOLEAN DEFAULT '0',
            PKCE_SUPPORT_PLAIN BOOLEAN DEFAULT '0',
...
CREATE TABLE SP_APP (
            ...
            IS_LOCAL_CLAIM_DIALECT BOOLEAN DEFAULT '1',
            IS_SEND_LOCAL_SUBJECT_ID BOOLEAN DEFAULT '0',
            IS_SEND_AUTH_LIST_OF_IDPS BOOLEAN DEFAULT '0',
            IS_USE_TENANT_DOMAIN_SUBJECT BOOLEAN DEFAULT '1',
            IS_USE_USER_DOMAIN_SUBJECT BOOLEAN DEFAULT '1',
            ENABLE_AUTHORIZATION BOOLEAN DEFAULT '0',
            SUBJECT_CLAIM_URI VARCHAR (512),
            IS_SAAS_APP BOOLEAN DEFAULT '0',
            IS_DUMB_MODE BOOLEAN DEFAULT '0',
            UUID CHAR(36),
...
CREATE TABLE SP_AUTH_STEP (
  ...
  APP_ID INTEGER NOT NULL,
            IS_SUBJECT_STEP BOOLEAN DEFAULT '0',
            IS_ATTRIBUTE_STEP BOOLEAN DEFAULT '0',
            PRIMARY KEY (ID))
/
...
CREATE TABLE SP_PROVISIONING_CONNECTOR (
	    	...
	    	APP_ID INTEGER NOT NULL,
	    	IS_JIT_ENABLED BOOLEAN DEFAULT '0',
		    BLOCKING BOOLEAN DEFAULT '0',
		    RULE_ENABLED BOOLEAN DEFAULT '0' NOT NULL,
            PRIMARY KEY (ID))
/
...
CREATE TABLE IDP (
  ...
  CERTIFICATE                BLOB,
  ALIAS                      VARCHAR(254),
  INBOUND_PROV_ENABLED       BOOLEAN DEFAULT '0',
  ...
  IS_FEDERATION_HUB          BOOLEAN DEFAULT '0',
  IS_LOCAL_CLAIM_DIALECT     BOOLEAN DEFAULT '0',
  DISPLAY_NAME               VARCHAR(255),
  IMAGE_URL                  VARCHAR(1024),
...
CREATE TABLE IDP_PROVISIONING_CONFIG (
            ...
            IS_RULES_ENABLED BOOLEAN DEFAULT '0',
            PRIMARY KEY (ID),
...
CREATE TABLE FIDO2_DEVICE_STORE (
        ...
        DISPLAY_NAME VARCHAR(255),
        IS_USERNAMELESS_SUPPORTED BOOLEAN DEFAULT '0',
