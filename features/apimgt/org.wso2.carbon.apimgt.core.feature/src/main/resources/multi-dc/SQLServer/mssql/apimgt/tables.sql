...
CREATE TABLE AM_API_PRIMARY_EP_MAPPING (
    ...
    UNIQUE (API_UUID, REVISION_UUID, ENDPOINT_UUID),
    FOREIGN KEY (API_UUID) REFERENCES AM_API(API_UUID) ON DELETE CASCADE,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[AM_EXECUTOR_TASK_LOCK]') AND TYPE IN (N'U'))
CREATE TABLE AM_EXECUTOR_TASK_LOCK (
