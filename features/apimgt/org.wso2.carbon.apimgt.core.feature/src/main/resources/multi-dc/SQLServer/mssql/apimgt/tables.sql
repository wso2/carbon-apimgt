...
CREATE TABLE IDN_OAUTH2_TOKEN_BINDING (
            ...
            PRIMARY KEY (TOKEN_ID,TOKEN_BINDING_TYPE,TOKEN_BINDING_VALUE),
...
IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_API_METADATA]') AND type IN (N'U'))
...
CREATE TABLE AM_API_ENDPOINTS (
    API_UUID VARCHAR(256) NOT NULL,
    ENDPOINT_UUID VARCHAR(100) NOT NULL,
...
IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_BACKEND]') AND type IN (N'U'))

CREATE TABLE AM_BACKEND (
    BACKEND_ID                  VARCHAR(40) NOT NULL,
    BACKEND_NAME                VARCHAR(256) NOT NULL,
    ENDPOINT_CONFIG             VARBINARY(MAX),
...
CREATE TABLE AM_API_PRIMARY_EP_MAPPING (
    MAPPING_ID INTEGER NOT NULL IDENTITY(1,1),
    API_UUID VARCHAR(256) NOT NULL,
...
CREATE TABLE AM_API_URL_MAPPING (
    ...
    SCHEMA_DEFINITION VARBINARY(MAX),
    REVISION_UUID VARCHAR(255),
    LOG_LEVEL VARCHAR(255) DEFAULT 'OFF',
    PRIMARY KEY (URL_MAPPING_ID)
);

IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_BACKEND_OPERATION_MAPPING]') AND type IN (N'U'))

CREATE TABLE AM_BACKEND_OPERATION_MAPPING (
    MAPPING_ID       INTEGER IDENTITY(1,1),
...
IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_API_OPERATION_MAPPING]') AND type IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_GW_PLATFORM_API_ARTIFACTS]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE NAME = 'IDX_GW_PLATFORM_ARTIFACT_API_ID')
...
CREATE TABLE AM_SCOPE_BINDING (
  ...
  PRIMARY KEY (SCOPE_ID, SCOPE_BINDING, BINDING_TYPE)
);
...
CREATE TABLE AM_API_REVISION_METADATA (
  ...
  PRIMARY KEY (API_UUID, REVISION_UUID)
);
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_GW_PLATFORM_EVENT]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE NAME = 'AM_GW_PLATFORM_EVENT_PENDING')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_GW_INSTANCES]') AND type IN (N'U'))
CREATE TABLE AM_GW_INSTANCES (
    GATEWAY_ID INT IDENTITY(1,1) NOT NULL,
    GATEWAY_UUID VARCHAR(255) NOT NULL,
    ORGANIZATION VARCHAR(128) NOT NULL,
    LAST_UPDATED DATETIME NOT NULL,
    GW_PROPERTIES VARBINARY(MAX),
    PRIMARY KEY (GATEWAY_ID),
    UNIQUE (GATEWAY_UUID, ORGANIZATION)
);

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_GW_INSTANCE_ENV_MAPPING]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_GW_REVISION_DEPLOYMENT]') AND type IN (N'U'))
...
CREATE TABLE AM_WEBHOOKS_SUBSCRIPTION (
    WH_SUBSCRIPTION_ID INTEGER IDENTITY(1,1),
...
CREATE TABLE AM_WEBHOOKS_UNSUBSCRIPTION (
    AM_WEBHOOKS_UNSUBSCRIPTION_ID INTEGER IDENTITY(1,1),
    API_UUID VARCHAR(255) NOT NULL,
    APPLICATION_ID VARCHAR(20) NOT NULL,
    TENANT_DOMAIN VARCHAR(255) NOT NULL,
    HUB_CALLBACK_URL VARCHAR(1024) NOT NULL,
...
IF NOT  EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_FEDERATED_DISCOVERY_CACHE]') AND type IN (N'U'))
CREATE TABLE AM_FEDERATED_DISCOVERY_CACHE (
    ID INTEGER IDENTITY(1,1) NOT NULL,
    ...
    REFERENCE_ARTIFACT VARBINARY(MAX),
    STATUS VARCHAR(20) NOT NULL,
    DISCOVERED_AT DATETIME NOT NULL DEFAULT GETDATE(),
    PRIMARY KEY (ID),
    UNIQUE (ENVIRONMENT_NAME, ORGANIZATION, EXTERNAL_API_ID)
);
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_TASK_LOCK]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_API_KEY]') AND type IN (N'U'))
CREATE TABLE AM_API_KEY (
            API_KEY_UUID VARCHAR(64) PRIMARY KEY,
            NAME VARCHAR(512) NOT NULL,
            API_KEY_HASH VARCHAR(512) NOT NULL UNIQUE,
            KEY_TYPE VARCHAR(100),
            API_KEY_PROPERTIES VARBINARY(MAX) DEFAULT NULL,
            AUTHZ_USER VARCHAR(512),
            TIME_CREATED DATETIME2(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
            VALIDITY_PERIOD BIGINT,
            LAST_USED DATETIME2(6) NULL DEFAULT NULL,
            STATUS VARCHAR(100) DEFAULT 'ACTIVE' NOT NULL
);

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_API_KEY_API_MAPPING]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = object_id(N'[dbo].[AM_API_KEY_APPLICATION_MAPPING]') AND type IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE NAME = 'IDX_APGT_TOKEN_HASH')
