...
CREATE OR ALTER TRIGGER TRG_DEL_AM_SUBSCRIPTION on AM_SUBSCRIPTION
  INSTEAD OF DELETE
     AS 
      BEGIN
       DELETE AMSKM FROM DELETED, AM_SUBSCRIPTION_KEY_MAPPING AMSKM WHERE AMSKM.SUBSCRIPTION_ID = DELETED.SUBSCRIPTION_ID;
      END
      DELETE FROM AM_SUBSCRIPTION WHERE (SUBSCRIPTION_ID) IN (SELECT SUBSCRIPTION_ID FROM DELETED);
;
GO
