...
-- Delete triggers for replacing cascades --
...
CREATE OR REPLACE TRIGGER TRG_DEL_IDN_OIDC_OBJ_CLAIMS
  BEFORE DELETE
    ...
    FOR EACH ROW
      ...
      END;
/
CREATE OR REPLACE TRIGGER TRG_DEL_IDN_OIDC_SCOPE
  BEFORE DELETE
    on IDN_OIDC_SCOPE
    FOR EACH ROW
      BEGIN
        DELETE FROM IDN_OIDC_SCOPE_CLAIM_MAPPING IOSCM WHERE IOSCM.SCOPE_ID = :OLD.ID;
      END;
/
