...
CREATE SEQUENCE AM_API_RATINGS_seq;

CREATE TABLE AM_API_RATINGS (
  RATING_ID INTEGER DEFAULT NEXTVAL ('AM_API_RATINGS_seq'),
...
CREATE SEQUENCE AM_API_COMMENTS_seq;

CREATE TABLE AM_API_COMMENTS (
  COMMENT_ID INTEGER DEFAULT NEXTVAL ('AM_API_COMMENTS_seq'),
  COMMENT_TEXT TEXT,
