...
CREATE TABLE `AM_APPLICATION_GROUP_PERMISSION` (
...
CREATE TABLE IF NOT EXISTS `AM_EVENT` (
  `EVENT` VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS `AM_EVENT_FUNCTION_MAPPING` (
  ...
  FOREIGN KEY (`EVENT`) REFERENCES `AM_EVENT`(`EVENT`) ON UPDATE CASCADE ON DELETE RESTRICT
);
