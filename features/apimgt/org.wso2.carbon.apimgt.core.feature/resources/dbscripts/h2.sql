...
INSERT INTO AM_APPLICATION_POLICY (UUID, NAME, DISPLAY_NAME, DESCRIPTION, QUOTA_TYPE, QUOTA, QUOTA_UNIT, UNIT_TIME,
            TIME_UNIT, IS_DEPLOYED) VALUES ('xxxxx', 'gold', 'Gold', 'Gold Tier', 'x', 10, 'REQ', 1, 's', 1);
INSERT INTO AM_APPLICATION_POLICY (UUID, NAME, DISPLAY_NAME, DESCRIPTION, QUOTA_TYPE, QUOTA, QUOTA_UNIT, UNIT_TIME,
            TIME_UNIT, IS_DEPLOYED) VALUES ('yyyyy', 'silver', 'Silver', 'Silver Tier', 'y', 50, 'REQ', 1, 's', 1);
Commit;