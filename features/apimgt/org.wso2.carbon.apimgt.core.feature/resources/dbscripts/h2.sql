...
INSERT INTO AM_API_POLICY (`UUID`, `NAME`, `DISPLAY_NAME`, `DESCRIPTION`,`DEFAULT_QUOTA_TYPE`,`DEFAULT_QUOTA`,`DEFAULT_UNIT_TIME`,`DEFAULT_TIME_UNIT`,`APPLICABLE_LEVEL`) VALUES ('1', 'Unlimited', 'Unlimited', 'Unlimited','',1,60,'s','API');
INSERT INTO AM_API_POLICY (`UUID`, `NAME`, `DISPLAY_NAME`, `DESCRIPTION`,`DEFAULT_QUOTA_TYPE`,`DEFAULT_QUOTA`,`DEFAULT_UNIT_TIME`,`DEFAULT_TIME_UNIT`,`APPLICABLE_LEVEL`) VALUES ('2', 'Gold', 'Gold', 'Gold','',1,60,'s','API');
INSERT INTO AM_API_POLICY (`UUID`, `NAME`, `DISPLAY_NAME`, `DESCRIPTION`,`DEFAULT_QUOTA_TYPE`,`DEFAULT_QUOTA`,`DEFAULT_UNIT_TIME`,`DEFAULT_TIME_UNIT`,`APPLICABLE_LEVEL`) VALUES ('3', 'Bronze', 'Bronze', 'Bronze','',1,60,'s','API');
INSERT INTO AM_API_POLICY (`UUID`, `NAME`, `DISPLAY_NAME`, `DESCRIPTION`,`DEFAULT_QUOTA_TYPE`,`DEFAULT_QUOTA`,`DEFAULT_UNIT_TIME`,`DEFAULT_TIME_UNIT`,`APPLICABLE_LEVEL`) VALUES ('4', 'Silver', 'Silver', 'Silver','',1,60,'s','API');
