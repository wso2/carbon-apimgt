...
/
-- Generate ID using sequence and trigger
CREATE SEQUENCE AM_API_RATINGS_seq START WITH 1 INCREMENT BY 1 NOCACHE
/

CREATE OR REPLACE TRIGGER AM_API_RATINGS_seq_tr
BEFORE INSERT ON AM_API_RATINGS FOR EACH ROW
WHEN (NEW.RATING_ID IS NULL)
  BEGIN
    SELECT AM_API_RATINGS_seq.NEXTVAL INTO :NEW.RATING_ID FROM DUAL;
  END;
/
...
/
-- Generate ID using sequence and trigger
CREATE SEQUENCE AM_API_COMMENTS_seq START WITH 1 INCREMENT BY 1 NOCACHE
/

CREATE OR REPLACE TRIGGER AM_API_COMMENTS_seq_tr
BEFORE INSERT ON AM_API_COMMENTS FOR EACH ROW
WHEN (NEW.COMMENT_ID IS NULL)
  BEGIN
    SELECT AM_API_COMMENTS_seq.NEXTVAL INTO :NEW.COMMENT_ID FROM DUAL;
  END;
/
