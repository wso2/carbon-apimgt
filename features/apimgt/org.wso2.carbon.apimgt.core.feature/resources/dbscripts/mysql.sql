...
CREATE TABLE `AM_ENDPOINT` (
  ...
  UPDATED_BY VARCHAR(100),
  LAST_UPDATED_TIME TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`UUID`))CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `AM_API` (
  ...
  `AM_API_PERMISSION` INT(11) DEFAULT '7',
  `UPDATED_BY` VARCHAR(100),
  ...
  FULLTEXT (`NAME`,`PROVIDER`,`CONTEXT`,`VERSION`,`DESCRIPTION`,`CURRENT_LC_STATUS`,`TECHNICAL_OWNER`, `BUSINESS_OWNER`)
)CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `AM_APPLICATION` (
  ...
  `UPDATED_BY` VARCHAR(100),
  `LAST_UPDATED_TIME` TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6),
  `AM_APPLICATION_PERMISSION` INT(11) DEFAULT '7',
  PRIMARY KEY (`UUID`),
  UNIQUE (NAME),
...
CREATE TABLE IF NOT EXISTS `AM_IP_RANGE_CONDITION` (
  `AM_IP_RANGE_CONDITION_ID` INTEGER AUTO_INCREMENT,
  `STARTING_IP` VARCHAR(45) NULL,
  `ENDING_IP` VARCHAR(45) NULL,
  `UUID` VARCHAR(254),
...
-- CREATE TABLE IF NOT EXISTS AM_THREAT_PROTECTION_JSON (
--   UUID VARCHAR(255),
--   API_ID VARCHAR(255),
--   ENABLED BOOLEAN DEFAULT 1,
--   MAX_FIELD_COUNT INT NOT NULL,
--   MAX_STRING_LENGTH INT NOT NULL,
--   MAX_ARRAY_ELEMENT_COUNT INT NOT NULL,
--   MAX_FIELD_LENGTH INT NOT NULL,
--   MAX_DEPTH INT NOT NULL,
--   FOREIGN KEY(`API_ID`) REFERENCES `AM_API`(`UUID`) ON UPDATE CASCADE ON DELETE CASCADE,
--   PRIMARY KEY(`UUID`)
-- )CHARACTER SET utf8 COLLATE utf8_general_ci;
--
-- CREATE TABLE IF NOT EXISTS AM_THREAT_PROTECTION_XML (
--   UUID VARCHAR(255),
--   API_ID VARCHAR(255),
--   ENABLED BOOLEAN DEFAULT 1,
--   DTD_ENABLED BOOLEAN,
--   EXTERNAL_ENTITIES_ENABLED BOOLEAN,
--   MAX_DEPTH INT NOT NULL,
--   MAX_ELEMENT_COUNT INT NOT NULL,
--   MAX_ATTRIBUTE_COUNT INT NOT NULL,
--   MAX_ATTRIBUTE_LENGTH INT NOT NULL,
--   ENTITY_EXPANSION_LIMIT INT NOT NULL,
--   MAX_CHILDREN_PER_ELEMENT INT NOT NULL,
--   FOREIGN KEY(`API_ID`) REFERENCES `AM_API`(`UUID`) ON UPDATE CASCADE ON DELETE CASCADE,
--   PRIMARY KEY(`UUID`)
-- )CHARACTER SET utf8 COLLATE utf8_general_ci;