...
class Details extends React.Component {
  ...
  render() {
    ...
    const { notFound, doc, isEditable, files } = this.state;
      ...
      <Grid container spacing={0} direction='row' justify='flex-start' alignItems='stretch'>
        <Grid item xs={12}>
          <Grid container>
            ...
            <Grid item>
              <Button size="small" className={classes.button} onClick={this.editDocument} disabled={isEditable}>
          ...
          <Grid container direction='column'>
            <Grid item >
              ...
              <Select
                ...
                input={!isEditable ? <Input name="name" id="name-readonly" readOnly />
