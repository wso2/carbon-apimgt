...
class Documents extends Component {
    ...
    componentDidMount() {
        const api = new API();
        const promisedAPI = api.get(this.props.api.id);
        promisedAPI
            .then((response) => {
    ...
    submitAddNewDocListener() {
        ...
        const promisedAdd = this.client.addDocument(this.props.api.id, apiDocumentsData);
        promisedAdd
            .then((done) => {
        ...
        return (
            <div>
                ...
                <ScopeValidation resourcePath={resourcePath.API_DOCS} resourceMethod={resourceMethod.POST}>
                    <ApiPermissionValidation userPermissions={this.props.api.userPermissionsForApi}>
