...
import { Col, Row, Card, Form, Select, Dropdown, Tag, Menu , Button } from 'antd';
                    ...
                    <Col span={4}>
                        ...
                        <Card bodyStyle={{ padding: 10 }} bordered={false}>
                            <div className="custom-image">
                                <img alt="example" width="100%" src="http://placekitten.com/g/200/200" />
                            </div>
                            <div className="custom-card">
                                <h3>{this.state.api.lifeCycleStatus}</h3>
                                <p>11 Apps</p>
