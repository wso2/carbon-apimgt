            ...
            <div className='message message-warning'>
                <h4>
                    <FormattedMessage
                        ...
                        defaultMessage='External Devportals not found for api: '
                    />
        ...
        API.getPublishedExternalStores(api.id)
            ...
            .catch((error) => {
                ...
                Alert.error(intl.formatMessage({
                    ...
                    defaultMessage: 'Error while getting published external devportals!! {reason}',
                }, { reason }));
            });
    }
        ...
        API.publishAPIToExternalStores(api.id, publishedExternalStores)
            .then((response) => {
                ...
                Alert.success(intl.formatMessage({
                    ...
                    defaultMessage: 'Successfully Published to external devportals: ',
                }, { successfulStores }));
            })
            .catch((error) => {
                const response = error.response && error.response.obj;
                ...
                Alert.error(intl.formatMessage({
                    ...
                    defaultMessage: 'Error while updating external devportals!! {reason}',
                }, { reason }));
            })
            .finally(() => {
                setUpdating(false);
                                ...
                                <Grid item>
                                    <Typography variant='body2' color='primary'>
                                        <FormattedMessage
                                            ...
                                            ' to external devportals due to insufficient permissions'}
                                        />
                                    </Typography>
                                </Grid>
                            )
