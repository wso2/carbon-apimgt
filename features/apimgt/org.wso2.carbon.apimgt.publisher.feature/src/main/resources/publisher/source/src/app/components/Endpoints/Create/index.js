...
import {Row, Col, Input, Radio, InputNumber, Switch, Button} from 'antd'
                    ...
                    <Row type="flex" justify="center">
                        ...
                        <Col span={8}>
                            <RadioGroup value={this.state.endpointType}
                                        onChange={e => {e.target["name"]="endpointType";this.handleInputs(e)}}>
                                ...
                                <Row>
                                    ...
                                    <Col span={8}>
                                        <RadioGroup value={this.state.securityType}
                                                    onChange={e => {e.target["name"]="securityType";this.handleInputs(e)}}>
