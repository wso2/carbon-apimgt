                ...
                <TextField
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Devportal Visibility'
                        />
                    }
                    ...
                    helperText={
                        <FormattedMessage
                            ...
                            defaultMessage='By default API is visible to all devportal users'
                        />
                    }
                    margin='normal'
                    variant='outlined'
                            ...
                            <p>
                                ...
                                <FormattedMessage
                                    ...
                                    defaultMessage={
                                        ...
                                        'in multiple devportals - a central devportal and/or non-WSO2 devportals.'
                                    }
                                />
                                <br />
                                <br />
                                ...
                                <FormattedMessage
                                    ...
                                    defaultMessage={
                                        ...
                                        ' roles in the tenant devportal that you specify.'
                                    }
                                />
                            </p>
                        </React.Fragment>
