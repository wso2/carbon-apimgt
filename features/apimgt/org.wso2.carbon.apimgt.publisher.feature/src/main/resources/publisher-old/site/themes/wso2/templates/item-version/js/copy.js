var copyAPIToNewVersion = function (provider) {
    ...
    jagg.post("/site/blocks/item-version/ajax/version.jag", { action:"createNewAPI", provider:provider,apiName:apiName, version:version, newVersion:newVersion ,isDefaultVersion:isDefaultVersion},
              function (result) {
                  if (!result.error) {
