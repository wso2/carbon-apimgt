 ...
 * @extends {Component}
 */
class AppErrorBoundaryStyled extends React.Component {
    /**
                    ...
                    <div className={classes.errorDisplay}>
                        <div className={classes.errorDisplayContent}>
                            <div className={classes.errorTitle}>
                                <img src='/publisher-new/static/public/images/robo.png' alt='OOPS' />
...
AppErrorBoundaryStyled.propTypes = {
    children: PropTypes.node.isRequired,
    classes: PropTypes.shape({}).isRequired,
    theme: PropTypes.shape({}).isRequired,
};

export default withStyles(styles, { withTheme: true })(AppErrorBoundaryStyled);
