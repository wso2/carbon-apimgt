...
import org.wso2.carbon.apimgt.rest.api.admin.v1.common.impl.TenantInfoCommonImpl;
...
public class TenantInfoApiServiceImpl implements TenantInfoApiService {
    ...
    public Response getTenantInfoByUsername(String username, MessageContext messageContext)
        ...
        if (StringUtils.isEmpty(username)) {
            throw new APIManagementException("User Name should not be empty",
                    ExceptionCodes.PARAMETER_NOT_PROVIDED);
        }
        TenantInfoDTO tenantInfoDTO = TenantInfoCommonImpl.getTenantInfoByUsername(username);
