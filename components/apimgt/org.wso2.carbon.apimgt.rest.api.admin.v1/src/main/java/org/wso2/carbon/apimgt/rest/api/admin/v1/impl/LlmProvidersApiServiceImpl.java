...
public class LlmProvidersApiServiceImpl implements LlmProvidersApiService {
     ...
     */
    @Override
    public Response addLLMProvider(String name, String apiVersion, String description, Boolean multipleVendorSupport,
        ...
        try {
            ...
            LLMProvider provider = buildLLMProvider(name, apiVersion, description, configurations,
                    apiDefinitionInputStream, models, multipleVendorSupport);
            if (provider == null) {
    ...
    private LLMProvider buildLLMProvider(String name, String apiVersion, String description, String configurations,
        ...
        provider.setModelFamilySupported(multipleVendorSupport);
        ...
        try {
            ...
            LLMProvider provider =
                    buildUpdatedLLMProvider(retrievedProvider, llmProviderId, description, configurations,
                            apiDefinitionInputStream, models);
