...
public class PolicyDTO   {
   ...
   * Id of policy
   **/
  public PolicyDTO policyId(Integer policyId) {
   ...
   * UUId of policy
   **/
  public PolicyDTO uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
   ...
   * Name of policy
   **/
  public PolicyDTO policyName(String policyName) {
 ...
 @Size(min=1,max=60)  public String getPolicyName() {
   ...
   **/
  public PolicyDTO displayName(String displayName) {
 ...
 @Size(max=1024)  public String getDescription() {
   ...
   **/
  public PolicyDTO isDeployed(Boolean isDeployed) {
   ...
   **/
  public PolicyDTO type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PolicyDTO policy = (PolicyDTO) o;
    return Objects.equals(policyId, policy.policyId) &&
        Objects.equals(uuid, policy.uuid) &&
        ...
        Objects.equals(isDeployed, policy.isDeployed) &&
        Objects.equals(type, policy.type);
  }
