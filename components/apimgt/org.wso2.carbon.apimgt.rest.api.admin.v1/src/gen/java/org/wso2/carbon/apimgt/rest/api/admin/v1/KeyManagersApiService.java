...
public interface KeyManagersApiService {
      ...
      public Response keyManagersKeyManagerIdPut(String keyManagerId, KeyManagerDTO keyManagerDTO, String tokenType, MessageContext messageContext) throws APIManagementException;
      public Response keyManagersPost(KeyManagerDTO keyManagerDTO, String tokenType, MessageContext messageContext) throws APIManagementException;
}
