...
KeyManagersApiService delegate = new KeyManagersApiServiceImpl();
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class) })
    public Response keyManagersKeyManagerIdPut(@ApiParam(value = "Key Manager UUID ",required=true) @PathParam("keyManagerId") String keyManagerId, @ApiParam(value = "Key Manager object with updated information " ,required=true) KeyManagerDTO keyManagerDTO,  @ApiParam(value = "The type of the tokens to be used (exchanged or without exchanged) ", allowableValues="EXCHANGED, ORIGINAL", defaultValue="ORIGINAL") @DefaultValue("ORIGINAL") @QueryParam("tokenType") String tokenType) throws APIManagementException{
        return delegate.keyManagersKeyManagerIdPut(keyManagerId, keyManagerDTO, tokenType, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Bad Request. Invalid request or validation error.", response = ErrorDTO.class) })
    public Response keyManagersPost(@ApiParam(value = "Key Manager object that should to be added " ,required=true) KeyManagerDTO keyManagerDTO,  @ApiParam(value = "The type of the tokens to be used (exchanged or without exchanged) ", allowableValues="EXCHANGED, ORIGINAL", defaultValue="ORIGINAL") @DefaultValue("ORIGINAL") @QueryParam("tokenType") String tokenType) throws APIManagementException{
        return delegate.keyManagersPost(keyManagerDTO, tokenType, securityContext);
    }
}
