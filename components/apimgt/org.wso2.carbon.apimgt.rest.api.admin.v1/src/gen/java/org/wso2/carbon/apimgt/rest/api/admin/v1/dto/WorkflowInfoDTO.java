...
public enum WorkflowTypeEnum {
    ...
    @XmlEnumValue("AM_APPLICATION_CREATION") APPLICATION_CREATION(String.valueOf("AM_APPLICATION_CREATION")), @XmlEnumValue("AM_SUBSCRIPTION_CREATION") SUBSCRIPTION_CREATION(String.valueOf("AM_SUBSCRIPTION_CREATION")), @XmlEnumValue("AM_USER_SIGNUP") USER_SIGNUP(String.valueOf("AM_USER_SIGNUP")), @XmlEnumValue("AM_APPLICATION_REGISTRATION_PRODUCTION") APPLICATION_REGISTRATION_PRODUCTION(String.valueOf("AM_APPLICATION_REGISTRATION_PRODUCTION")), @XmlEnumValue("AM_APPLICATION_REGISTRATION_SANDBOX") APPLICATION_REGISTRATION_SANDBOX(String.valueOf("AM_APPLICATION_REGISTRATION_SANDBOX")), @XmlEnumValue("AM_APPLICATION_DELETION") APPLICATION_DELETION(String.valueOf("AM_APPLICATION_DELETION")), @XmlEnumValue("AM_API_STATE") API_STATE(String.valueOf("AM_API_STATE")), @XmlEnumValue("AM_SUBSCRIPTION_DELETION") SUBSCRIPTION_DELETION(String.valueOf("AM_SUBSCRIPTION_DELETION"));
