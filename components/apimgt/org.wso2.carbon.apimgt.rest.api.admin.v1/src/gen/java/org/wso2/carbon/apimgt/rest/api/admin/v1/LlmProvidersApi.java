...
LlmProvidersApiService delegate = new LlmProvidersApiServiceImpl();
    ...
    public Response addLLMProvider(@Multipart(value = "name", required = false)  String name, @Multipart(value = "apiVersion", required = false)  String apiVersion, @Multipart(value = "description", required = false)  String description, @Multipart(value = "multipleVendorSupport", required = false)  String multipleVendorSupport, @Multipart(value = "configurations", required = false)  String configurations,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "models", required = false)  String models) throws APIManagementException{
