...
LlmProvidersApiService delegate = new LlmProvidersApiServiceImpl();
    ...
    public Response addLLMProvider(@Multipart(value = "name", required = false)  String name, @Multipart(value = "apiVersion", required = false)  String apiVersion, @Multipart(value = "description", required = false)  String description, @Multipart(value = "multipleVendorSupport", required = false)  Boolean multipleVendorSupport, @Multipart(value = "configurations", required = false)  String configurations,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "models", required = false)  List<LLMModelDTO> models) throws APIManagementException{
        return delegate.addLLMProvider(name, apiVersion, description, multipleVendorSupport, configurations, apiDefinitionInputStream, apiDefinitionDetail, models, securityContext);
    }
    ...
    public Response updateLLMProvider(@ApiParam(value = "LLM Provider UUID ",required=true) @PathParam("llmProviderId") String llmProviderId, @Multipart(value = "name", required = false)  String name, @Multipart(value = "apiVersion", required = false)  String apiVersion, @Multipart(value = "description", required = false)  String description, @Multipart(value = "multipleVendorSupport", required = false)  Boolean multipleVendorSupport, @Multipart(value = "configurations", required = false)  String configurations,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "models", required = false)  List<LLMModelDTO> models) throws APIManagementException{
        return delegate.updateLLMProvider(llmProviderId, name, apiVersion, description, multipleVendorSupport, configurations, apiDefinitionInputStream, apiDefinitionDetail, models, securityContext);
    }
}
