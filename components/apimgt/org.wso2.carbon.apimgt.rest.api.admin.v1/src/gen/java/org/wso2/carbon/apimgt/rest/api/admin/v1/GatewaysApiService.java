...
public interface GatewaysApiService {
      ...
      public Response gatewaysGatewayIdPatch(String gatewayId, UpdatePlatformGatewayRequestDTO updatePlatformGatewayRequestDTO, MessageContext messageContext) throws APIManagementException;
