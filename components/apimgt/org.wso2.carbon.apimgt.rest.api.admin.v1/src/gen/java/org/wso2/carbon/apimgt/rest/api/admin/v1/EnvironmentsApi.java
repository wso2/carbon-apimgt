...
EnvironmentsApiService delegate = new EnvironmentsApiServiceImpl();
    ...
    public Response addEnvironment(@ApiParam(value = "Environment object that should to be added " ,required=true) EnvironmentDTO environmentDTO) throws APIManagementException{
        return delegate.addEnvironment(environmentDTO, securityContext);
    }
    ...
    public Response getEnvironments() throws APIManagementException{
        return delegate.getEnvironments(securityContext);
    }
    ...
    public Response removeEnvironment(@ApiParam(value = "Environment UUID (or Environment name defined in config) ",required=true) @PathParam("environmentId") String environmentId) throws APIManagementException{
        return delegate.removeEnvironment(environmentId, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Bad Request. Invalid request or validation error.", response = ErrorDTO.class),
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class) })
    public Response updateEnvironment(@ApiParam(value = "Environment UUID (or Environment name defined in config) ",required=true) @PathParam("environmentId") String environmentId, @ApiParam(value = "Environment object with updated information " ,required=true) EnvironmentDTO environmentDTO) throws APIManagementException{
        return delegate.updateEnvironment(environmentId, environmentDTO, securityContext);
    }
}
