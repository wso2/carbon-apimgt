...
AiServiceProvidersApiService delegate = new AiServiceProvidersApiServiceImpl();
    ...
    public Response addAIServiceProvider(@Multipart(value = "name", required = false)  String name, @Multipart(value = "apiVersion", required = false)  String apiVersion, @Multipart(value = "description", required = false)  String description, @Multipart(value = "multitpleModelProviderSupport", required = false)  String multitpleModelProviderSupport, @Multipart(value = "configurations", required = false)  String configurations,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "modelProviders", required = false)  String modelProviders) throws APIManagementException{
        return delegate.addAIServiceProvider(name, apiVersion, description, multitpleModelProviderSupport, configurations, apiDefinitionInputStream, apiDefinitionDetail, modelProviders, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Bad Request. Invalid request or validation error.", response = ErrorDTO.class),
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class) })
    public Response updateAIServiceProvider(@ApiParam(value = "AI Service Provider UUID ",required=true) @PathParam("aiServiceProviderId") String aiServiceProviderId, @Multipart(value = "name", required = false)  String name, @Multipart(value = "apiVersion", required = false)  String apiVersion, @Multipart(value = "description", required = false)  String description, @Multipart(value = "multitpleModelProviderSupport", required = false)  String multitpleModelProviderSupport, @Multipart(value = "configurations", required = false)  String configurations,  @Multipart(value = "apiDefinition", required = false) InputStream apiDefinitionInputStream, @Multipart(value = "apiDefinition" , required = false) Attachment apiDefinitionDetail, @Multipart(value = "modelProviders", required = false)  String modelProviders) throws APIManagementException{
        return delegate.updateAIServiceProvider(aiServiceProviderId, name, apiVersion, description, multitpleModelProviderSupport, configurations, apiDefinitionInputStream, apiDefinitionDetail, modelProviders, securityContext);
    }
}
