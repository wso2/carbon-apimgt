...
public class LLMProviderRequestDTO   {
    ...
    private String multipleVendorSupport = "false";
 ...
 @Size(max=1023)  public String getDescription() {
   ...
   **/
  public LLMProviderRequestDTO multipleVendorSupport(String multipleVendorSupport) {
  ...
  public String getMultipleVendorSupport() {
    return multipleVendorSupport;
  }
  public void setMultipleVendorSupport(String multipleVendorSupport) {
    this.multipleVendorSupport = multipleVendorSupport;
  }
  ...
  /**
   **/
  public LLMProviderRequestDTO models(String models) {
    this.models = models;
    return this;
  }
