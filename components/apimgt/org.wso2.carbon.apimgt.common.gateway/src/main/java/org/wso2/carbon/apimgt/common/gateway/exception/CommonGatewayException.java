 ...
 */
public class CommonGatewayException extends Exception {
    ...
    public CommonGatewayException(String msg) {
        super(msg);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }

    public CommonGatewayException(String msg, Throwable e) {
        super(msg, e);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }

    public CommonGatewayException(Throwable throwable) {
        super(throwable);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }
     ...
     */
    public CommonGatewayException(String message, ErrorHandler code) {
        super(message);
     ...
     * @param code Exception code that need to pass to the error DTO
     */
    public CommonGatewayException(ErrorHandler code) {
     ...
     * @param code Exception code that need to pass to the error DTO
     */
    public CommonGatewayException(String message, Throwable cause, ErrorHandler code) {
        super(message, cause);
        this.errorHandler = code;
    }
}
