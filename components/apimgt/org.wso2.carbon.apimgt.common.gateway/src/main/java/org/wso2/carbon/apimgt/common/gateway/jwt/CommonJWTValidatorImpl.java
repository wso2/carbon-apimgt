...
/**
 * CommonJWTValidatorImpl keeps the common logic between the deprecated JWTValidatorImpl and the new implementation.
 * This is required because of the protected methods implemented inside the deprecated JWTValidatorImpl.
 */
public class CommonJWTValidatorImpl {
    private final Log log = LogFactory.getLog(CommonJWTValidatorImpl.class);
    private JWTValidatorConfiguration jwtValidatorConfiguration;
    protected JWTTransformer jwtTransformer;

    protected JWKSet jwkSet;

    protected TokenIssuerDto tokenIssuer;

    protected boolean isValidCertificateBoundAccessToken(SignedJWTInfo signedJWTInfo) { //Holder of Key token
    ...
    protected void createJWTValidationInfoFromJWT(JWTValidationInfo jwtValidationInfo,
    ...
    protected void loadConfiguration(JWTValidatorConfiguration jwtValidatorConfiguration) {
