...
public class APIMgtGatewayUrlSafeJWTGeneratorImplTest {

    @Test
    public void testEncode() {
        // Test whether the encode method is base64url encoding.
        APIMgtGatewayUrlSafeJWTGeneratorImpl apiMgtGatewayUrlSafeJWTGenerator =
                new APIMgtGatewayUrlSafeJWTGeneratorImpl();
        String stringToBeEncoded = "<<???>>";
        String expectedEncodedString = "PDw_Pz8-Pg";
        try {
            String actualEncodedString = apiMgtGatewayUrlSafeJWTGenerator.encode(stringToBeEncoded.getBytes());
