...
public class PoliciesApiServiceImpl extends PoliciesApiService {
    ...
    @Override
    public Response policiesTierLevelTierNameDelete(String tierName, String tierLevel, String ifMatch,
    ...
    @Override
    public Response policiesTierLevelTierNamePut(String tierName, TierDTO body, String tierLevel, String contentType,
