...
public class TiersApi  {
   ...
   private final TiersApiService delegate = TiersApiServiceFactory.getTiersApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update Tier Permission", notes = "Update tier permission", response = TierDTO.class, responseContainer = "List")
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "List Tiers", notes = "Get available tiers", response = TierListDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Add a new Tier", notes = "Add a new tier", response = TierDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get a Tier", notes = "Get tier details", response = TierDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nTier returned"),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update a Tier", notes = "Update tier details", response = TierDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Delete a Tier", notes = "Remove a tier", response = Void.class)
    @io.swagger.annotations.ApiResponses(value = { 
