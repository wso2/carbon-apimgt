...
public class EnvironmentsApi  {
   ...
   private final EnvironmentsApiService delegate = EnvironmentsApiServiceFactory.getEnvironmentsApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get gateway environments", notes = "Get a list of gateway environments configured previously.", response = EnvironmentListDTO.class)
