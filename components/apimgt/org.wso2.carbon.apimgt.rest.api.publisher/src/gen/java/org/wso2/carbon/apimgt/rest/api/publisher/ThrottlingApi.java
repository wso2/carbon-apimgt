...
import org.wso2.carbon.apimgt.rest.api.publisher.factories.ThrottlingApiServiceFactory;
...
public class ThrottlingApi  {
   ...
   private final ThrottlingApiService delegate = ThrottlingApiServiceFactory.getThrottlingApi();
    ...
    public Response throttlingBlockingConditionsGet(@ApiParam(value = "Media types acceptable for the response. Default is JSON.\n"  , defaultValue="JSON")@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on the ETag of the formerly retrieved\nvariant of the resourec.\n"  )@HeaderParam("If-None-Match") String ifNoneMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header of the\nformerly retrieved variant of the resource.\n"  )@HeaderParam("If-Modified-Since") String ifModifiedSince)
    {
    return delegate.throttlingBlockingConditionsGet(accept,ifNoneMatch,ifModifiedSince);
    }
    @POST
    @Path("/blocking-conditions")
    @Consumes({ "application/json" })
    ...
    public Response throttlingPoliciesAdvancedPoliciesGet(@ApiParam(value = "Media types acceptable for the response. Default is JSON.\n"  , defaultValue="JSON")@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on the ETag of the formerly retrieved\nvariant of the resourec.\n"  )@HeaderParam("If-None-Match") String ifNoneMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header of the\nformerly retrieved variant of the resource.\n"  )@HeaderParam("If-Modified-Since") String ifModifiedSince)
    {
    return delegate.throttlingPoliciesAdvancedPoliciesGet(accept,ifNoneMatch,ifModifiedSince);
    }
    @POST
    @Path("/policies/advanced-policies")
    @Consumes({ "application/json" })
    ...
    public Response throttlingPoliciesGlobalGet(@ApiParam(value = "Media types acceptable for the response. Default is JSON.\n"  , defaultValue="JSON")@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on the ETag of the formerly retrieved\nvariant of the resourec.\n"  )@HeaderParam("If-None-Match") String ifNoneMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header of the\nformerly retrieved variant of the resource.\n"  )@HeaderParam("If-Modified-Since") String ifModifiedSince)
    {
    return delegate.throttlingPoliciesGlobalGet(accept,ifNoneMatch,ifModifiedSince);
    }
    @POST
    @Path("/policies/global")
    @Consumes({ "application/json" })
