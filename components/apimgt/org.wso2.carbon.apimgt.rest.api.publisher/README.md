...
/sample:
    get:
      ...
      x-wso2-curl: "curl -k -H \"Authorization: Bearer ae4eae22-3f65-387b-a171-d37eaa366fa8\" https://127.0.0.1:9443/api/am/publisher/v0.16/sample"
      x-wso2-request: |
       GET https://127.0.0.1:9443/api/am/publisher/v0.16/sample
...
14. Build the org.wso2.carbon.apimgt.rest.api.publisher and deploy the api#am#publisher#v0.16.war in the pack
...
```
curl -H "Authorization: Bearer <access-token>" https://localhost:9443/api/am/publisher/v0.16/sample -k -v
