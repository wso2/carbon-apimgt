...
public class APIKeyMgtSubscriberService extends AbstractAdmin {
    ...
    public OAuthApplicationInfo createOAuthApplicationByApplicationInfo(OAuthApplicationInfo oauthApplicationInfo)
            throws TokenMgtException, APIManagementException {
        ...
        try {
            ...
            if (serviceProviderCreated == null) {
                throw new TokenMgtException("Couldn't create Service Provider Application " + applicationName);
            }
    ...
    public OAuthApplicationInfo createOAuthApplication(String userId, String applicationName, String callbackUrl,
            String tokenType) throws TokenMgtException, APIManagementException {
    ...
    public OAuthApplicationInfo updateOAuthApplication(String userId, String applicationName, String callbackUrl,
            ...
            throws TokenMgtException, APIManagementException, IdentityException {
     ...
     * @throws TokenMgtException Error when getting the list of APIs from the persistence store.
     */
    public APIInfoDTO[] getSubscribedAPIsOfUser(String userId) throws TokenMgtException,
