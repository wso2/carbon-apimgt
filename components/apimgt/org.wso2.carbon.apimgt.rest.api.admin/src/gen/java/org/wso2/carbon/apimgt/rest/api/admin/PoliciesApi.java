...
,@ApiParam(value = "Validator for API Minor Version " , defaultValue="1.0")@HeaderParam("Minor-Version") String minorVersion
    ...
    throws NotFoundException {
        return delegate.policiesTierLevelPut(tierName,body,tierLevel,contentType,ifMatch,ifUnmodifiedSince,minorVersion);
    }
    @POST
...
,@ApiParam(value = "" ) TierPermissionDTO permissions
    ...
    throws NotFoundException {
        return delegate.policiesUpdatePermissionPost(tierName,tierLevel,ifMatch,ifUnmodifiedSince,minorVersion,permissions);
    }
}
