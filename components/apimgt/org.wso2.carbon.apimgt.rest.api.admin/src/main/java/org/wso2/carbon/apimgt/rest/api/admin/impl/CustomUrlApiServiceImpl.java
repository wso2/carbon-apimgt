...
public class CustomUrlApiServiceImpl extends CustomUrlApiService {
        ...
        try {
            ...
            if(perTenantServiceProviderEnabled) {
                ...
                if(tenantBasedStoreDomainMapping != null) {
                    customUrlInfoDTO.setCustomUrl((String)tenantBasedStoreDomainMapping.get("customUrl"));
                }
            }
            customUrlInfoDTO.setTenantAdminUsername(APIUtil.getTenantAdminUserName(tenantDomain));
            customUrlInfoDTO.setIsCustomUrlEnabled(perTenantServiceProviderEnabled);
