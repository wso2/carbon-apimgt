...
public final class APIConstants {
    ...
    public static final String API_LIFE_CYCLE_HISTORY = "/repository/components/org.wso2.carbon" +
    ...
    //Registry location where descriptions and thumbnails of the tags are stored.
    ...
    public static final String EXTERNAL_API_STORES_LOCATION = APIMGT_REGISTRY_LOCATION +
             "/externalstores/external-api-stores.xml";
    ...
    public static final String API_STORE_RECENTLY_ADDED_API_CACHE_ENABLE = CACHE_CONFIGS +
             "EnableRecentlyAddedAPICache";
    ...
    public static final String API_KEY_VALIDATOR_CONNECTION_TIMEOUT = API_KEY_VALIDATOR +
    ...
    public static final String CLIENT_CODEGEN_SUPPORTED_LANGUAGES = "SwaggerCodegen.ClientGeneration" +
             ".SupportedLanguages";
