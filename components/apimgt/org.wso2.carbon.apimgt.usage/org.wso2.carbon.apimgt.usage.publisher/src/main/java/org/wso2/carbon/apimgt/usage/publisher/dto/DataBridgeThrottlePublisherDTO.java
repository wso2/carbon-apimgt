...
public class DataBridgeThrottlePublisherDTO extends ThrottlePublisherDTO{
    ...
    public DataBridgeThrottlePublisherDTO(ThrottlePublisherDTO throttlePublisherDTO){
        ...
        setAccessLevel(throttlePublisherDTO.getAccessLevel());
        setRequestTime(throttlePublisherDTO.getRequestTime());
    ...
    public static String getStreamDefinition() {
        ...
        String streamDefinition =  "{" +
                "  'name':'" + APIMgtUsagePublisherConstants.API_MANAGER_THROTTLE_STREAM_NAME + "'," +
                "  'version':'" + APIMgtUsagePublisherConstants.API_MANAGER_THROTTLE_STREAM_VERSION + "'," +
    ...
    public Object createPayload(){
        return new Object[]{getAccessToken(), getUsername(),getTenantDomain(),getApiname(),getVersion(),getContext(),getProvider(),getAccessLevel(),getRequestTime()};
    }
}
