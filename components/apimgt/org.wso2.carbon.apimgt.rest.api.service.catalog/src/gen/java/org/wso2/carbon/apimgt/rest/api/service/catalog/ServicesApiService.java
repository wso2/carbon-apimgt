...
public interface ServicesApiService {
      ...
      public Response importService(String serviceId, InputStream fileInputStream, Attachment fileDetail, String ifMatch, Boolean overwrite, List<VerifierDTO> verifier, MessageContext messageContext) throws APIManagementException;
