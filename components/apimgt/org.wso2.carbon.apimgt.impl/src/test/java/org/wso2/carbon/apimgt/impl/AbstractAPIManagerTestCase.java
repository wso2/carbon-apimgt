...
public class AbstractAPIManagerTestCase {
    ...
    public void testGetAllApis() throws GovernanceException, APIManagementException {
        ...
        GenericArtifact genericArtifact = new GenericArtifactImpl("1", new QName("test"), "");
        genericArtifact.setAttribute(APIConstants.API_OVERVIEW_PROVIDER, "admin");
        genericArtifact.setAttribute(APIConstants.API_OVERVIEW_NAME, "test");
        genericArtifact.setAttribute(APIConstants.API_OVERVIEW_VERSION, "1.0.0");
        genericArtifacts[0] = genericArtifact;
        Mockito.when(genericArtifactManager.getAllGenericArtifacts()).thenReturn(genericArtifacts);
