...
CREATE TABLE IF NOT EXISTS AM_POLICY (
            ...
            RATE_LIMIT_TIME_UNIT VARCHAR(25),
...
CREATE TABLE IF NOT EXISTS AM_CONDITION (
            ...
            FOREIGN KEY (POLICY_ID) REFERENCES AM_POLICY(POLICY_ID) ON DELETE CASCADE ON UPDATE CASCADE
)ENGINE INNODB;
