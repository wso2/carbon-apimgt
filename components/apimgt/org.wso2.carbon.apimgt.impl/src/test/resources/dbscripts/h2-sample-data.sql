...
INSERT INTO AM_API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT) VALUES ('CERTIFICATE', 'API1', '1.0.0','/abcde');
INSERT INTO AM_API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT) VALUES ('testUser1', 'testAPI1', '1.0.0','/sample/api');
INSERT INTO AM_API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT) VALUES ('testUser1@wso2.test', 'testAPI1', '1.0.0','/t/wso2.test/sample/api');
INSERT INTO AM_API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT) VALUES ('RASIKA', 'API1', '1.0.0','/test');
...
INSERT INTO IDN_OAUTH_CONSUMER_APPS (CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, USER_DOMAIN, APP_NAME, OAUTH_VERSION, CALLBACK_URL, GRANT_TYPES) VALUES ('getOAuthApplication', 'getOAuthApplication', 'getOAuthApplication', '-1234', 'PRIMARY', 'admin-app1-Production', '2.0', 'http://localhost', 'client_credentials');
...
INSERT INTO AM_CERTIFICATE_METADATA VALUES (-1234, 'ALIAS1',RAWTOHEX('abcdefghtij'), 'EP1');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (-1234, 'ALIAS2',RAWTOHEX('abcdefghtij'), 'EP2');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (-1234, 'ALIAS3',RAWTOHEX('abcdefghtij'), 'EP3');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (-1234, 'ALIAS4',RAWTOHEX('abcdefghtij'), 'EP4');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (-1234, 'ALIAS5',RAWTOHEX('abcdefghtij'), 'EP5');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (1001, 'ALIAS_1',RAWTOHEX('abcdefghtij'), 'EP_1');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (1001, 'ALIAS_2',RAWTOHEX('abcdefghtij'), 'EP_2');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (1002, 'ALIAS_3',RAWTOHEX('abcdefghtij'), 'EP_3');
INSERT INTO AM_CERTIFICATE_METADATA VALUES (1002, 'ALIAS_4', RAWTOHEX('abcdefghtij'),'EP_4');
