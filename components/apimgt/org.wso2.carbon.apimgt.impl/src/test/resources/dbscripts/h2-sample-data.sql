...
VALUES ('Gold','api',-1234,'per user','This is gold description','RequestCount',1000,1,'min',100,'sec');
...
VALUES (1,'1.1.1.1','3.3.3.3',null,'GET',null,null,null,'RequestCount',100,10,'sec');
