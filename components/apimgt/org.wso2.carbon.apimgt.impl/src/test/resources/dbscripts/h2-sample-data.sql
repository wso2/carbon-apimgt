...
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN ( TOKEN_ID, ACCESS_TOKEN ,AUTHZ_USER , USER_TYPE , CONSUMER_KEY_ID , REFRESH_TOKEN ,TIME_CREATED , REFRESH_TOKEN_TIME_CREATED, TOKEN_SCOPE_HASH , TOKEN_STATE ,VALIDITY_PERIOD, USER_DOMAIN ) VALUES ('TI1','a1b2c3d4','UDAYANGA','DEVELOPER',1,NULL,'2017-01-01','2017-01-01','SANDBOXHASH','ACTIVE',1343714931875, 'primary');
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN ( TOKEN_ID, ACCESS_TOKEN ,AUTHZ_USER , USER_TYPE , CONSUMER_KEY_ID , REFRESH_TOKEN ,TIME_CREATED , REFRESH_TOKEN_TIME_CREATED, TOKEN_SCOPE_HASH , TOKEN_STATE ,VALIDITY_PERIOD, USER_DOMAIN ) VALUES ('TI2','p1q2r3s4','UDAYANGA','DEVELOPER',1,NULL,'2012-01-01','2017-01-02','PRODUCTIONHASH','ACTIVE',1343714931875, 'primary');
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN ( TOKEN_ID, ACCESS_TOKEN ,AUTHZ_USER , USER_TYPE , CONSUMER_KEY_ID , REFRESH_TOKEN ,TIME_CREATED , REFRESH_TOKEN_TIME_CREATED, TOKEN_SCOPE_HASH , TOKEN_STATE ,VALIDITY_PERIOD, USER_DOMAIN ) VALUES ('TI3','test1','UDAYANGA','DEVELOPER',1,NULL,'2012-01-01','2017-01-03','PRODUCTIONHASH','ACTIVE',1343714931875, 'primary');
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN ( TOKEN_ID, ACCESS_TOKEN ,AUTHZ_USER , USER_TYPE , CONSUMER_KEY_ID , REFRESH_TOKEN ,TIME_CREATED , REFRESH_TOKEN_TIME_CREATED, TOKEN_SCOPE_HASH , TOKEN_STATE ,VALIDITY_PERIOD, USER_DOMAIN ) VALUES ('TI4','test2','UDAYANGA','DEVELOPER',2,NULL,'2012-01-01','2017-01-01','SANDBOXHASH','ACTIVE',1343714931875, 'primary');
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN ( TOKEN_ID, ACCESS_TOKEN ,AUTHZ_USER , USER_TYPE , CONSUMER_KEY_ID , REFRESH_TOKEN ,TIME_CREATED , REFRESH_TOKEN_TIME_CREATED, TOKEN_SCOPE_HASH , TOKEN_STATE ,VALIDITY_PERIOD, USER_DOMAIN) VALUES ('TI5','test3','UDAYANGA','DEVELOPER',3,NULL,'2012-01-01','2017-01-29','PRODUCTIONHASH','ACTIVE',3600, 'primary');

INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE (TOKEN_ID, TOKEN_SCOPE, TENANT_ID ) VALUES ('TI1','SANDBOX', -1);
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE (TOKEN_ID, TOKEN_SCOPE, TENANT_ID ) VALUES ('TI2','PRODUCTION', -1);
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE (TOKEN_ID, TOKEN_SCOPE, TENANT_ID ) VALUES ('TI3','PRODUCTION', -1);
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE (TOKEN_ID, TOKEN_SCOPE, TENANT_ID ) VALUES ('TI4','SANDBOX', -1);
INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_SCOPE (TOKEN_ID, TOKEN_SCOPE, TENANT_ID ) VALUES ('TI5','PRODUCTION', -1);
