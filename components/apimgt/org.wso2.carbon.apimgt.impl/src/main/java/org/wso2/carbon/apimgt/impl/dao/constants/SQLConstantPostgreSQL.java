...
public class SQLConstantPostgreSQL extends SQLConstants{
    ...
    public static final String GET_REPLIES_SQL =
            "SELECT " +
                    ...
                    "AND PARENT_COMMENT_ID = ? ORDER BY  AM_API_COMMENTS.CREATED_TIME ASC OFFSET ? LIMIT ?";
    ...
    public static final String GET_ROOT_COMMENTS_SQL =
            "SELECT " +
                    ...
                    "AND API.API_VERSION  = ? " +
                    "AND API.API_ID = AM_API_COMMENTS.API_ID " +
                    "AND PARENT_COMMENT_ID IS NULL ORDER BY  AM_API_COMMENTS.CREATED_TIME DESC OFFSET ? LIMIT ?";
}
