...
public class APIManagerConfiguration {
    ...
    private void setGatewayNotificationConfiguration(org.apache.axiom.om.OMElement omElement) {
        org.apache.axiom.om.OMElement enabledElem = omElement.getFirstChildWithName(new QName(APIConstants.GatewayNotification.GATEWAY_NOTIFICATION_ENABLED));
        if (enabledElem != null) {
            gatewayNotificationConfiguration.setEnabled(Boolean.parseBoolean(enabledElem.getText()));
        }
        
        org.apache.axiom.om.OMElement heartbeatElem = omElement.getFirstChildWithName(new QName(APIConstants.GatewayNotification.HEARTBEAT));
        if (heartbeatElem != null) {
            org.apache.axiom.om.OMElement intervalElem = heartbeatElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.NOTIFY_INTERVAL_SECONDS));
            if (intervalElem != null) {
                gatewayNotificationConfiguration.getHeartbeat().setNotifyIntervalSeconds(Integer.parseInt(intervalElem.getText()));
            }
            org.apache.axiom.om.OMElement gwidElem =
                heartbeatElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.GATEWAY_IDENTIFIER));
            if (gwidElem != null) {
                gatewayNotificationConfiguration.getHeartbeat().setGatewayID(gwidElem.getText());
            }
        }

        org.apache.axiom.om.OMElement deploymentAckElem = omElement.getFirstChildWithName(new QName(APIConstants.GatewayNotification.DEPLOYMENT_ACKNOWLEDGEMENT));
        if (deploymentAckElem != null) {
            org.apache.axiom.om.OMElement batchSizeElem = deploymentAckElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.BATCH_SIZE));
            if (batchSizeElem != null) {
                gatewayNotificationConfiguration.getDeploymentAcknowledgement().setBatchSize(Integer.parseInt(batchSizeElem.getText()));
            }
            org.apache.axiom.om.OMElement batchIntervalElem = deploymentAckElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.BATCH_INTERVAL_MILLIS));
            if (batchIntervalElem != null) {
                gatewayNotificationConfiguration.getDeploymentAcknowledgement().setBatchIntervalMillis(Long.parseLong(batchIntervalElem.getText()));
            }
            org.apache.axiom.om.OMElement maxRetryCountElem = deploymentAckElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.MAX_RETRY_COUNT));
            if (maxRetryCountElem != null) {
                gatewayNotificationConfiguration.getDeploymentAcknowledgement().setMaxRetryCount(Integer.parseInt(maxRetryCountElem.getText()));
            }
            org.apache.axiom.om.OMElement retryDurationElem = deploymentAckElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.RETRY_DURATION));
            if (retryDurationElem != null) {
                gatewayNotificationConfiguration.getDeploymentAcknowledgement().setRetryDuration(Long.parseLong(retryDurationElem.getText()));
            }
            org.apache.axiom.om.OMElement retryProgressionFactorElem = deploymentAckElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.RETRY_PROGRESSION_FACTOR));
            if (retryProgressionFactorElem != null) {
                gatewayNotificationConfiguration.getDeploymentAcknowledgement().setRetryProgressionFactor(Double.parseDouble(retryProgressionFactorElem.getText()));
            }
        }

        org.apache.axiom.om.OMElement registrationElem = omElement.getFirstChildWithName(new QName(APIConstants.GatewayNotification.REGISTRATION));
        if (registrationElem != null) {
            org.apache.axiom.om.OMElement maxRetryCountElem = registrationElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.MAX_RETRY_COUNT));
            if (maxRetryCountElem != null) {
                gatewayNotificationConfiguration.getRegistration().setMaxRetryCount(Integer.parseInt(maxRetryCountElem.getText()));
            }
            org.apache.axiom.om.OMElement retryDurationElem = registrationElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.RETRY_DURATION));
            if (retryDurationElem != null) {
                gatewayNotificationConfiguration.getRegistration().setRetryDuration(Long.parseLong(retryDurationElem.getText()));
            }
            org.apache.axiom.om.OMElement retryProgressionFactorElem = registrationElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.RETRY_PROGRESSION_FACTOR));
            if (retryProgressionFactorElem != null) {
                gatewayNotificationConfiguration.getRegistration().setRetryProgressionFactor(Double.parseDouble(retryProgressionFactorElem.getText()));
            }
        }

        org.apache.axiom.om.OMElement cleanupElem = omElement.getFirstChildWithName(new QName(APIConstants.GatewayNotification.GATEWAY_CLEANUP));
        if (cleanupElem != null) {
            org.apache.axiom.om.OMElement expireElem = cleanupElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.EXPIRE_TIME_SECONDS));
            if (expireElem != null) {
                gatewayNotificationConfiguration.getGatewayCleanupConfiguration().setExpireTimeSeconds(Integer.parseInt(expireElem.getText()));
            }
            org.apache.axiom.om.OMElement retentionElem = cleanupElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.DATA_RETENTION_PERIOD_SECONDS));
            if (retentionElem != null) {
                gatewayNotificationConfiguration.getGatewayCleanupConfiguration().setDataRetentionPeriodSeconds(Integer.parseInt(retentionElem.getText()));
            }
            org.apache.axiom.om.OMElement intervalElem = cleanupElem.getFirstChildWithName(new QName(APIConstants.GatewayNotification.CLEANUP_INTERVAL_SECONDS));
            if (intervalElem != null) {
                gatewayNotificationConfiguration.getGatewayCleanupConfiguration().setCleanupIntervalSeconds(Integer.parseInt(intervalElem.getText()));
            }
        }
    }
