...
public class URITemplate implements org.apache.thrift.TBase<URITemplate, URITemplate._Fields>, java.io.Serializable, Cloneable, Comparable<URITemplate> {
  ...
  private static final _Fields optionals[] = {_Fields.URI_TEMPLATE,_Fields.RESOURCE_URI,_Fields.RESOURCE_SANDBOX_URI,_Fields.HTTP_VERB,_Fields.AUTH_TYPE,_Fields.THROTTLING_TIER};
  ...
  public int hashCode() {
    ...
    boolean present_uriTemplate = true && (isSetUriTemplate());
    list.add(present_uriTemplate);
    if (present_uriTemplate)
      list.add(uriTemplate);

    boolean present_resourceURI = true && (isSetResourceURI());
    list.add(present_resourceURI);
    if (present_resourceURI)
      list.add(resourceURI);

    boolean present_resourceSandboxURI = true && (isSetResourceSandboxURI());
    list.add(present_resourceSandboxURI);
    if (present_resourceSandboxURI)
      list.add(resourceSandboxURI);

    boolean present_httpVerb = true && (isSetHttpVerb());
    list.add(present_httpVerb);
    if (present_httpVerb)
      list.add(httpVerb);

    boolean present_authType = true && (isSetAuthType());
    list.add(present_authType);
    if (present_authType)
      list.add(authType);

    boolean present_throttlingTier = true && (isSetThrottlingTier());
    list.add(present_throttlingTier);
    if (present_throttlingTier)
      list.add(throttlingTier);
