...
public class DefaultApiKeyGenerator implements ApiKeyGenerator {
    ...
    protected byte[] buildSignature(String assertion) throws APIManagementException {
        ...
        try {
            ...
            if (APIConstants.DEFAULT_API_KEY_SIGN_KEY_STORE.equals(apiKeySignKeyStoreName)){
                privateKey = tenantKSM.getDefaultPrivateKey();
            } else {
                String keyStorePassword = config.getFirstProperty(APIConstants.KeyStoreManagement
                        .SERVER_APIKEYSIGN_PRIVATE_KEY_PASSWORD.replaceFirst(APIConstants.KeyStoreManagement
                                        .KeyStoreName, apiKeySignKeyStoreName));
                ...
                KeyStore apiKeySignKeyStore = getApiKeySignKeyStore();
    ...
    private KeyStore getApiKeySignKeyStore() throws Exception {
