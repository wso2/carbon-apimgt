...
public class SubscriptionCreationWFNotifier extends AbstractWFNotifier {
    private static final Log log = LogFactory.getLog(SubscriptionCreationWFNotifier.class);

    @Override
    public NotificationDTO prepareNotification(WorkflowDTO workflowDTO) throws APIManagementException {
        NotificationDTO notificationDTO = new NotificationDTO();
        notificationDTO.setNotificationType(NotificationType.SUBSCRIPTION_CREATION);
    ...
    public List<NotificationEndUserDTO> getEndUsers(WorkflowDTO workflowDTO) throws APIManagementException {
        ...
        //add primary user
        String destinationUser = workflowDTO.getProperties("subscriber");
    ...
    public String groupID(WorkflowDTO workflowDTO) throws APIManagementException {
        ...
        return sub.getApplication().getGroupId();
    }
