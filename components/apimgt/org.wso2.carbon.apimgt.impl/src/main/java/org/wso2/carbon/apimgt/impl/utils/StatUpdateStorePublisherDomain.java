 ...
 */
public class StatUpdateStorePublisherDomain extends AbstractAdmin implements Serializable {
    ...
    public void updateStatsPublishStore(boolean statUpdateStatus) {
        ...
        if (clusteringAgent != null) {
            ...
            try {
                ...
                log.error("Failed to send cluster message to Publisher/Store domain and update stats publishing status.");
            }
