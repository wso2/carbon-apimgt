    ...
    private List<ApplicationPolicy> populateApplicationPolicyList(ResultSet resultSet)
        ...
        if (resultSet != null) {
            while (resultSet.next()) {
                ...
                applicationPolicyDTO.setRateLimitCount(resultSet.getInt(ThrottlePolicyConstants.COLUMN_RATE_LIMIT_COUNT));
                applicationPolicyDTO.setRateLimitTimeUnit(resultSet.getString(ThrottlePolicyConstants.COLUMN_RATE_LIMIT_TIME_UNIT));
