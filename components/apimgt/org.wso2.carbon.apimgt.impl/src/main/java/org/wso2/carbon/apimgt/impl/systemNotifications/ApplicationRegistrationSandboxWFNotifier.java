...
public class ApplicationRegistrationSandboxWFNotifier extends AbstractWFNotifier {
    private static final Log log = LogFactory.getLog(ApplicationRegistrationSandboxWFNotifier.class);

    @Override
    public NotificationDTO prepareNotification(WorkflowDTO workflowDTO) throws APIManagementException {
        NotificationDTO notificationDTO = new NotificationDTO();
        notificationDTO.setNotificationType(NotificationType.APPLICATION_REGISTRATION_SANDBOX);
