...
public class SDKGenerationConfigurationDTO {
    ...
    private String mergeSpecResource;
    private String generateCodeResource;
    ...
    public String getMergeSpecResource() {
        return mergeSpecResource;
    }

    public void setMergeSpecResource(String mergeSpecResource) {
        this.mergeSpecResource = mergeSpecResource;
    }

    public String getGenerateCodeResource() {
        return generateCodeResource;
    }

    public void setGenerateCodeResource(String generateCodeResource) {
        this.generateCodeResource = generateCodeResource;
    }
