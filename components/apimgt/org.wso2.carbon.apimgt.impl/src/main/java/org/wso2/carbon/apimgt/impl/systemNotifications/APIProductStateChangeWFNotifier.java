...
public class APIProductStateChangeWFNotifier extends AbstractWFNotifier {
    private static final Log log = LogFactory.getLog(APIProductStateChangeWFNotifier.class);

    @Override
    public NotificationDTO prepareNotification(WorkflowDTO workflowDTO) throws APIManagementException {
        NotificationDTO notificationDTO = new NotificationDTO();
        notificationDTO.setNotificationType(NotificationType.API_PRODUCT_STATE_CHANGE);
