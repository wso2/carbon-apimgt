...
public abstract class AbstractWFNotifier extends BaseNotifier {
        ...
        public abstract NotificationDTO prepareNotification(WorkflowDTO workflowDTO)
                throws APIManagementException;
        public abstract NotificationMetaData getNotificationMetaData(WorkflowDTO workflowDTO);
        public abstract List<NotificationEndUserDTO> getEndUsers(WorkflowDTO workflowDTO)
                throws APIManagementException;
        ...
        protected List<NotificationEndUserDTO> getSubscriberListOfAPI(String apiAction, String apiName,
                String apiContext, String apiVersion, String provider, String tenantDomain)
                throws APIManagementException {
                ...
                try {
                        apiUUID = getAPIUUIDUsingNameContextVersion(apiName, apiContext, apiVersion,
                                tenantDomain);
                        APIIdentifier apiIdEmailReplaced = new APIIdentifier(
                                APIUtil.replaceEmailDomain(provider), apiName, apiVersion);
                        List<SubscribedAPI> subscribers = getSubscribersOfAPI(apiUUID, tenantDomain,
                                apiIdEmailReplaced);
                        ...
                        APIUtil.handleException("Error while getting subscribers of API - getDestinationUser()",
                                e);
                }
         ...
         */
        protected List<User> getAllUsersBelongToGroup(WorkflowDTO workflowDTO, String groupId)
