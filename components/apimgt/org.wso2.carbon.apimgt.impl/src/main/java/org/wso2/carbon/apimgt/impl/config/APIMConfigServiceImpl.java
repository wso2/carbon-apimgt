...
public class APIMConfigServiceImpl implements APIMConfigService {
    ...
    private String addMissingScopes(String systemConfig) {
        ...
        scopesToCheck.put("apim:gov_rule_read", "admin,Internal/publisher,Internal/creator");
        scopesToCheck.put("apim:gov_result_read", "admin,Internal/publisher,Internal/creator");
        scopesToCheck.put("apim:gov_policy_manage", "admin");
        scopesToCheck.put("apim:gov_policy_read", "admin,Internal/publisher,Internal/creator");
