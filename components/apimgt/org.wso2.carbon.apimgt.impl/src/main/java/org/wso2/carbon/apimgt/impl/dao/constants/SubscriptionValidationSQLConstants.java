...
public class SubscriptionValidationSQLConstants {
    ...
    public static final String GET_OPERATION_POLICIES_PER_URI_BY_API_SQL =
            "SELECT OP.POLICY_NAME, OP.POLICY_VERSION,APM.DIRECTION AS API_POLICY_DIRECTION, APM.POLICY_UUID AS API_POLICY_UUID, OPM.POLICY_UUID AS OPERATION_POLICY_UUID, OPM.DIRECTION AS OPERATION_POLICY_DIRECTION, AUM.HTTP_METHOD, AUM.URL_PATTERN, OPM.PARAMETERS AS OPERATION_PARAMS, APM.PARAMETERS AS API_PARAMS "
    ...
    public static final String GET_RESOURCE_POLICIES_BY_API_PRODUCT_SQL =
            "SELECT OP.POLICY_NAME, OP.POLICY_VERSION, OPM.POLICY_UUID, OPM.DIRECTION, AUM.HTTP_METHOD, AUM.URL_PATTERN "
                    + "FROM AM_API_PRODUCT_MAPPING AS APM "
                    + "INNER JOIN AM_API AS API ON API.API_ID = APM.API_ID "
                    + "INNER JOIN AM_API_URL_MAPPING AS AUM ON AUM.URL_MAPPING_ID = APM.URL_MAPPING_ID "
                    + "LEFT JOIN AM_API_OPERATION_POLICY_MAPPING AS OPM ON OPM.URL_MAPPING_ID = APM.URL_MAPPING_ID "
                    + "LEFT JOIN AM_API_OPERATION_POLICY AS AOP ON AOP.POLICY_UUID = OPM.POLICY_UUID "
                    + "INNER JOIN AM_OPERATION_POLICY AS OP ON OP.POLICY_UUID = AOP.POLICY_UUID "
