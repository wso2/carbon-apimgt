...
public class SubscriptionValidationSQLConstants {
    ...
    public static final String GET_URI_TEMPLATES_BY_API_SQL = "SELECT AM_API_URL_MAPPING.HTTP_METHOD," +
            ...
            "AM_API_RESOURCE_SCOPE_MAPPING.SCOPE_NAME, AM_API_BACKEND_OPERATION_MAPPING.TARGET, " +
            "AM_API_BACKEND_OPERATION_MAPPING.VERB FROM AM_API_URL_MAPPING LEFT JOIN AM_API_RESOURCE_SCOPE_MAPPING " +
            "ON AM_API_URL_MAPPING.URL_MAPPING_ID=AM_API_RESOURCE_SCOPE_MAPPING.URL_MAPPING_ID " +
            "LEFT JOIN AM_API_BACKEND_OPERATION_MAPPING ON AM_API_BACKEND_OPERATION_MAPPING.URL_MAPPING_ID = " +
            "AM_API_URL_MAPPING.URL_MAPPING_ID WHERE " +
