...
public class SubscriptionValidationSQLConstants {
    ...
    public static final String GET_API_BY_UUID_SQL =
            "SELECT " +
                    ...
                    "AM_API_AI_CONFIGURATION.ENDPOINT_CONFIGURATION AS ENDPOINT_CONFIGURATION, " +
                    "AM_LLM_PROVIDER.NAME AS LLM_PROVIDER_NAME, " +
                    "AM_LLM_PROVIDER.API_VERSION AS LLM_PROVIDER_API_VERSION, " +
                    "AM_API_AI_CONFIGURATION.THROTTLING_CONFIGURATIONS AS THROTTLING_CONFIGURATIONS " +
                    "FROM " +
                    ...
                    "LEFT JOIN AM_API_AI_CONFIGURATION ON AM_API_AI_CONFIGURATION.API_UUID = AM_API.API_UUID " +
                    "LEFT JOIN AM_LLM_PROVIDER ON AM_API_AI_CONFIGURATION.LLM_PROVIDER_UUID = AM_LLM_PROVIDER.UUID " +
