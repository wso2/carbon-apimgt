...
public class ApplicationRegistrationProductionWFNotifier extends AbstractWFNotifier {
    ...
    public NotificationDTO prepareNotification(WorkflowDTO workflowDTO) throws APIManagementException {
        ...
        notificationDTO.setNotificationType(NotificationType.APPLICATION_REGISTRATION_PRODUCTION);
    ...
    public String groupID(WorkflowDTO workflowDTO) {
        return ((ApplicationRegistrationWorkflowDTO) workflowDTO).getApplication().getGroupId();
    }
