...
public class RemoteAuthorizationClientFactory extends AuthorizationManagerClientFactory {
    ...
    public RemoteAuthorizationClientFactory() {
    ...
    public AuthorizationManagerClient getAuthorizationManagerClient() throws APIManagementException {
        try {
            return (RemoteAuthorizationManagerClient) clientPool.borrowObject();
        } catch (Exception e) {
            throw new APIManagementException("Error occurred while borrowing a authorization client from " +
                    "the object pool", e);
        }
    }
