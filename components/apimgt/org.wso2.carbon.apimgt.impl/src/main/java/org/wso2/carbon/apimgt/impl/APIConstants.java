...
public final class APIConstants {
    ...
    public static final String API_OVERVIEW_ENDPOINT_AUTH_KERBEROS = "overview_endpointAuthKerberos";
    public static final String API_OVERVIEW_ENDPOINT_KERBEROS_TARGETSPN = "overview_endponitKerberosTargetSpn";
