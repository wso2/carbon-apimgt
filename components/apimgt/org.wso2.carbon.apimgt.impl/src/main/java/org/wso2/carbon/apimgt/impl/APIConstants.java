...
public final class APIConstants {
    ...
    public static final String JWT_ISSUER = "JwtAuth.iss";
    public static final String JWT_AUDIENCE = "JwtAuth.aud";
    public static final String JWT_CERT_ALIAS = "JwtAuth.alias";
