...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String RETRIEVE_ALL_PER_API_RESOURCE_LOGGING_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, API.API_NAME, API.CONTEXT, AUM.HTTP_METHOD, AUM.URL_PATTERN, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE AUM.LOG_LEVEL <> 'OFF'";
