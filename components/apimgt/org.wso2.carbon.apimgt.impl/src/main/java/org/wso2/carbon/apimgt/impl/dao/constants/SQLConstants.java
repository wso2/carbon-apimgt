  ...
  //--------------------
    ...
    public static class ThrottleSQLConstants{
		...
		public static final String GET_CONDITION_GROUPS_FOR_POLICIES_SQL = "SELECT grp.CONDITION_GROUP_ID ,AUM.HTTP_METHOD,AUM.AUTH_SCHEME, "
				...
				+ " FROM AM_API_THROTTLE_POLICY pol, AM_CONDITION_GROUP grp, AM_API_URL_MAPPING AUM, AM_API API"
				+ " where API.CONTEXT= ? AND API.API_VERSION = ?  AND AUM.API_ID = API.API_ID and pol.NAME = AUM.THROTTLING_TIER"
				+ " and  grp.POLICY_ID = pol.POLICY_ID "
