...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_SUBSCRIPTION_IDS_OF_APPLICATION_LIST_SQL = "SELECT SUBSCRIPTION_ID FROM AM_SUBSCRIPTION WHERE APPLICATION_ID IN (_IDS_)";
    ...
    public static final String GET_CONSUMER_KEYS_OF_APPLICATION_LIST_SQL =
            "SELECT MAP.CONSUMER_KEY, MAP.CREATE_MODE, KM.NAME, KM.ORGANIZATION " + "FROM "
                    + "AM_APPLICATION_KEY_MAPPING MAP, AM_KEY_MANAGER KM " + "WHERE " + "MAP.APPLICATION_ID IN (_IDS_) "
    ...
    public static final String REMOVE_APPLICATION_LIST_FROM_SUBSCRIPTIONS_SQL = "DELETE FROM AM_SUBSCRIPTION WHERE APPLICATION_ID IN (_IDS_)";
    ...
    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATION_KEY_MAPPINGS_SQL = "DELETE FROM AM_APPLICATION_KEY_MAPPING WHERE APPLICATION_ID IN (_IDS_)";
    ...
    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATIONS_SQL = "DELETE FROM AM_APPLICATION WHERE APPLICATION_ID IN (_IDS_)";
    ...
    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATION_REGISTRATIONS_SQL = "DELETE FROM AM_APPLICATION_REGISTRATION WHERE APP_ID IN (_IDS_)";
    ...
    public static final String GET_PENDING_REGISTRATIONS_FOR_APPLICATION_LIST =
            "SELECT KEY_MANAGER FROM AM_APPLICATION_KEY_MAPPING WHERE " + "APPLICATION_ID IN (_APPLICATION_IDS_) "
                    + "AND KEY_TYPE = ? AND STATE = 'CREATED'";
    ...
    public static final String DELETE_APPLICATION_REGISTRATION_WF_FOR_KEY_MANAGER =
            "DELETE FROM AM_WORKFLOWS WHERE WF_EXTERNAL_REFERENCE IN "
                    ...
                    + " AND TOKEN_TYPE = ? AND KEY_MANAGER = ?)";

    public static final String DELETE_PENDING_SUBSCRIPTIONS =
            "DELETE FROM AM_WORKFLOWS AM_WF_1 WHERE AM_WF_1.WF_EXTERNAL_REFERENCE " + "IN ( "
                    ...
                    + "WHERE APPLICATION_ID IN (_APPLICATION_IDS_) " + "AND SUB_STATUS = 'ON_HOLD')) "
    ...
    public static final String GET_SUBSCRIBERS_FOR_ORG_ID = "SELECT SUBSCRIBER_ID FROM AM_SUBSCRIBER_ORG_MAPPING WHERE ORGANIZATION = ?";

    public static final String GET_MAPPED_ORGANIZATIONS_FOR_SUBSCRIBER_ID = "SELECT ORGANIZATION FROM AM_SUBSCRIBER_ORG_MAPPING WHERE SUBSCRIBER_ID = ?";

    public static final String DELETE_SUBSCRIBER_ORGANIZATION_MAPPING = "DELETE FROM AM_SUBSCRIBER_ORG_MAPPING WHERE SUBSCRIBER_ID = ? AND ORGANIZATION = ?";

    public static final String DELETE_SUBSCRIBER = "DELETE FROM AM_SUBSCRIBER WHERE SUBSCRIBER_ID = ?";
}
