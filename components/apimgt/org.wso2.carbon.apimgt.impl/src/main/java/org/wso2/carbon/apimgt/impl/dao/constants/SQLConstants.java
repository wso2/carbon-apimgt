...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_OFF_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'OFF' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_BASIC_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'BASIC' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_STANDARD_SQL =
        "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'STANDARD' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_FULL_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'FULL' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_ALL_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, API.API_NAME, API.CONTEXT, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE API.ORGANIZATION= ?";
