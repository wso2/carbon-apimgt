...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_ENVIRONMENT_BY_ORGANIZATION_SQL =
            "SELECT ID, UUID, NAME, ORGANIZATION, DISPLAY_NAME, DESCRIPTION " +
    ...
    public static final String INSERT_ENVIRONMENT_SQL = "INSERT INTO " +
            "AM_GATEWAY_ENVIRONMENT (UUID, NAME, DISPLAY_NAME, DESCRIPTION, ORGANIZATION) " +
            "VALUES (?,?,?,?,?)";
    ...
    public static final String RETRIEVE_ARTIFACTS_BY_APIID_AND_LABEL_BY_ORGANIZATION=
    ...
    public static final String RETRIEVE_ARTIFACTS_BY_MULTIPLE_APIIDs_AND_LABEL_BY_ORGANIZATION =
    ...
    public static final String RETRIEVE_ARTIFACTS_BY_LABEL_BY_ORGANIZATION =
            "SELECT AM_GW_API_DEPLOYMENTS.API_ID AS API_ID,AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "AM_GW_PUBLISHED_API_DETAILS" +
                    ".API_PROVIDER AS API_PROVIDER," +
                    "AM_API.ORGANIZATION AS ORGANIZATION," +
                    ...
                    "AM_API.CONTEXT AS CONTEXT FROM " +
                    "AM_GW_PUBLISHED_API_DETAILS,AM_GW_API_ARTIFACTS,AM_GW_API_DEPLOYMENTS,AM_API WHERE " +
                    "AM_GW_API_DEPLOYMENTS.LABEL IN (_GATEWAY_LABELS_) AND AM_API.ORGANIZATION " +
                    "= ? " +
                    "AND AM_GW_PUBLISHED_API_DETAILS.API_ID=AM_GW_API_DEPLOYMENTS.API_ID AND " +
                    "AM_GW_API_ARTIFACTS.API_ID=AM_GW_API_DEPLOYMENTS.API_ID AND " +
                    "AM_API.API_UUID=AM_GW_API_DEPLOYMENTS.API_ID AND " +
    ...
    public static final String RETRIEVE_ARTIFACTS_BY_ORGANIZATION =
            "SELECT AM_GW_API_DEPLOYMENTS.API_ID AS API_ID,AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS " +
                    "API_PROVIDER, AM_API.ORGANIZATION AS ORGANIZATION, AM_GW_PUBLISHED_API_DETAILS.API_NAME AS API_NAME,AM_GW_PUBLISHED_API_DETAILS.API_VERSION AS " +
                    "API_VERSION," +
                    "AM_GW_PUBLISHED_API_DETAILS.API_TYPE AS API_TYPE,AM_GW_API_ARTIFACTS.ARTIFACT AS ARTIFACT," +
                    "AM_GW_API_DEPLOYMENTS.LABEL AS LABEL,AM_GW_API_DEPLOYMENTS.VHOST AS VHOST, " +
                    "AM_API.CONTEXT AS CONTEXT FROM " +
    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_REVISION_UUID = "SELECT REVISION_UUID FROM AM_REVISION, AM_API WHERE AM_REVISION.API_UUID = ? " +
                "AND AM_REVISION.ID = ?";
