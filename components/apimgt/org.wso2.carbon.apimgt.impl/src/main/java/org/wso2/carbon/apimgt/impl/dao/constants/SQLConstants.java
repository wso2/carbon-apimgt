...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_ALL_API_KEYS_SQL =
            "SELECT U.API_KEY_UUID, U.API_KEY_HASH, U.KEY_NAME, U.KEY_TYPE, U.AUTHZ_USER, U.STATUS, " +
                    "U.APP_ID, U.API_ID, U.APPLICATION_UUID, U.API_UUID, U.APPLICATION_NAME, U.API_NAME, " +
                    "U.VALIDITY_PERIOD, U.LAST_USED, U.TIME_CREATED, AK.API_KEY_PROPERTIES AS ADDITIONAL_PROPERTIES " +
                    "FROM (" +
                    "SELECT KEY_TBL.API_KEY_UUID AS API_KEY_UUID, KEY_TBL.API_KEY_HASH AS API_KEY_HASH, " +
                    "KEY_TBL.NAME AS KEY_NAME, KEY_TBL.KEY_TYPE AS KEY_TYPE, KEY_TBL.AUTHZ_USER AS AUTHZ_USER, " +
                    "KEY_TBL.STATUS AS STATUS, " +
                    ...
                    "KEY_TBL.VALIDITY_PERIOD AS VALIDITY_PERIOD, KEY_TBL.LAST_USED AS LAST_USED, " +
                    "KEY_TBL.TIME_CREATED AS TIME_CREATED " +
                    ...
                    "ON KEY_API_MAP.API_UUID = API_TBL.API_UUID LEFT OUTER JOIN " +
                    ...
                    "SELECT KEY_TBL.API_KEY_UUID AS API_KEY_UUID, KEY_TBL.API_KEY_HASH AS API_KEY_HASH, " +
                    "KEY_TBL.NAME AS KEY_NAME, KEY_TBL.KEY_TYPE AS KEY_TYPE, KEY_TBL.AUTHZ_USER AS AUTHZ_USER, " +
                    "KEY_TBL.STATUS AS STATUS, APP_TBL.APPLICATION_ID AS APP_ID, NULL AS API_ID, " +
                    "APP_TBL.UUID AS APPLICATION_UUID, NULL AS API_UUID, APP_TBL.NAME AS APPLICATION_NAME, " +
                    "NULL AS API_NAME, KEY_TBL.VALIDITY_PERIOD AS VALIDITY_PERIOD, " +
                    "KEY_TBL.LAST_USED AS LAST_USED, KEY_TBL.TIME_CREATED AS TIME_CREATED " +
                    ...
                    "ON KEY_APP_MAP.APPLICATION_UUID = APP_TBL.UUID LEFT OUTER JOIN " +
                    ...
                    "SELECT KEY_TBL.API_KEY_UUID AS API_KEY_UUID, KEY_TBL.API_KEY_HASH AS API_KEY_HASH, " +
                    "KEY_TBL.NAME AS KEY_NAME, KEY_TBL.KEY_TYPE AS KEY_TYPE, KEY_TBL.AUTHZ_USER AS AUTHZ_USER, " +
                    "KEY_TBL.STATUS AS STATUS, APP_TBL.APPLICATION_ID AS APP_ID, API_TBL.API_ID AS API_ID, " +
                    "APP_TBL.UUID AS APPLICATION_UUID, API_TBL.API_UUID AS API_UUID, " +
                    "APP_TBL.NAME AS APPLICATION_NAME, API_TBL.API_NAME AS API_NAME, " +
                    "KEY_TBL.VALIDITY_PERIOD AS VALIDITY_PERIOD, KEY_TBL.LAST_USED AS LAST_USED, " +
                    "KEY_TBL.TIME_CREATED AS TIME_CREATED " +
                    "FROM AM_API_KEY KEY_TBL INNER JOIN AM_API_KEY_API_MAPPING KEY_API_MAP " +
                    "ON KEY_TBL.API_KEY_UUID = KEY_API_MAP.API_KEY_UUID INNER JOIN AM_API API_TBL " +
                    "ON KEY_API_MAP.API_UUID = API_TBL.API_UUID INNER JOIN AM_API_KEY_APPLICATION_MAPPING KEY_APP_MAP " +
                    "ON KEY_TBL.API_KEY_UUID = KEY_APP_MAP.API_KEY_UUID INNER JOIN AM_APPLICATION APP_TBL " +
                    "ON KEY_APP_MAP.APPLICATION_UUID = APP_TBL.UUID " +
                    "WHERE API_TBL.ORGANIZATION = ? AND APP_TBL.ORGANIZATION = ? AND KEY_TBL.STATUS = 'ACTIVE'" +
                    ") U JOIN AM_API_KEY AK ON U.API_KEY_UUID = AK.API_KEY_UUID";
