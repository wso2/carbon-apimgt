...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String INSERT_API_LLM_CONFIGURATIONS_MAPPING = "INSERT INTO AM_API_LLM_CONFIGURATIONS_MAPPING (LLM_CONFIGURATIONS_UUID, API_UUID, LLM_PROVIDER_NAME, LLM_PROVIDER_VERSION, ADDITIONAL_HEADERS, ADDITIONAL_QUERY_PARAMETERS, TOKEN_DETAILS) VALUES (?,?,?,?,?,?,?)";
    public static final String GET_API_LLM_CONFIGURATIONS_MAPPING = "SELECT LLM_CONFIGURATIONS_UUID, ADDITIONAL_HEADERS, ADDITIONAL_QUERY_PARAMETERS, LLM_PROVIDER_NAME, LLM_PROVIDER_VERSION, TOKEN_DETAILS FROM AM_API_LLM_CONFIGURATIONS_MAPPING WHERE API_UUID = ?";
