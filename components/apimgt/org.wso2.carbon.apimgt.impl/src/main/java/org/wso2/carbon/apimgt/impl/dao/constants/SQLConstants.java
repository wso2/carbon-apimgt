...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_LABEL_SQL = "INSERT INTO AM_LABEL (UUID, NAME, TYPE, DESCRIPTION, TENANT_DOMAIN) " +
            "VALUES (?, ?, ?, ?, ?)";

    public static final String GET_LABELS_BY_TENANT_DOMAIN_SQL = "SELECT UUID, NAME, TYPE, DESCRIPTION, TENANT_DOMAIN " +
    ...
    public static final String IS_LABEL_NAME_EXISTS_SQL = "SELECT COUNT(UUID) AS LABEL_COUNT FROM AM_LABEL " +
            "WHERE LOWER(NAME) = LOWER(?) AND TYPE = ? AND TENANT_DOMAIN = ?";

    public static final String IS_LABEL_NAME_EXISTS_FOR_ANOTHER_UUID_SQL = "SELECT COUNT(UUID) AS LABEL_COUNT FROM AM_LABEL " +
            "WHERE LOWER(NAME) = LOWER(?) AND TYPE = ? AND TENANT_DOMAIN = ? AND UUID != ?";

    public static final String GET_LABEL_BY_UUID_SQL = "SELECT * FROM AM_LABEL WHERE UUID = ?";

    public static final String UPDATE_LABEL_SQL = "UPDATE AM_LABEL " +
            "SET NAME = ?, TYPE = ?, DESCRIPTION = ?, TENANT_DOMAIN = ? WHERE UUID = ?";
    ...
    public static final String GET_MAPPED_LABELS_BY_API_UUID_SQL = "SELECT AM_LABEL.UUID, AM_LABEL.NAME, AM_LABEL.TYPE, " +
    ...
    public static final String IS_ANY_MAPPING_EXISTS_FOR_API_SQL = "SELECT COUNT(*) AS MAPPING_COUNT FROM AM_API_LABEL_MAPPING " +
            "WHERE API_UUID = ?";
