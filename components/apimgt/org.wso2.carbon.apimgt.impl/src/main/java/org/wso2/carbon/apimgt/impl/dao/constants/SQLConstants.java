...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String REMOVE_APPLICATION_LIST_FROM_SUBSCRIPTIONS_SQL = "DELETE SUB FROM AM_SUBSCRIPTION SUB "
            + "JOIN AM_APPLICATION APP ON APP.APPLICATION_ID = SUB.APPLICATION_ID WHERE APP.ORGANIZATION = ?";

    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATION_KEY_MAPPINGS_SQL = "DELETE MAP FROM "
            + "AM_APPLICATION_KEY_MAPPING MAP JOIN AM_APPLICATION APP on APP.APPLICATION_ID = MAP.APPLICATION_ID "
            + "WHERE APP.ORGANIZATION = ?";

    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATIONS_SQL = "DELETE FROM AM_APPLICATION WHERE ORGANIZATION = ?";

    public static final String REMOVE_APPLICATION_LIST_FROM_APPLICATION_REGISTRATIONS_SQL = "DELETE REG FROM "
            + "AM_APPLICATION_REGISTRATION REG JOIN AM_APPLICATION APP on APP.APPLICATION_ID = REG.APP_ID WHERE APP.ORGANIZATION = ?";
