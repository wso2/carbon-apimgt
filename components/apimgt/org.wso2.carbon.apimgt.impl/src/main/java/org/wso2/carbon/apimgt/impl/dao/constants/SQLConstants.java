...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static class DevPortalContentConstants {
        ...
        public static final String GET_ARTIFACT_TYPE = "SELECT TYPE FROM AM_ARTIFACT WHERE UUID = ?";
        public static final String MAKE_NULL_API_DRAFTED_ID = "UPDATE AM_DEVPORTAL_API_CONTENT SET DRAFTED_ARTIFACT = NULL WHERE DRAFTED_ARTIFACT = ?";
        public static final String MAKE_NULL_ORG_DRAFTED_ID = "UPDATE AM_DEVPORTAL_ORG_CONTENT SET DRAFTED_ARTIFACT = NULL WHERE DRAFTED_ARTIFACT = ?";
        public static final String MAKE_NULL_API_PUBLISHED_ID = "UPDATE AM_DEVPORTAL_API_CONTENT SET PUBLISHED_ARTIFACT = NULL WHERE PUBLISHED_ARTIFACT = ?";
        public static final String MAKE_NULL_ORG_PUBLISHED_ID = "UPDATE AM_DEVPORTAL_ORG_CONTENT SET PUBLISHED_ARTIFACT = NULL WHERE PUBLISHED_ARTIFACT = ?";
        ...
        public static final String CHECK_IF_DRAFTED_ORG_THEME_IS_USED = "SELECT COUNT(*) FROM AM_DEVPORTAL_ORG_CONTENT WHERE DRAFTED_ARTIFACT = ? AND ORGANIZATION = ?";
        public static final String CHECK_IF_DRAFTED_API_THEME_IS_USED = "SELECT COUNT(*) FROM AM_DEVPORTAL_API_CONTENT WHERE DRAFTED_ARTIFACT = ? AND ORGANIZATION = ? AND API_UUID = ?";
        ...
        public static final String ADD_REF_ID = "INSERT INTO AM_DEVPORTAL_API_REFERENCE (API_UUID, ORGANIZATION, REFERENCE_APIID) VALUES (?, ?, ?)";
        public static final String GET_REF_ID = "SELECT REFERENCE_APIID FROM AM_DEVPORTAL_API_REFERENCE WHERE API_UUID = ? AND ORGANIZATION = ?";
        public static final String REMOVE_REF_ID = "DELETE FROM AM_DEVPORTAL_API_REFERENCE WHERE API_UUID = ? AND ORGANIZATION = ?";
    }
