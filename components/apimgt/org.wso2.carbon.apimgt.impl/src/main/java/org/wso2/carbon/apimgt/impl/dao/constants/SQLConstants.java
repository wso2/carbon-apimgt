...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_SQL =
        ...
        public static final String ADD_API_PRODUCT_SQL =
                " INSERT INTO AM_API_PRODUCT (API_PRODUCT_PROVIDER,API_PRODUCT_NAME,API_PRODUCT_VERSION,DESCRIPTION," +
                        "API_PRODUCT_TIER,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,VISIBILITY," +
    ...
    public static final String GET_API_PRODUCT_SQL = "SELECT API_PRODUCT_ID, DESCRIPTION, CREATED_TIME, UPDATED_TIME, UUID, LIFECYCLE_STATE, " +
