...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_ENVIRONMENTS_BY_ORGANIZATION_WITH_DATA_PLANE_ID_SQL =
            ...
            "ON AMGE.UUID = CGEDM.UUID " +
            "WHERE AMGE.ORGANIZATION = ? AND AMGE.UUID = ?";
    ...
    public static final String UPDATE_ENV_TO_DATA_PLANE_MAPPING_SQL = "UPDATE CHOREO_GW_ENV_DATA_PLANE_MAPPING " +
            "SET DATA_PLANE_ID = ?" +
