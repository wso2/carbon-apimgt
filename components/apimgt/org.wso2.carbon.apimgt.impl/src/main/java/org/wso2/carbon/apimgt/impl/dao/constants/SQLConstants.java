...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String INSERT_LLM_PROVIDER_SQL = "INSERT INTO AM_LLM_PROVIDERS (UUID, NAME, VERSION, " +
            "DESCRIPTION, ORGANIZATION, MODEL_PATH, PROMPT_TOKENS_PATH, COMPLETION_TOKENS_PATH, TOTAL_TOKENS_PATH, PAYLOAD_HANDLER, HAS_METADATA_IN_PAYLOAD, " +
            "API_DEFINITION) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";

    public static final String INSERT_LLM_PROVIDER_PARAMETERS = "INSERT INTO AM_LLM_PROVIDER_PARAMETERS " +
            "(LLM_PROVIDER_UUID, PARAMETER_NAME, PARAMETER_VALUE, ORGANIZATION, IS_HEADER, IS_QUERY_PARAMS) VALUES (?,?,?,?,?,?)";

    public static final String GET_LLM_PROVIDERS_BY_ORG_SQL = "SELECT UUID, NAME, VERSION, DESCRIPTION " +
            "FROM AM_LLM_PROVIDERS " +
            "WHERE ORGANIZATION = ?";

    public static final String GET_LLM_PROVIDERS_SQL = "SELECT NAME, VERSION, ORGANIZATION, MODEL_PATH, PROMPT_TOKENS_PATH, COMPLETION_TOKENS_PATH, " +
            "TOTAL_TOKENS_PATH, PAYLOAD_HANDLER, HAS_METADATA_IN_PAYLOAD FROM AM_LLM_PROVIDERS";

    public static final String GET_LLM_PROVIDER_SQL = "SELECT PROVIDER.UUID, PROVIDER.NAME, PROVIDER.VERSION, " +
            "PROVIDER.DESCRIPTION, PROVIDER.ORGANIZATION, PROVIDER.API_DEFINITION, PROVIDER.MODEL_PATH, PROVIDER.PROMPT_TOKENS_PATH, PROVIDER.COMPLETION_TOKENS_PATH, PROVIDER.TOTAL_TOKENS_PATH, PROVIDER.PAYLOAD_HANDLER, PROVIDER.HAS_METADATA_IN_PAYLOAD, PARAMETER.PARAMETER_NAME, " +
            "PARAMETER.PARAMETER_VALUE, PARAMETER.IS_HEADER, PARAMETER.IS_QUERY_PARAMS " +
            "FROM AM_LLM_PROVIDERS PROVIDER LEFT JOIN AM_LLM_PROVIDER_PARAMETERS PARAMETER " +
    ...
    public static final String UPDATE_LLM_PROVIDERS_SQL = "UPDATE AM_LLM_PROVIDERS SET DESCRIPTION = ?, API_DEFINITION = ?, MODEL_PATH = ?, PROMPT_TOKENS_PATH = ?, COMPLETION_TOKENS_PATH = ?, " +
            "TOTAL_TOKENS_PATH = ?, PAYLOAD_HANDLER = ?,  HAS_METADATA_IN_PAYLOAD = ? WHERE ORGANIZATION = ? AND UUID = ?";

    public static final String DELETE_LLM_PROVIDER_PARAMETERS_SQL = "DELETE FROM AM_LLM_PROVIDER_PARAMETERS " +
            "WHERE ORGANIZATION = ? AND LLM_PROVIDER_UUID = ?";
