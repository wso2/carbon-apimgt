...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_KEY_EXTERNAL_API_KEY_MAPPING_SQL =
            "INSERT INTO AM_API_KEY_EXTERNAL_API_KEY_MAPPING " +
                    "(API_KEY_UUID, GATEWAY_ENV_ID, REFERENCE_ARTIFACT) VALUES (?, ?, ?)";

    public static final String UPDATE_API_KEY_EXTERNAL_API_KEY_MAPPING_SQL =
            "UPDATE AM_API_KEY_EXTERNAL_API_KEY_MAPPING SET REFERENCE_ARTIFACT = ? " +
                    "WHERE API_KEY_UUID = ? AND GATEWAY_ENV_ID = ?";

    public static final String GET_API_KEY_EXTERNAL_API_KEY_MAPPINGS_SQL =
            "SELECT GATEWAY_ENV_ID, REFERENCE_ARTIFACT FROM AM_API_KEY_EXTERNAL_API_KEY_MAPPING " +
                    "WHERE API_KEY_UUID = ?";

    public static final String DELETE_API_KEY_EXTERNAL_API_KEY_MAPPINGS_SQL =
            "DELETE FROM AM_API_KEY_EXTERNAL_API_KEY_MAPPING WHERE API_KEY_UUID = ?";
