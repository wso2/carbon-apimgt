...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String RETRIEVE_PER_API_LOGGING_BY_UUID_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, API.API_NAME, API.CONTEXT, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE API.API_UUID = ? AND API.ORGANIZATION= ?";
