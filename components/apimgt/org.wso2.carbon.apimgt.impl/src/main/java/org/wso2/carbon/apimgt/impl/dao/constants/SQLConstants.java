...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String DELETE_BUILT_IN_LLM_PROVIDER_SQL =
            "DELETE FROM AM_LLM_PROVIDERS " +
                    "WHERE ORGANIZATION = ? AND UUID = ? AND BUILT_IN_SUPPORT = ?";
    ...
    public static final String CHECK_LLM_PROVIDER_BUILT_IN_SUPPORT_SQL = "SELECT BUILT_IN_SUPPORT FROM AM_LLM_PROVIDERS WHERE ORGANIZATION = ? AND UUID = ?";
