    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GATEWAY_DEPLOYMENT_STATS_QUERY =
                "SELECT " +
                        ...
                        "AND (gwi.ENV_LABELS = ? OR gwi.ENV_LABELS LIKE ? OR gwi.ENV_LABELS LIKE ? OR gwi.ENV_LABELS "
                        + "LIKE ?) AND gwi.STATUS = 'ACTIVE'";

        public static final String GATEWAY_LIVE_COUNT_QUERY ="SELECT COUNT(*) AS LIVE_COUNT FROM AM_GW_INSTANCES " +
                "WHERE STATUS = 'ACTIVE' AND (ENV_LABELS = ? OR ENV_LABELS LIKE ? OR ENV_LABELS LIKE ? OR ENV_LABELS LIKE ?)";
