  ...
  //--------------------
    ...
    public static final String ADD_API_SQL =
        ...
        public static final String ADD_API_PRODUCT_SQL =
                " INSERT INTO AM_API_PRODUCT (API_PRODUCT_PROVIDER,API_PRODUCT_NAME,API_PRODUCT_VERSION,DESCRIPTION," +
                        "API_PRODUCT_TIER,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,VISIBILITY,LIFECYCLE_STATE," +
                        "BUSINESS_OWNER,BUSINESS_OWNER_EMAIL,SUBSCRIPTION_AVAILABILITY,UUID)" +
                        " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String GET_MIN_API_PRODUCT_PRE_SQL = "SELECT API_PRODUCT_PROVIDER, API_PRODUCT_NAME, API_PRODUCT_VERSION, " +
            "DESCRIPTION, UUID, LIFECYCLE_STATE FROM AM_API_PRODUCT WHERE ";

    public static final String GET_API_PRODUCT_SQL = "SELECT API_PRODUCT_ID, DESCRIPTION, CREATED_TIME, UPDATED_TIME, UUID, LIFECYCLE_STATE, API_PRODUCT_TIER," +
            "BUSINESS_OWNER, BUSINESS_OWNER_EMAIL, VISIBILITY, SUBSCRIPTION_AVAILABILITY FROM AM_API_PRODUCT WHERE API_PRODUCT_PROVIDER = ? AND API_PRODUCT_NAME = ? AND API_PRODUCT_VERSION = ?";

    public static final String GET_API_PRODUCT_ROLES_SQL = "SELECT ROLE_NAME FROM AM_API_PRODUCT_ROLES WHERE API_PRODUCT_ID = ?";
