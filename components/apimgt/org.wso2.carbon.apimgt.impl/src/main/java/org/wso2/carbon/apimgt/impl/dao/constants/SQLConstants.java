...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_KEY_SQL =
            "INSERT INTO AM_API_KEY (NAME, API_UUID, APPLICATION_UUID, API_KEY_HASH, " +
    ...
    public static final String GET_ALL_API_KEYS_SQL =
            "SELECT K.NAME, K.API_UUID, A.API_NAME AS API_NAME, K.APPLICATION_UUID, APP.NAME AS APPLICATION_NAME, K.API_KEY_HASH, K.KEY_TYPE, " +
    ...
    public static final String GET_API_KEY_SQL =
            "SELECT NAME, TIME_CREATED, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE APPLICATION_UUID = ? " +
                    "AND KEY_TYPE = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_API_KEY_SQL =
            "SELECT K.NAME, K.APPLICATION_UUID, A.NAME AS APPLICATION_NAME, K.KEY_TYPE, K.TIME_CREATED, K.VALIDITY_PERIOD, K.LAST_USED FROM AM_API_KEY K " +
    ...
    public static final String GET_API_KEY_FROM_DISPLAY_NAME_SQL =
            "SELECT API_KEY_PROPERTIES, AUTHZ_USER, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE APPLICATION_UUID = ? " +
                    "AND KEY_TYPE = ? AND NAME = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_API_KEY_FROM_DISPLAY_NAME_SQL =
            "SELECT APPLICATION_UUID, KEY_TYPE, API_KEY_PROPERTIES, AUTHZ_USER, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE API_UUID = ? " +
                    "AND NAME = ? AND STATUS = 'ACTIVE'";
    public static final String REVOKE_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE APPLICATION_UUID = ? AND KEY_TYPE = ? AND NAME = ?";
    public static final String ADMIN_REVOKE_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE API_UUID = ? AND" +
                    "(APPLICATION_UUID = ? OR (? IS NULL AND APPLICATION_UUID IS NULL)) AND KEY_TYPE = ? AND NAME = ?";
    public static final String REVOKE_API_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE API_UUID = ? AND NAME = ?";
    ...
    public static final String UPDATE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = ?, ASSOCIATED_ON = CURRENT_TIMESTAMP WHERE API_UUID = ? AND NAME = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_KEY_ASSOCIATIONS_SQL = "SELECT K.NAME, K.ASSOCIATED_ON, A.API_NAME, K.VALIDITY_PERIOD, K.LAST_USED FROM AM_API_KEY K " +
    ...
    public static final String REMOVE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL, ASSOCIATED_ON = NULL WHERE API_UUID = ? AND NAME = ?";
    public static final String REMOVE_API_KEY_ASSOCIATION_VIA_APP_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL, ASSOCIATED_ON = NULL WHERE APPLICATION_UUID = ? AND NAME = ?";
    public static final String GET_API_UUID_AND_TYPE_FOR_ASSOCIATION_REMOVAL_VIA_APP_SQL =
            "SELECT K.API_UUID, K.KEY_TYPE, K.API_KEY_HASH, APP.APPLICATION_ID AS APPLICATION_ID FROM AM_API_KEY K " +
                    "JOIN AM_APPLICATION APP ON K.APPLICATION_UUID = APP.UUID WHERE K.APPLICATION_UUID = ? AND K.NAME = ?";
    public static final String GET_KEY_TYPE_FOR_ASSOCIATION_SQL =
            "SELECT K.KEY_TYPE, K.API_KEY_HASH, APP.APPLICATION_ID AS APPLICATION_ID FROM AM_API_KEY K JOIN AM_APPLICATION APP ON " +
                    "K.APPLICATION_UUID = APP.UUID WHERE K.API_UUID = ? AND K.NAME = ? AND K.APPLICATION_UUID = ?";
    public static final String GET_KEY_TYPE_ONLY_FOR_ASSOCIATION_SQL =
            "SELECT KEY_TYPE, API_KEY_HASH FROM AM_API_KEY WHERE API_UUID = ? AND NAME = ?";
    public static final String GET_SUBSCRIBED_API_WITH_API_KEY_SQL =
            "SELECT DISTINCT K.NAME, K.API_UUID, A.API_NAME FROM AM_SUBSCRIPTION S JOIN AM_APPLICATION APP ON S.APPLICATION_ID = APP.APPLICATION_ID JOIN AM_API A ON S.API_ID = A.API_ID JOIN AM_API_KEY K " +
