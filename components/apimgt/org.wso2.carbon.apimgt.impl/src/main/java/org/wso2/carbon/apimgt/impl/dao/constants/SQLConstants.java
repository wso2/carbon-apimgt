  ...
  //--------------------
    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_REVISIONS_BY_API_UUID = "SELECT AR.ID, AR.API_UUID, AR.REVISION_UUID, " +
                "AR.DESCRIPTION, AR.CREATED_TIME, AR.CREATED_BY, ADRM.NAME AS DEPLOY_NAME, ADRM.VHOST AS  DEPLOY_VHOST, " +
                "ADRM.DISPLAY_ON_DEVPORTAL, ADRM.DEPLOYED_TIME AS DEPLOY_TIME, AD.NAME AS DEPLOYED_NAME, " +
                "AD.VHOST AS DEPLOYED_VHOST, AD.DEPLOYED_TIME AS DEPLOYED_TIME  " +
                "FROM AM_REVISION AR " +
                "LEFT JOIN " +
                "AM_DEPLOYMENT_REVISION_MAPPING ADRM " +
                "ON AR.REVISION_UUID = ADRM.REVISION_UUID " +
                "LEFT JOIN " +
                "AM_DEPLOYED_REVISION AD " +
