...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_COMMENT_SQL =
            "INSERT INTO AM_API_COMMENTS (COMMENT_ID,COMMENT_TEXT,COMMENTED_USER,DATE_COMMENTED,API_ID,PARENT_COMMENT_ID,CATEGORY) VALUES (?,?,?,?,?,?,?)";

    public static final String EDIT_COMMENT_SQL =
