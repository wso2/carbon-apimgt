...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_KEY_SQL =
            "INSERT INTO AM_API_KEY (API_KEY_NAME, API_UUID, APPLICATION_UUID, API_KEY_HASH, " +
    ...
    public static final String GET_ALL_API_KEYS_SQL =
            "SELECT K.API_KEY_NAME, K.API_UUID, A.API_NAME AS API_NAME, K.APPLICATION_UUID, APP.NAME AS APPLICATION_NAME, K.API_KEY_HASH, K.KEY_TYPE, " +
                    "K.API_KEY_PROPERTIES, K.AUTHZ_USER, K.TIME_CREATED, K.VALIDITY_PERIOD, K.LAST_USED, K.STATUS " +
                    "FROM AM_API_KEY K LEFT JOIN AM_API A ON K.API_UUID = A.API_UUID " +
                    "LEFT JOIN AM_APPLICATION APP ON K.APPLICATION_UUID = APP.UUID WHERE K.STATUS = 'ACTIVE' " +
                    "AND A.ORGANIZATION = ? AND (APP.ORGANIZATION = ? OR K.APPLICATION_UUID IS NULL)";
    public static final String GET_API_KEY_SQL =
            "SELECT API_KEY_NAME, TIME_CREATED, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE APPLICATION_UUID = ? " +
                    "AND KEY_TYPE = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_API_KEY_SQL =
            "SELECT K.API_KEY_NAME, K.APPLICATION_UUID, A.NAME AS APPLICATION_NAME, K.KEY_TYPE, K.TIME_CREATED, K.VALIDITY_PERIOD, K.LAST_USED FROM AM_API_KEY K " +
                    "LEFT JOIN AM_APPLICATION A ON K.APPLICATION_UUID = A.UUID WHERE K.API_UUID = ? AND K.STATUS = 'ACTIVE'";
    public static final String GET_API_KEY_FROM_DISPLAY_NAME_SQL =
            "SELECT API_KEY_PROPERTIES, AUTHZ_USER, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE APPLICATION_UUID = ? " +
                    "AND KEY_TYPE = ? AND API_KEY_NAME = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_API_KEY_FROM_DISPLAY_NAME_SQL =
            "SELECT APPLICATION_UUID, KEY_TYPE, API_KEY_PROPERTIES, AUTHZ_USER, VALIDITY_PERIOD, LAST_USED FROM AM_API_KEY WHERE API_UUID = ? " +
                    "AND API_KEY_NAME = ? AND STATUS = 'ACTIVE'";
    public static final String REVOKE_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE APPLICATION_UUID = ? AND KEY_TYPE = ? AND API_KEY_NAME = ?";
    public static final String ADMIN_REVOKE_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE API_UUID = ? AND" +
                    "(APPLICATION_UUID = ? OR (? IS NULL AND APPLICATION_UUID IS NULL)) AND KEY_TYPE = ? AND API_KEY_NAME = ?";
    public static final String REVOKE_API_API_KEY_SQL =
            "UPDATE AM_API_KEY SET STATUS = 'REVOKED' WHERE API_UUID = ? AND API_KEY_NAME = ?";
    ...
    public static final String UPDATE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = ?, ASSOCIATED_ON = CURRENT_TIMESTAMP WHERE API_UUID = ? AND API_KEY_NAME = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_KEY_ASSOCIATIONS_SQL = "SELECT K.API_KEY_NAME, K.ASSOCIATED_ON, A.API_NAME, K.VALIDITY_PERIOD, K.LAST_USED FROM AM_API_KEY K " +
            "LEFT JOIN AM_API A ON K.API_UUID = A.API_UUID WHERE K.APPLICATION_UUID = ? AND K.KEY_TYPE = ? AND K.STATUS = 'ACTIVE' AND K.ASSOCIATED_ON IS NOT NULL";
    public static final String REMOVE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL, ASSOCIATED_ON = NULL WHERE API_UUID = ? AND API_KEY_NAME = ?";
    public static final String REMOVE_API_KEY_ASSOCIATION_VIA_APP_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL, ASSOCIATED_ON = NULL WHERE APPLICATION_UUID = ? AND API_KEY_NAME = ?";
    public static final String GET_API_UUID_AND_TYPE_FOR_ASSOCIATION_REMOVAL_VIA_APP_SQL =
            "SELECT K.API_UUID, K.KEY_TYPE, K.API_KEY_HASH, APP.APPLICATION_ID AS APPLICATION_ID FROM AM_API_KEY K " +
                    "JOIN AM_APPLICATION APP ON K.APPLICATION_UUID = APP.UUID WHERE K.APPLICATION_UUID = ? AND K.API_KEY_NAME = ?";
    public static final String GET_KEY_TYPE_FOR_ASSOCIATION_SQL =
            "SELECT K.KEY_TYPE, K.API_KEY_HASH, APP.APPLICATION_ID AS APPLICATION_ID FROM AM_API_KEY K JOIN AM_APPLICATION APP ON " +
                    "K.APPLICATION_UUID = APP.UUID WHERE K.API_UUID = ? AND K.API_KEY_NAME = ? AND K.APPLICATION_UUID = ?";
    public static final String GET_KEY_TYPE_ONLY_FOR_ASSOCIATION_SQL =
            "SELECT KEY_TYPE, API_KEY_HASH FROM AM_API_KEY WHERE API_UUID = ? AND API_KEY_NAME = ?";
    public static final String GET_SUBSCRIBED_API_WITH_API_KEY_SQL =
            "SELECT DISTINCT K.API_KEY_NAME, K.API_UUID, A.API_NAME FROM AM_SUBSCRIPTION S JOIN AM_APPLICATION APP ON S.APPLICATION_ID = APP.APPLICATION_ID JOIN AM_API A ON S.API_ID = A.API_ID JOIN AM_API_KEY K " +
                    "ON K.API_UUID = A.API_UUID WHERE APP.UUID = ? AND S.SUBS_CREATE_STATE = '" + APIConstants.SubscriptionCreatedStatus.SUBSCRIBE +
                    "' AND S.SUB_STATUS = 'UNBLOCKED' AND K.APPLICATION_UUID IS NULL AND K.STATUS = 'ACTIVE' AND K.KEY_TYPE = ? AND A.STATUS = 'PUBLISHED'";
