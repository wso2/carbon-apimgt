...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_COMMENT_SQL =
            ...
            "   AM_API_COMMENTS.UPDATED_BY AS UPDATED_BY," +
            "   AM_API_COMMENTS.UPDATED_TIME AS UPDATED_TIME," +
            "   AM_API_COMMENTS.API_ID AS API_ID " +
            "   AM_API_COMMENTS.PARENT_COMMENT_ID AS PARENT_COMMENT_ID," +
            "   AM_API_COMMENTS.ENTRY_POINT AS ENTRY_POINT," +
            "   AM_API_COMMENTS.CATEGORY AS CATEGORY " +
