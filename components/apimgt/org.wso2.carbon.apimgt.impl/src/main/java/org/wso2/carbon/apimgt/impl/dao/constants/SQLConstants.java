...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String INSERT_API_LLM_CONFIGURATION = "INSERT INTO AM_API_LLM_CONFIGURATION (LLM_CONFIGURATION_UUID, API_UUID, API_REVISION_UUID, LLM_PROVIDER_NAME, LLM_PROVIDER_VERSION, ADDITIONAL_HEADERS, ADDITIONAL_QUERY_PARAMETERS, TOKEN_DETAILS) VALUES (?,?,?,?,?,?,?,?)";
    public static final String UPDATE_API_LLM_CONFIGURATION = "UPDATE AM_API_LLM_CONFIGURATION SET LLM_PROVIDER_NAME = ?, LLM_PROVIDER_VERSION = ?, ADDITIONAL_HEADERS = ?, ADDITIONAL_QUERY_PARAMETERS = ?, TOKEN_DETAILS = ? WHERE API_UUID = ? AND API_REVISION_UUID IS NULL";
    public static final String GET_API_LLM_CONFIGURATION = "SELECT LLM_CONFIGURATION_UUID, ADDITIONAL_HEADERS, ADDITIONAL_QUERY_PARAMETERS, LLM_PROVIDER_NAME, LLM_PROVIDER_VERSION, TOKEN_DETAILS FROM AM_API_LLM_CONFIGURATION WHERE API_UUID = ? AND API_REVISION_UUID IS NULL";
    public static final String GET_API_LLM_CONFIGURATION_REVISION = "SELECT LLM_CONFIGURATION_UUID, ADDITIONAL_HEADERS, ADDITIONAL_QUERY_PARAMETERS, LLM_PROVIDER_NAME, LLM_PROVIDER_VERSION, TOKEN_DETAILS FROM AM_API_LLM_CONFIGURATION WHERE API_UUID = ? AND API_REVISION_UUID = ?";
    public static final String DELETE_API_LLM_CONFIGURATION = "DELETE FROM AM_API_LLM_CONFIGURATION WHERE API_UUID = ? AND API_REVISION_UUID = ?";
    public static final String DELETE_API_LLM_CONFIGURATION_ALL_REVISIONS = "DELETE FROM AM_API_LLM_CONFIGURATION WHERE API_UUID = ?";
