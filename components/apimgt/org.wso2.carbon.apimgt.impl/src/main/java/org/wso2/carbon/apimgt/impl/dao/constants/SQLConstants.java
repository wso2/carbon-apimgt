...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String UPDATE_CONSUMER_KEY_IN_APPLICATION_KEY_MAPPINGS_SQL =
            " UPDATE AM_APPLICATION_KEY_MAPPING SET CONSUMER_KEY = ? WHERE APPLICATION_ID = ? AND " +
                    "KEY_TYPE = ? AND KEY_MANAGER = ?";
    ...
    public static final String GET_ORG_SPECIFIC_APPLICATION_ID_SQL =
            "SELECT APPLICATION_ID FROM AM_APPLICATION WHERE SUBSCRIBER_ID = ? AND NAME= ? AND ORGANIZATION = ?";
    ...
    public static final String DELETE_APPLICATION_KEY_MAPPING_BY_APP_KEY_TYPE_KEY_MANAGER_SQL =
            "DELETE FROM AM_APPLICATION_KEY_MAPPING WHERE APPLICATION_ID = ? AND KEY_TYPE = ? AND KEY_MANAGER = ?";
    ...
    public static final String GET_ENVIRONMENT_BY_ORGANIZATION_SQL =
            "SELECT ID, UUID, NAME, ORGANIZATION, DISPLAY_NAME, DESCRIPTION, PROVIDER, ACCESSIBILITY_TYPE " +
    ...
    public static final String GET_ENVIRONMENTS_BY_ORGANIZATION_WITH_DATA_PLANE_ID_SQL =
            "SELECT AMGE.ID, AMGE.UUID, AMGE.NAME, AMGE.ORGANIZATION, AMGE.DISPLAY_NAME, AMGE.DESCRIPTION, " +
                    "AMGE.PROVIDER, AMGE.ACCESSIBILITY_TYPE, CGEDM.DATA_PLANE_ID " +
            "FROM AM_GATEWAY_ENVIRONMENT AMGE " +
            "INNER JOIN CHOREO_GW_ENV_DATA_PLANE_MAPPING CGEDM " +
            "ON AMGE.UUID = CGEDM.GATEWAY_ENV_UUID " +
            "WHERE AMGE.ORGANIZATION = ?";

    public static final String GET_ENVIRONMENTS_TO_DATA_PLANE_ID_MAPPING_SQL =
            "SELECT CHOREO_GW_ENV_DATA_PLANE_MAPPING.DATA_PLANE_ID AS DATA_PLANE_ID " +
                    "FROM AM_GATEWAY_ENVIRONMENT,CHOREO_GW_ENV_DATA_PLANE_MAPPING WHERE " +
    ...
    public static final String GET_ENVIRONMENT_BY_NAME_SQL =
            "SELECT ID, NAME FROM AM_GATEWAY_ENVIRONMENT WHERE ORGANIZATION = ? AND NAME = ?";
    ...
    public static final String UPDATE_ENV_TO_DATA_PLANE_MAPPING_SQL =
            "UPDATE CHOREO_GW_ENV_DATA_PLANE_MAPPING SET DATA_PLANE_ID = ? WHERE GATEWAY_ENV_UUID = ?";

    public static final String DELETE_ENV_TO_DATA_PLANE_MAPPING_SQL =
            "DELETE FROM CHOREO_GW_ENV_DATA_PLANE_MAPPING WHERE GATEWAY_ENV_UUID = ?";

    public static final String GET_DATA_PLANE_ID_FOR_ENV_SQL =
            "SELECT DATA_PLANE_ID FROM CHOREO_GW_ENV_DATA_PLANE_MAPPING WHERE GATEWAY_ENV_UUID = ?";
    ...
    public static final String UPDATE_ENVIRONMENT_SQL = "UPDATE AM_GATEWAY_ENVIRONMENT " +
            "SET DISPLAY_NAME = ?, DESCRIPTION = ? , ACCESSIBILITY_TYPE = ? " +
            "WHERE UUID = ?";
    ...
    public static final String GET_CONSUMER_KEY_FOR_APPLICATION_KEY_TYPE_APP_ID_KEY_MANAGER_SQL =
            "SELECT CONSUMER_KEY FROM AM_APPLICATION_KEY_MAPPING WHERE APPLICATION_ID = ? AND KEY_TYPE = ? AND " +
                    "KEY_MANAGER = ?";
    public static final String GET_KEY_MAPPING_INFO_FROM_APP_ID = "SELECT AKM.UUID AS UUID, " +
            "AKM.CONSUMER_KEY AS CONSUMER_KEY," +
            "AKM.KEY_MANAGER AS KEY_MANAGER," +
            "AKM.KEY_TYPE AS KEY_TYPE," +
            "AKM.STATE AS STATE," +
            "AKM.APP_INFO AS APP_INFO," +
            "AKM.CREATE_MODE AS CREATE_MODE," +
            "KM.ORGANIZATION AS ORGANIZATION " +
            "FROM AM_APPLICATION_KEY_MAPPING AKM, AM_KEY_MANAGER KM WHERE AKM.KEY_MANAGER = KM.UUID AND AKM.APPLICATION_ID = ?";
    ...
    public static final String RETRIEVE_ALL_ARTIFACTS_BY_DATA_PLANE_IDS_AND_GATEWAY_ACCESSIBILITY_TYPE =
            "SELECT " +
                    "   AM_GW_API_DEPLOYMENTS.API_ID AS API_ID," +
                    "   AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "   AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS API_PROVIDER," +
    ...
    public static final String RETRIEVE_ALL_ARTIFACTS_BY_ORGANIZATION_DATA_PLANE_IDS_AND_GATEWAY_ACCESSIBILITY_TYPE =
            "SELECT " +
                    "   AM_GW_API_DEPLOYMENTS.API_ID AS API_ID," +
                    "   AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "   AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS API_PROVIDER," +
    ...
    public static final String RETRIEVE_ALL_ARTIFACTS_BY_ORGANIZATION_GATEWAY_ACCESSIBILITY_TYPE_AND_DATA_PLANE_ID =
            "SELECT " +
                    "   AM_GW_API_DEPLOYMENTS.API_ID AS API_ID," +
                    "   AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "   AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS API_PROVIDER," +
    ...
    public static final String RETRIEVE_ALL_ARTIFACTS_BY_DATA_PLANE_ID =
            "SELECT AM_GW_API_DEPLOYMENTS.API_ID AS API_ID,AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS API_PROVIDER," +
                    "AM_GW_PUBLISHED_API_DETAILS.API_NAME AS API_NAME,AM_GW_PUBLISHED_API_DETAILS.API_VERSION AS API_VERSION," +
                    "AM_GW_PUBLISHED_API_DETAILS.API_TYPE AS API_TYPE,AM_GW_API_ARTIFACTS.ARTIFACT AS ARTIFACT," +
    ...
    public static final String RETRIEVE_ALL_ARTIFACTS_BY_DATA_PLANE_ID_AND_GATEWAY_ACCESSIBILITY_TYPE =
            "SELECT " +
                    "   AM_GW_API_DEPLOYMENTS.API_ID AS API_ID," +
                    "   AM_GW_API_DEPLOYMENTS.REVISION_ID AS REVISION_ID," +
                    "   AM_GW_PUBLISHED_API_DETAILS.API_PROVIDER AS API_PROVIDER," +
    ...
    public static final String GET_API_INFO_BY_NAME_VERSION =
            "SELECT API.API_UUID, API.STATUS, API.API_VERSION, API.API_TYPE, API.VERSION_COMPARABLE, API.CONTEXT, "
                    ...
                    " AND ORGANIZATION = ? AND API_VERSION = ?";
    public static final String GET_API_VERSIONS_UUID =
            "SELECT API.API_UUID, API.STATUS, API.API_VERSION, API.API_TYPE, API.VERSION_COMPARABLE, API.CONTEXT, "
                    + "API.CONTEXT_TEMPLATE FROM AM_API API WHERE API.API_PROVIDER = ? AND API.API_NAME = ? ";
    public static final String GET_API_VERSIONS_UUID_BY_ORGANIZATION =
            "SELECT API.API_UUID, API.STATUS, API.API_VERSION, API.API_TYPE, API.VERSION_COMPARABLE, API.CONTEXT, "
                    + "API.CONTEXT_TEMPLATE FROM AM_API API WHERE API.API_PROVIDER = ? AND API.API_NAME = ? AND ORGANIZATION = ?";
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_REVISION_APIID_BY_REVISION_UUID = "SELECT AR.API_UUID AS API_UUID, AR.ID AS ID, " +
                "ARM.SCOPE_PREFIX AS SCOPE_PREFIX FROM AM_REVISION AR, AM_API_REVISION_METADATA ARM " +
                "WHERE AR.REVISION_UUID = ARM.REVISION_UUID AND AR.REVISION_UUID = ?";
