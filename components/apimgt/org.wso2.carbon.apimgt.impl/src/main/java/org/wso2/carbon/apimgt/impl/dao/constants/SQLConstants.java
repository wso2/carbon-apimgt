...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_PER_API_RESOURCE_LOGGING_SQL =
            "UPDATE AM_API_URL_MAPPING SET LOG_LEVEL= ? WHERE  API_ID = (SELECT API_ID FROM AM_API WHERE API_UUID= ? AND ORGANIZATION= ?) AND HTTP_METHOD = ? AND URL_PATTERN = ?";
    public static final String CHECK_PER_API_RESOURCE_IS_AVAILABLE_LOGGING_SQL =
            "SELECT * FROM AM_API_URL_MAPPING WHERE API_ID = (SELECT API_ID FROM AM_API WHERE API_UUID= ? AND ORGANIZATION= ?) AND HTTP_METHOD = ? AND URL_PATTERN = ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_OFF_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AUM.HTTP_METHOD, AUM.URL_PATTERN, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'OFF' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_BASIC_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AUM.HTTP_METHOD, AUM.URL_PATTERN, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'BASIC' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_STANDARD_SQL =
        "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AUM.HTTP_METHOD, AUM.URL_PATTERN, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'STANDARD' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_FULL_SQL =
            "SELECT AM_API.API_UUID, AUM.LOG_LEVEL, AM_API.API_NAME, AUM.HTTP_METHOD, AUM.URL_PATTERN, AM_API.CONTEXT, AM_API.API_VERSION FROM AM_API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = AM_API.API_ID WHERE AUM.LOG_LEVEL = 'FULL' AND AM_API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_ALL_PER_API_RESOURCE_LOGGING_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, API.API_NAME, API.CONTEXT, AUM.HTTP_METHOD, AUM.URL_PATTERN, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE AUM.LOG_LEVEL <> 'OFF' AND AUM.REVISION_UUID IS NULL";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_ALL_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, AUM.HTTP_METHOD, AUM.URL_PATTERN, API.API_NAME, API.CONTEXT, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE API.ORGANIZATION= ?";
    ...
    public static final String RETRIEVE_PER_API_RESOURCE_LOGGING_BY_UUID_SQL =
            "SELECT API.API_UUID, AUM.LOG_LEVEL, API.API_NAME, AUM.HTTP_METHOD ,AUM.URL_PATTERN , API.CONTEXT, API.API_VERSION FROM AM_API API INNER JOIN AM_API_URL_MAPPING AUM ON AUM.API_ID = API.API_ID WHERE API.API_UUID = ? AND API.ORGANIZATION= ?";
