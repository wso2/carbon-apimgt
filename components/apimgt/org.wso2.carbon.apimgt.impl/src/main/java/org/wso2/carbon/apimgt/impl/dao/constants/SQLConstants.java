...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_LLM_PROVIDER_CONFIGURATIONS_SQL =
            "SELECT NAME, API_VERSION, ORGANIZATION, CONFIGURATIONS FROM AM_LLM_PROVIDERS WHERE 1=1";
    ...
    public static final String CHECK_LLM_PROVIDER_BUILT_IN_SUPPORT_SQL = "SELECT NAME, API_VERSION, BUILT_IN_SUPPORT " +
            "FROM AM_LLM_PROVIDERS WHERE ORGANIZATION = ? AND UUID = ?";

    public static final String INSERT_AI_CONFIGURATION = "INSERT INTO AM_API_AI_CONFIGURATION (AI_CONFIGURATION_UUID," +
            " API_UUID, API_REVISION_UUID, LLM_PROVIDER_NAME, LLM_PROVIDER_API_VERSION, ENDPOINT_CONFIGURATION, " +
    ...
    public static final String GET_AI_CONFIGURATION = "SELECT AI_CONFIGURATION_UUID, LLM_PROVIDER_NAME, " +
     "LLM_PROVIDER_API_VERSION, ENDPOINT_CONFIGURATION, THROTTLING_CONFIGURATIONS FROM AM_API_AI_CONFIGURATION WHERE " +
            "API_UUID = ? AND API_REVISION_UUID IS NULL";
    public static final String GET_AI_CONFIGURATION_REVISION = "SELECT AI_CONFIGURATION_UUID, LLM_PROVIDER_NAME, " +
     "LLM_PROVIDER_API_VERSION, ENDPOINT_CONFIGURATION, THROTTLING_CONFIGURATIONS FROM AM_API_AI_CONFIGURATION WHERE " +
