...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_ENVIRONMENT_BY_ORGANIZATION_SQL =
            "SELECT ID, UUID, NAME, ORGANIZATION, DISPLAY_NAME, DESCRIPTION, PROVIDER, ENVIRONMENT_TYPE " +
    ...
    public static final String GET_ENVIRONMENTS_BY_ORGANIZATION_WITH_DATA_PLANE_ID_SQL =
            "SELECT AMGE.ID, AMGE.UUID, AMGE.NAME, AMGE.ORGANIZATION, AMGE.DISPLAY_NAME, AMGE.DESCRIPTION, " +
                    "AMGE.PROVIDER, AMGE.ENVIRONMENT_TYPE, CGEDM.DATA_PLANE_ID " +
    ...
    public static final String INSERT_ENVIRONMENT_SQL = "INSERT INTO " +
            "AM_GATEWAY_ENVIRONMENT (UUID, NAME, DISPLAY_NAME, DESCRIPTION, PROVIDER, ENVIRONMENT_TYPE, ORGANIZATION) " +
            "VALUES (?,?,?,?,?,?,?)";
    ...
    public static final String UPDATE_ENVIRONMENT_SQL = "UPDATE AM_GATEWAY_ENVIRONMENT " +
            "SET DISPLAY_NAME = ?, DESCRIPTION = ? , ENVIRONMENT_TYPE = ? " +
            "WHERE UUID = ?";
