...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_REGISTRY_ENTRY_MAPPING_SQL = "INSERT INTO AM_API_ENDPOINT_REG_ENTRY_MAPPING " +
            "(API_ID, REG_NAME, ENTRY_NAME, ENTRY_VERSION) VALUES (?, ?, ? ,?)";

    public static final String DELETE_API_REGISTRY_ENTRY_MAPPINGS_SQL = "DELETE FROM AM_API_ENDPOINT_REG_ENTRY_MAPPING" +
            " WHERE API_ID = ?";
