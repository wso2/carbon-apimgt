...
public class SQLConstants {
    ...
    public static final String GET_SUBSCRIPTION_BY_ID_SQL =
            ...
            + "     NULL AS API_PRODUCT_VERSION, NULL AS PRODUCT_UUID, API.API_NAME, API.API_PROVIDER,  API.API_VERSION "
            ...
            + "     PRODUCT.API_PRODUCT_VERSION, PRODUCT.UUID AS PRODUCT_UUID, NULL AS API_NAME, NULL AS API_PROVIDER,  "
            + "NULL AS API_VERSION "
  ...
  //--------------------
    ...
    public static final String GET_API_PRODUCT_SQL = 
            "SELECT API_PRODUCT_ID, UUID, DESCRIPTION, API_PRODUCT_PROVIDER, API_PRODUCT_NAME, API_PRODUCT_VERSION, API_PRODUCT_TIER, "
