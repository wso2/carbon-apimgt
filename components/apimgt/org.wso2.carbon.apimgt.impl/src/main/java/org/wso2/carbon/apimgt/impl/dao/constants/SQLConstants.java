...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_WH_TOPIC_SUBSCRIPTIONS = "SELECT SUBSCRIPTION.HUB_TOPIC, SUBSCRIPTION.API_KEY, " +
            "SUBSCRIPTION.DELIVERED_AT, SUBSCRIPTION.DELIVERY_STATUS, SUBSCRIPTION.HUB_CALLBACK_URL, APPLICATION.UUID, " +
            "FROM AM_ASYNC_WEBHOOKS_SUBSCRIPTION SUBSCRIPTION INNER JOIN AM_APPLICATION APPLICATION" +
            "ON SUBSCRIPTION.APPLICATION_ID = APPLICATION.APPLICATION_ID WHERE SUBSCRIPTION.APPLICATION_ID = ?";

    public static final String GET_WH_TOPIC_SUBSCRIPTIONS_BY_API_KEY = "SELECT SUBSCRIPTION.HUB_TOPIC, SUBSCRIPTION.API_KEY, " +
            "SUBSCRIPTION.DELIVERED_AT, SUBSCRIPTION.DELIVERY_STATUS, SUBSCRIPTION.HUB_CALLBACK_URL, APPLICATION.UUID, " +
            "FROM AM_ASYNC_WEBHOOKS_SUBSCRIPTION SUBSCRIPTION INNER JOIN AM_APPLICATION APPLICATION" +
            "ON SUBSCRIPTION.APPLICATION_ID = APPLICATION.APPLICATION_ID WHERE SUBSCRIPTION.APPLICATION_ID = ? " +
            "AND SUBSCRIPTION.API_KEY = ?";

    public static final String GET_API_DATA_FROM_UUID = "SELECT API_PROVIDER, API_NAME" +
            "API_VERSION FROM AM_API WHERE API_ID = ?";

    public static final String GET_ALL_TOPICS_BY_API_ID = "" +
            "SELECT URL.URL_MAPPING, API.API_ID FROM AM_API_URL_MAPPING URL INNER JOIN" +
            "AM_API API ON URL.API_ID = API.API_ID WHERE API.API_ID = ?";
