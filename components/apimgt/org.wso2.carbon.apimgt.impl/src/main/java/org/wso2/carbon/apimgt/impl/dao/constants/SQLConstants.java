  ...
  //--------------------
    ...
    public static final String GET_LLM_PROVIDERS_BY_ORG_SQL =
            "SELECT UUID, NAME, API_VERSION, BUILT_IN_SUPPORT, DESCRIPTION " +
                    "FROM AM_LLM_PROVIDER " +
                    "WHERE ORGANIZATION = ?";

    public static final String GET_LLM_PROVIDER_CONFIGURATIONS_SQL =
            "SELECT NAME, API_VERSION, ORGANIZATION, CONFIGURATIONS FROM AM_LLM_PROVIDER WHERE 1=1";

    public static final String GET_BUILT_IN_LLM_PROVIDER_CONFIGURATIONS_BY_ORG_SQL =
            "SELECT UUID, CONFIGURATIONS FROM AM_LLM_PROVIDER WHERE ORGANIZATION = ? AND BUILT_IN_SUPPORT = true";
    ...
    public static final String GET_LLM_PROVIDER_SQL =
            "SELECT UUID, NAME, API_VERSION, BUILT_IN_SUPPORT, DESCRIPTION, API_DEFINITION, CONFIGURATIONS " +
                    "FROM AM_LLM_PROVIDER PROVIDER WHERE ORGANIZATION = ? AND UUID = ?";
    ...
    public static final String CHECK_LLM_PROVIDER_BUILT_IN_SUPPORT_SQL = "SELECT NAME, API_VERSION, BUILT_IN_SUPPORT " +
            "FROM AM_LLM_PROVIDER WHERE ORGANIZATION = ? AND UUID = ?";

    public static final String INSERT_AI_CONFIGURATION = "INSERT INTO AM_API_AI_CONFIGURATION (AI_CONFIGURATION_UUID," +
            " API_UUID, API_REVISION_UUID, LLM_PROVIDER_UUID, ENDPOINT_CONFIGURATION, " +
            "THROTTLING_CONFIGURATIONS) VALUES (?,?,?,?,?,?)";
    public static final String UPDATE_AI_CONFIGURATION = "UPDATE AM_API_AI_CONFIGURATION SET ENDPOINT_CONFIGURATION =" +
            " ?, THROTTLING_CONFIGURATIONS = ? WHERE API_UUID = ? AND API_REVISION_UUID IS NULL";
    public static final String GET_AI_CONFIGURATION = "SELECT AI_CONFIGURATION_UUID, LLM_PROVIDER_UUID, " +
     "ENDPOINT_CONFIGURATION, THROTTLING_CONFIGURATIONS FROM AM_API_AI_CONFIGURATION WHERE " +
            "API_UUID = ? AND API_REVISION_UUID IS NULL";
    public static final String GET_AI_CONFIGURATION_REVISION = "SELECT AI_CONFIGURATION_UUID, LLM_PROVIDER_UUID, " +
     "ENDPOINT_CONFIGURATION, THROTTLING_CONFIGURATIONS FROM AM_API_AI_CONFIGURATION WHERE " +
      "API_UUID = ? AND API_REVISION_UUID = ?";
    public static final String DELETE_AI_CONFIGURATION_REVISION = "DELETE FROM AM_API_AI_CONFIGURATION WHERE API_UUID" +
     " = ? AND API_REVISION_UUID = ?";
    public static final String DELETE_AI_CONFIGURATIONS = "DELETE FROM AM_API_AI_CONFIGURATION WHERE API_UUID = ? AND" +
     " API_REVISION_UUID IS NULL";
