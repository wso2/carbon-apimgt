...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_KEY_MAPPING_INFO_FROM_APP_ID_KEY_MANAGER_KEY_TYPE = "SELECT UUID,CONSUMER_KEY," +
            "KEY_MANAGER, KEY_TYPE, STATE,APP_INFO,CREATE_MODE FROM AM_APPLICATION_KEY_MAPPING WHERE APPLICATION_ID = ?"
            + " AND KEY_MANAGER = ? AND KEY_TYPE = ?";
