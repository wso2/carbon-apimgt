...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_REVISIONS_BY_API_UUID = "SELECT AR.ID, AR.API_UUID, AR.REVISION_UUID, " +
                "AR.DESCRIPTION, AR.CREATED_TIME, AR.CREATED_BY, ADRM.NAME, ADRM.VHOST, ADRM.DISPLAY_ON_DEVPORTAL, " +
                "ADRM.DEPLOYED_TIME AS DEPLOY_TIME, AD.DEPLOYED_TIME AS DEPLOYED_TIME  " +
                "FROM AM_REVISION AR " +
                "LEFT JOIN " +
                "AM_DEPLOYMENT_REVISION_MAPPING ADRM " +
                "ON AR.REVISION_UUID = ADRM.REVISION_UUID " +
                "LEFT JOIN AM_DEPLOYED_REVISION AD " +
                "ON AR.REVISION_UUID = AD.REVISION_UUID AND AD.NAME=ADRM.NAME " +
                "WHERE AR.API_UUID = ?";
        ...
        public static final String GET_API_REVISION_DEPLOYMENTS_BY_API_UUID
                = "SELECT * FROM " +
                "(SELECT t3.NAME, t3.VHOST, t3.REVISION_UUID, MAX(t3.DEPLOYED_TIME) AS DEPLOYED_TIME, MAX(t3.DISPLAY_ON_DEVPORTAL) AS DISPLAY_ON_DEVPORTAL, MAX(t3.DEPLOY_TIME) AS DEPLOY_TIME " +
                "FROM " +
                ...
                "GROUP BY t3.NAME, t3.REVISION_UUID, t3.VHOST) AS t4 " +
