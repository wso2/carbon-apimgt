...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_REVISIONS_BY_API_UUID = "SELECT * FROM AM_REVISION AR LEFT JOIN AM_DEPLOYED_REVISION ADR"
                + " ON AR.REVISION_UUID = ADR.REVISION_UUID  WHERE AR.API_UUID = ? ";
