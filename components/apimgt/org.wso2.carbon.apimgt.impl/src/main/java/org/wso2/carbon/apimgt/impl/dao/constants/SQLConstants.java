...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String UPDATE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = ? WHERE API_UUID = ? AND NAME = ? AND KEY_TYPE = ? AND STATUS = 'ACTIVE'";
    public static final String GET_API_KEY_ASSOCIATIONS_SQL = "SELECT K.NAME, A.API_NAME, K.TIME_CREATED, K.VALIDITY_PERIOD, K.LAST_USED FROM AM_API_KEY K " +
            "LEFT JOIN AM_API A ON K.API_UUID = A.API_UUID WHERE K.APPLICATION_UUID = ? AND K.KEY_TYPE = ? AND K.STATUS = 'ACTIVE' AND K.API_UUID IS NOT NULL";
    public static final String REMOVE_API_KEY_ASSOCIATION_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL WHERE API_UUID = ? AND NAME = ?";
    public static final String REMOVE_API_KEY_ASSOCIATION_VIA_APP_SQL =
            "UPDATE AM_API_KEY SET APPLICATION_UUID = NULL WHERE APPLICATION_UUID = ? AND NAME = ?";
