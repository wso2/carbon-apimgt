  ...
  //--------------------
    ...
    public static class ClientCertificateConstants{
        ...
        public static final String SELECT_CERTIFICATE_FOR_TENANT =
                "SELECT AC.CERTIFICATE, AC.ALIAS, AC.TIER_NAME, AC.KEY_TYPE, AA.API_PROVIDER, AA.API_NAME, "
        ...
        public static final String SELECT_CERTIFICATE_FOR_TENANT_ALIAS =
                "SELECT AC.CERTIFICATE, AC.ALIAS, AC.TIER_NAME, AC.KEY_TYPE, AA.API_PROVIDER, AA.API_NAME, AA.API_VERSION "
        ...
        public static final String SELECT_CERTIFICATE_FOR_TENANT_ALIAS_APIID =
                "SELECT AC.CERTIFICATE, AC.ALIAS, AC.TIER_NAME, AC.KEY_TYPE FROM AM_API_CLIENT_CERTIFICATE AC "
    ...
    public static class APIRevisionSqlConstants {
        ...
        public static final String GET_CLIENT_CERTIFICATES = "SELECT ALIAS, CERTIFICATE," +
                " TIER_NAME, KEY_TYPE FROM AM_API_CLIENT_CERTIFICATE WHERE API_ID = ? AND REVISION_UUID='Current API' AND REMOVED=FALSE";
        public static final String GET_CLIENT_CERTIFICATES_MSSQL = "SELECT ALIAS, CERTIFICATE," +
                " TIER_NAME, KEY_TYPE FROM AM_API_CLIENT_CERTIFICATE WHERE API_ID = ? AND REVISION_UUID='Current API' AND REMOVED=0";
        ...
        public static final String GET_CLIENT_CERTIFICATES_BY_REVISION_UUID = "SELECT ALIAS, CERTIFICATE," +
                " TIER_NAME, KEY_TYPE FROM AM_API_CLIENT_CERTIFICATE WHERE API_ID = ? AND REVISION_UUID = ?";
