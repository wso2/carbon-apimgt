  ...
  //--------------------
    ...
    public static final String ADD_API_SQL =
            " INSERT INTO AM_API (API_PROVIDER,API_NAME,API_VERSION,CONTEXT,CONTEXT_TEMPLATE,CREATED_BY," +
                    "CREATED_TIME, API_TIER, API_TYPE, API_UUID,STATUS, ORGANIZATION, GATEWAY_VENDOR)" +
                    " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String ADD_API_PRODUCT =
            ...
            + "API_TIER, CREATED_BY, CREATED_TIME, API_TYPE, API_UUID, STATUS, ORGANIZATION, GATEWAY_VENDOR) VALUES (?,?,?,?,?,?,?,?,?"
                    + ",?,?,?)";
