package org.wso2.carbon.apimgt.rest.api.gateway.v2;

import org.wso2.carbon.apimgt.rest.api.gateway.v2.dto.EndpointsDTO;
import org.wso2.carbon.apimgt.rest.api.gateway.v2.dto.ErrorDTO;
import org.wso2.carbon.apimgt.rest.api.gateway.v2.EndPointsApiService;
import org.wso2.carbon.apimgt.rest.api.gateway.v2.impl.EndPointsApiServiceImpl;
...
EndPointsApiService delegate = new EndPointsApiServiceImpl();
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 202, message = "Accepted. The request has been accepted. ", response = EndpointsDTO.class),
