...
import org.wso2.carbon.apimgt.rest.api.gateway.v2.SequenceApiService;
import org.wso2.carbon.apimgt.rest.api.gateway.v2.impl.SequenceApiServiceImpl;
...
SequenceApiService delegate = new SequenceApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Get sequences from the storage", notes = "This operation is used to get the API sequence from the storage. If the Tenant domain is not provided carbon.super will be picked as the Tenant domain. ", response = SequencesDTO.class, tags={ "Get API Artifacts" })
    @ApiResponses(value = { 
