...
/**
 * This is a test case for {@link RegularExpressionProtector}
 */
...
public class RegularExpressionProtectorTest {
    ...
    public void testSqlInjectionInPathParam() {
        log.info("Running Sql injection query param test case.");
    ...
    public void testSqlInjectionInHeaders() {
        log.info("Running test case for sql injection in request headers.");
