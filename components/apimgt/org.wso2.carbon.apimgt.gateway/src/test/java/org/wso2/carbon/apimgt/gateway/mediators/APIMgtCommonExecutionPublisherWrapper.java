...
public class APIMgtCommonExecutionPublisherWrapper extends APIMgtCommonExecutionPublisher {

    private APIManagerAnalyticsConfiguration apiManagerAnalyticsConfiguration;

    public APIMgtCommonExecutionPublisherWrapper(APIManagerAnalyticsConfiguration apiManagerAnalyticsConfiguration) {
