...
public class APIHandlerServiceComponentTestCase {
    ...
    public void testActivate() throws Exception {
        ...
        RevokedJWTTokensRetriever revokedJWTTokensRetriever = Mockito.mock(RevokedJWTTokensRetriever.class);
        PowerMockito.whenNew(RevokedJWTTokensRetriever.class).withAnyArguments().thenReturn(revokedJWTTokensRetriever);
        PowerMockito.doNothing().when(revokedJWTTokensRetriever).startRevokedJWTTokensRetriever();
