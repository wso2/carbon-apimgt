...
public class APIGatewayAdmin extends org.wso2.carbon.core.AbstractAdmin{
	 ...
	 * @throws AxisFault
	 */
	public void addApiForTenant(String apiProviderName, String apiName, String version, String apiConfig, String tenantDomain ) throws AxisFault {
     ...
     * @throws AxisFault
     */
    public void addPrototypeApiScriptImplForTenant(String apiProviderName, String apiName, String version,String apiConfig, String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.addPrototypeApiScriptImpl(apiConfig, tenantDomain);
    }
    
    public void addPrototypeApiScriptImpl(String apiProviderName, String apiName, String version,String apiConfig) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.addPrototypeApiScriptImpl(apiConfig);
    }

    public void addDefaultAPIForTenant(String apiProviderName, String apiName, String version,String apiConfig, String tenantDomain) throws AxisFault{
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.addDefaultAPI(apiConfig, tenantDomain);
    }
    
    public void addDefaultAPI(String apiProviderName, String apiName, String version,String apiConfig) throws AxisFault{
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
	 ...
	 * @throws AxisFault
	 */
    public org.wso2.carbon.apimgt.gateway.dto.APIData getApiForTenant(String apiProviderName, String apiName, String version,String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	APIData apiData = restClient.getApi(tenantDomain);
        return convert(apiData);
    }
    
    public org.wso2.carbon.apimgt.gateway.dto.APIData getApi(String apiProviderName, String apiName, String version) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	APIData apiData = restClient.getApi();
        return convert(apiData);
    }

    public org.wso2.carbon.apimgt.gateway.dto.APIData getDefaultApiForTenant(String apiProviderName, String apiName, String version,String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	APIData apiData = restClient.getDefaultApi(tenantDomain);
        return convert(apiData);
    }
    
    public org.wso2.carbon.apimgt.gateway.dto.APIData getDefaultApi(String apiProviderName, String apiName, String version) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
     ...
     * @throws AxisFault
     */
	public void updateApiForTenant(String apiProviderName, String apiName, String version,String apiConfig, String tenantDomain) throws AxisFault {
		RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
     ...
     * @throws AxisFault
     */
    public void updateApiForInlineScriptForTenant(String apiProviderName, String apiName, String version,String apiConfig, String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.updateApiForInlineScript(apiConfig, tenantDomain);
    }
    
    public void updateApiForInlineScript(String apiProviderName, String apiName, String version,String apiConfig) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.updateApiForInlineScript(apiConfig);
    }

    public void updateDefaultApiForTenant(String apiProviderName, String apiName, String version,String apiConfig, String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    	restClient.updateDefaultApi(apiConfig, tenantDomain);
    }
    
    public void updateDefaultApi(String apiProviderName, String apiName, String version,String apiConfig) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
	 ...
	 * @throws AxisFault
	 */
	public void deleteApiForTenant(String apiProviderName, String apiName, String version,String tenantDomain) throws AxisFault {
		RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    ...
    public void deleteDefaultApiForTenant(String apiProviderName, String apiName, String version,String tenantDomain) throws AxisFault {
    	RESTAPIAdminClient restClient = new RESTAPIAdminClient(apiProviderName, apiName, version);
    ...
    private org.wso2.carbon.apimgt.gateway.dto.APIData convert(org.wso2.carbon.rest.api.stub.types.carbon.APIData data){
    	if(data == null){
    		return null;
    	}
    ...
    private org.wso2.carbon.apimgt.gateway.dto.ResourceData convert(org.wso2.carbon.rest.api.stub.types.carbon.ResourceData data){
