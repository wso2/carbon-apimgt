...
/**
 * Seam over the network access-control gate so the SSRF check can be unit-tested
 * without the full {@code APIUtil} static context. Production wiring delegates to
