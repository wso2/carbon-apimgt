 ...
 */
public class AzureOpenAILLMProviderServiceImpl implements LLMProviderServiceForChatCompletion {
    ...
    public void init(LLMProviderConfigurationDTO providerConfig) throws APIManagementException {
        ...
        if (this.azureApiKey == null || this.endpointUrl == null) {
            throw new APIManagementException(
                    "Missing required Azure OpenAI LLM configuration properties: 'apikey' and/or 'llm_endpoint'");
        }
        ...
        try {
            ...
            try (CloseableHttpResponse response = APIUtil.executeHTTPRequestWithRetries(
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    log.error("Azure OpenAI API returned unexpected status code: " + statusCode);
