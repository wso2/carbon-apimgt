...
public class ApiKeyAuthenticator implements Authenticator {
    ...
    public InboundProcessorResponseDTO authenticate(InboundMessageContext inboundMessageContext)
        ...
        InboundWebsocketProcessorUtil.isAuthenticatorEnabled(APIConstants.API_SECURITY_API_KEY, inboundMessageContext);
        ...
        try {
            String apiKey = inboundMessageContext.getRequestHeaders().get(APIConstants.API_KEY_HEADER_QUERY_PARAM);
            ...
            if (inboundMessageContext.isHandShake()) {
                ...
                if (!ApiKeyAuthenticatorUtils.validateAPIKeyFormat(splitToken, decodedHeader, payload)) {
