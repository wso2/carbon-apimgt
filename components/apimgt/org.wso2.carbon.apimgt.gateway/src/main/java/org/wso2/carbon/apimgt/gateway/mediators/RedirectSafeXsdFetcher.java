 ...
 *
 * <p>This closes a redirect-to-private SSRF bypass: if the document is fetched by the JDK Xerces loader
 ...
 * default, so an allow-listed host that redirects to {@code 127.0.0.1}/{@code 169.254.169.254} would be
