...
public class Utils {
    ...
    public static String getRequestPath(MessageContext synCtx, String fullRequestPath, String apiContext,
            String apiVersion) {
        String requestPath;
    ...
    public static void removeCacheEntryFromGatewayAPiKeyCache(String key) {
        Caching.getCacheManager(APIConstants.API_MANAGER_CACHE_MANAGER)
                .getCache(APIConstants.GATEWAY_API_KEY_CACHE_NAME).remove(key);
    }
    ...
    public static void putInvalidTokenEntryIntoInvalidTokenCache(String cachedToken, String tenantDomain) {
        Caching.getCacheManager(APIConstants.API_MANAGER_CACHE_MANAGER)
                .getCache(APIConstants.GATEWAY_INVALID_TOKEN_CACHE_NAME).put(cachedToken, tenantDomain);
    }
    ...
    public static String getClientCertificateHeader() {
        ...
        if (apiManagerConfiguration != null) {
            String clientCertificateHeader = apiManagerConfiguration.getFirstProperty(
                    APIConstants.MutualSSL.CLIENT_CERTIFICATE_HEADER);
    ...
    public static X509Certificate getClientCertificate(org.apache.axis2.context.MessageContext axis2MessageContext)
        ...
        if (validatedCert != null) {
            ...
            if (sslCertObject != null) {
                ...
                axis2MessageContext.setProperty(APIMgtGatewayConstants.VALIDATED_X509_CERT,
    ...
    private static X509Certificate getClientCertificateFromHeader(
    ...
    private static boolean isClientCertificateValidationEnabled() {
        ...
        if (apiManagerConfiguration != null) {
            String firstProperty = apiManagerConfiguration.getFirstProperty(
                    APIConstants.MutualSSL.ENABLE_CLIENT_CERTIFICATE_VALIDATION);
    ...
    public static TreeMap<String, org.wso2.carbon.apimgt.keymgt.model.entity.API> getSelectedAPIList(String path,
            String tenantDomain) {
        TreeMap<String, org.wso2.carbon.apimgt.keymgt.model.entity.API> selectedAPIMap = new TreeMap<>(
                new ContextLengthSorter());
