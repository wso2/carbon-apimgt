...
public class RevokedConsumerKeyServiceImpl implements RevokedConsumerKeyService {
    @Override
    public void addConsumerKeyIntoMap(String revokedToken, Long expiryTime) {
        InternalRevokedJWTDataHolder.getInstance().addInternalRevokedJWTClientIDToMap(revokedToken, expiryTime);
    }
