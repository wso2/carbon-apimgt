...
public class ThrottledFaultDataCollector extends AbstractFaultDataCollector {
    ...
    public ThrottledFaultDataCollector(AnalyticsDataProvider provider, FaultEventType subType,
    ...
    public ThrottledFaultDataCollector(AnalyticsDataProvider provider) {
        this(provider, FaultEventType.THROTTLED, new FaultyRequestDataPublisher());
