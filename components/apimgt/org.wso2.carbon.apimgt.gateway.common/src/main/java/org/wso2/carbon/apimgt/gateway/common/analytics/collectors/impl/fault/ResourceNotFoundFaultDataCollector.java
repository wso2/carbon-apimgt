...
public class ResourceNotFoundFaultDataCollector extends AbstractFaultDataCollector {
    ...
    public ResourceNotFoundFaultDataCollector(AnalyticsDataProvider provider, FaultEventType subType,
    ...
    public ResourceNotFoundFaultDataCollector(AnalyticsDataProvider provider) {
        this(provider, FaultEventType.RESOURCE_NOT_FOUND, new FaultyRequestDataPublisher());
    }
