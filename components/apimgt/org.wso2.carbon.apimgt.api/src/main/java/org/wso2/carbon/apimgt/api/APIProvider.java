...
public interface APIProvider extends APIManager {
    ...
    * */
     ...
     */
    void publishInPrivateJet(API api, APIIdentifier apiIdentifier, List<String> clusterNames) throws ParseException, UserStoreException, RegistryException, IllegalAccessException, InstantiationException, ClassNotFoundException, APIManagementException;
}
