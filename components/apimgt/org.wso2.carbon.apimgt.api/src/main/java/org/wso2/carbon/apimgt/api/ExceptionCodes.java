...
public enum ExceptionCodes implements ErrorHandler {
    ...
    DUPLICATE_ISSUER(900616, "Unable to add identity provider.", 409, "An Identity provider with issuer has already registered"),
    EMPTY_ISSUER(600617, "Unable to add Identity Provider", 400, "Issuer is empty"),
