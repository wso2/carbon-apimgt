...
public enum ExceptionCodes implements ErrorHandler {
    ...
    RETIRED_MCP_SERVER_REVISION_DEPLOYMENT_UNSUPPORTED(900809,
    ...
    NO_MCP_SERVER_ARTIFACT_FOUND(900810, "No MCP Server artifacts found for given criteria", 404,
            "No MCP Server artifacts found for given criteria"),
    MCP_SERVER_UPDATE_FORBIDDEN_PER_LC(900811, "Insufficient permission to update the MCP Server", 403,
            "Updating the MCP Server is restricted as as it is %s."),
    INVALID_MCP_SERVER_ID(900812, "Invalid MCP Server ID", 404,
