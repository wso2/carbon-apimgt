...
public class APIInfo {
    ...
    private boolean isInitiatedFromGateway;
    ...
    public APIIdentifier toAPIIdentifier() {
        ...
        if (provider != null && provider.contains(APIConstants.EMAIL_DOMAIN_SEPARATOR)) {
            providerEmailDomainReplaced = provider.replace(APIConstants.EMAIL_DOMAIN_SEPARATOR,
    ...
    public static class Builder {
        ...
        public Builder isInitiatedFromGateway(int initiatedFromGateway) {
            this.isInitiatedFromGateway = initiatedFromGateway == 1;
            return this;
        }
        ...
        public APIInfo build() {
            ...
            apiInfo.isInitiatedFromGateway = isInitiatedFromGateway;
            return apiInfo;
        }
