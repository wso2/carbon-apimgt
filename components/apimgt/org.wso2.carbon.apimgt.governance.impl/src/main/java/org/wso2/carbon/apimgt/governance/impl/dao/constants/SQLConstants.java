...
public class SQLConstants {
    ...
    public static final String CREATE_DEVPORTAL_TEMPLATE =
            "INSERT INTO GOV_DEVPORTAL_TEMPLATE (TEMPLATE_ID, NAME, DESCRIPTION, FORM_CONFIG, FORM_CONFIG_HASH, " +
                    "STATUS, IS_DEFAULT, IS_GLOBAL, ORGANIZATION, CREATED_BY, CREATED_TIME) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    public static final String UPDATE_DEVPORTAL_TEMPLATE =
            "UPDATE GOV_DEVPORTAL_TEMPLATE SET NAME = ?, DESCRIPTION = ?, FORM_CONFIG = ?, FORM_CONFIG_HASH = ?, " +
                    "STATUS = ?, IS_DEFAULT = ?, IS_GLOBAL = ?, UPDATED_BY = ?, LAST_UPDATED_TIME = ? " +
                    "WHERE TEMPLATE_ID = ? AND ORGANIZATION = ?";
    ...
    public static final String GET_DEVPORTAL_TEMPLATE_BY_ID =
            "SELECT TEMPLATE_ID, NAME, DESCRIPTION, FORM_CONFIG, FORM_CONFIG_HASH, STATUS, IS_DEFAULT, IS_GLOBAL, " +
                    "ORGANIZATION, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME " +
    ...
    public static final String GET_TEMPLATE_RULESET_BINDINGS =
            "SELECT BINDING_ID, TEMPLATE_ID, RULESET_ID, BINDING_ORDER, CREATED_BY, CREATED_TIME " +
                    "FROM GOV_TEMPLATE_RULESET_BINDING WHERE TEMPLATE_ID = ? ORDER BY BINDING_ORDER";
