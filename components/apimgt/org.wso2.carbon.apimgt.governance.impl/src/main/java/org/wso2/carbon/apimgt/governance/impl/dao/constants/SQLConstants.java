...
public class SQLConstants {
    ...
    public static final String CREATE_GOVERNANCE_POLICY_ATTACHMENT_STATE_MAPPING =
            "INSERT INTO GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE (POLICY_ATTACHMENT_ID, STATE) VALUES (?, ?)";
    ...
    public static final String DELETE_GOVERNANCE_POLICY_ATTACHMENT_STATE_MAPPING_BY_POLICY_ID =
            "DELETE FROM GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE WHERE POLICY_ATTACHMENT_ID = ?";
    ...
    public static final String SEARCH_POLICY_ATTACHMENT =
            "SELECT DISTINCT GP.POLICY_ATTACHMENT_ID, GP.NAME, GP.DESCRIPTION, GP.CREATED_BY, GP.CREATED_TIME, " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE GPS ON GP.POLICY_ATTACHMENT_ID = " +
    ...
    public static final String GET_STATES_BY_POLICY_ATTACHMENT_ID =
            "SELECT STATE FROM GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE WHERE POLICY_ATTACHMENT_ID = ?";
    ...
    public static final String GET_POLICY_ATTACHMENT_FOR_POLICY =
            "SELECT POLICY_ATTACHMENT_ID FROM GOV_POLICY_ATTACHMENT_POLICY GPR " +
    ...
    public static final String GET_POLICIES_BY_POLICY_ATTACHMENT_ID =
            "SELECT POLICY.POLICY_ID, POLICY.NAME, " +
                    ...
                    "WHERE POLICY_POLICY_MAPPING.POLICY_ATTACHMENT_ID = ? AND POLICY.ORGANIZATION = ?";
    public static final String GET_POLICIES_WITH_CONTENT_BY_POLICY_ATTACHMENT_ID =
            "SELECT POLICY.POLICY_ID, POLICY.NAME, " +
                    ...
                    "WHERE GPR.POLICY_ATTACHMENT_ID = ? AND POLICY.ORGANIZATION = ?";
    public static final String GET_POLICY_ATTACHMENTS_BY_LABEL =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ID, GOV_POLICY_ATTACHMENT.NAME " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_LABEL.POLICY_ATTACHMENT_ID " +
    ...
    public static final String GET_POLICY_ATTACHMENTS_BY_LABEL_AND_STATE =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID " +
                    "FROM GOV_POLICY_ATTACHMENT " +
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_LABEL.POLICY_ATTACHMENT_ID " +
                    "JOIN GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE.POLICY_ATTACHMENT_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_LABEL.LABEL = ? " +
    ...
    public static final String DELETE_POLICY_ATTACHMENT_RUN_FOR_POLICY_ATTACHMENT = "DELETE " +
            "FROM GOV_POLICY_ATTACHMENT_RUN WHERE POLICY_ID = ?";
    ...
    public static final String GET_ARTIFACTS_FOR_POLICY_ATTACHMENT_RUN = "SELECT DISTINCT GA.ARTIFACT_REF_ID, " +
            ...
            "JOIN GOV_POLICY_ATTACHMENT_RUN GPR ON GA.ARTIFACT_KEY = GPR.ARTIFACT_KEY " +
            "WHERE GPR.POLICY_ATTACHMENT_ID = ? AND GA.ORGANIZATION = ?";
