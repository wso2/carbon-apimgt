...
public class SQLConstants {
    ...
    public static final String GET_POLICY_ATTACHMENTS_BY_LABEL_AND_STATE =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_LABEL.POLICY_ATTACHMENT_ID " +
                    "JOIN GOV_POLICY_ATTACHMENT_STATE ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_STATE.POLICY_ATTACHMENT_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_LABEL.LABEL = ? " +
                    "AND GOV_POLICY_ATTACHMENT_STATE.STATE = ? " +
                    "AND GOV_POLICY_ATTACHMENT.ORGANIZATION = ?";
    ...
    public static final String GET_GLOBAL_POLICY_ATTACHMENT_BY_STATE =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_STATE ON GOV_POLICY_ATTACHMENT.POLICY_ATTACHMENT_ID = " +
                    "GOV_POLICY_ATTACHMENT_STATE.POLICY_ATTACHMENT_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_STATE.STATE = ? " +
                    "AND GOV_POLICY_ATTACHMENT.ORGANIZATION = ? " +
                    "AND GOV_POLICY_ATTACHMENT.IS_GLOBAL = 1";
    ...
    public static final String GET_ALL_EVALUATED_ARTIFACTS = "SELECT DISTINCT GA.ARTIFACT_REF_ID " +
            "FROM GOV_ARTIFACT GA " +
