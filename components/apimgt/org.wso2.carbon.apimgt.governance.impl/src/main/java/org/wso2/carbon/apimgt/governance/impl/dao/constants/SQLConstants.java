...
public class SQLConstants {
    ...
    public static final String GET_POLICY_ATTACHMENT_BY_NAME =
            "SELECT POLICY_ID, NAME, DESCRIPTION, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME, IS_GLOBAL " +
                    "FROM GOV_POLICY_ATTACHMENT WHERE ORGANIZATION = ? AND NAME = ?";

    public static final String GET_POLICY_ATTACHMENT_BY_ID =
            "SELECT POLICY_ID, NAME, DESCRIPTION, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME, IS_GLOBAL " +
                    "FROM GOV_POLICY_ATTACHMENT WHERE POLICY_ID = ? AND ORGANIZATION = ?";

    public static final String GET_POLICY_ATTACHMENT =
            "SELECT POLICY_ID, NAME, DESCRIPTION, CREATED_BY, CREATED_TIME, UPDATED_BY, LAST_UPDATED_TIME, IS_GLOBAL " +
                    "FROM GOV_POLICY_ATTACHMENT WHERE ORGANIZATION = ?";
    ...
    public static final String SEARCH_POLICY_ATTACHMENT =
            "SELECT DISTINCT GP.POLICY_ID, GP.NAME, GP.DESCRIPTION, GP.CREATED_BY, GP.CREATED_TIME, " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL GPL ON GP.POLICY_ID = GPL.POLICY_ID " +
                    "JOIN GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE GPS ON GP.POLICY_ID = GPS.POLICY_ID " +
    ...
    public static final String GET_POLICY_IDS_BY_POLICY_ATTACHMENT_ID =
            "SELECT POLICY_ID FROM GOV_POLICY_ATTACHMENT_POLICY WHERE POLICY_ID = ?";

    public static final String GET_LABELS_BY_POLICY_ATTACHMENT_ID =
            "SELECT LABEL FROM GOV_POLICY_ATTACHMENT_LABEL WHERE POLICY_ID = ?";

    public static final String GET_STATES_BY_POLICY_ATTACHMENT_ID =
            "SELECT STATE FROM GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE WHERE POLICY_ID = ?";

    public static final String GET_ACTIONS_BY_POLICY_ATTACHMENT_ID =
            "SELECT STATE,SEVERITY,TYPE FROM GOV_POLICY_ATTACHMENT_ACTION WHERE POLICY_ID = ?";

    public static final String GET_POLICIES_FOR_POLICY =
            "SELECT POLICY_ID FROM GOV_POLICY_ATTACHMENT_POLICY GPR " +
                    "JOIN GOV_POLICY GR ON GPR.POLICY_ID = GR.POLICY_ID " +
                    "WHERE GPR.POLICY_ID = ? AND GR.ORGANIZATION = ?";
    ...
    public static final String GET_POLICIES_BY_POLICY_ATTACHMENT_ID =
            "SELECT POLICY.POLICY_ID, POLICY.NAME, " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_POLICY POLICY_POLICY_MAPPING ON POLICY.POLICY_ID = " +
                    "POLICY_POLICY_MAPPING.POLICY_ID " +
                    "WHERE POLICY_POLICY_MAPPING.POLICY_ID = ? AND POLICY.ORGANIZATION = ?";
    public static final String GET_POLICIES_WITH_CONTENT_BY_POLICY_ATTACHMENT_ID =
            "SELECT POLICY.POLICY_ID, POLICY.NAME, " +
                    "POLICY.POLICY_CATEGORY, POLICY.POLICY_TYPE, POLICY.ARTIFACT_TYPE, " +
                    "RC.CONTENT, RC.CONTENT_TYPE, RC.FILE_NAME " +
                    "FROM GOV_POLICY POLICY " +
                    "JOIN GOV_POLICY_CONTENT RC " +
                    "ON POLICY.POLICY_ID = RC.POLICY_ID " +
                    "JOIN GOV_POLICY_ATTACHMENT_POLICY GPR " +
                    "ON POLICY.POLICY_ID = GPR.POLICY_ID " +
                    "WHERE GPR.POLICY_ID = ? AND POLICY.ORGANIZATION = ?";
    public static final String GET_POLICIES_BY_LABEL =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ID, GOV_POLICY_ATTACHMENT.NAME " +
                    "FROM GOV_POLICY_ATTACHMENT " +
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL ON GOV_POLICY_ATTACHMENT.POLICY_ID = GOV_POLICY_ATTACHMENT_LABEL.POLICY_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_LABEL.LABEL = ? " +
                    "AND GOV_POLICY_ATTACHMENT.ORGANIZATION = ?";
    ...
    public static final String GET_POLICIES_BY_LABEL_AND_STATE =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ID " +
                    "FROM GOV_POLICY_ATTACHMENT " +
                    "JOIN GOV_POLICY_ATTACHMENT_LABEL ON GOV_POLICY_ATTACHMENT.POLICY_ID = GOV_POLICY_ATTACHMENT_LABEL.POLICY_ID " +
                    "JOIN GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE ON GOV_POLICY_ATTACHMENT.POLICY_ID = " +
                    "GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE.POLICY_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_LABEL.LABEL = ? " +
                    "AND GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE.STATE = ? " +
                    "AND GOV_POLICY_ATTACHMENT.ORGANIZATION = ?";
    ...
    public static final String GET_GLOBAL_POLICIES_BY_STATE =
            "SELECT DISTINCT GOV_POLICY_ATTACHMENT.POLICY_ID " +
                    ...
                    "JOIN GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE ON GOV_POLICY_ATTACHMENT.POLICY_ID = " +
                    "GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE.POLICY_ID " +
                    "WHERE GOV_POLICY_ATTACHMENT_GOVERNABLE_STATE.STATE = ? " +
                    "AND GOV_POLICY_ATTACHMENT.ORGANIZATION = ? " +
                    "AND GOV_POLICY_ATTACHMENT.IS_GLOBAL = 1";
    ...
    public static final String GET_REQ_POLICY_ATTACHMENT_MAPPING = "SELECT POLICY_ID FROM GOV_REQUEST_POLICY_ATTACHMENT " +
            "WHERE REQ_ID = ?";
    ...
    public static final String DELETE_REQ_POLICY_ATTACHMENT_MAPPING_FOR_POLICY_ATTACHMENT = "DELETE FROM " +
            "GOV_REQUEST_POLICY_ATTACHMENT WHERE POLICY_ID = ?";

    public static final String ADD_POLICY_ATTACHMENT_RUN = "INSERT INTO GOV_POLICY_ATTACHMENT_RUN (ARTIFACT_KEY, POLICY_ID) " +
            "VALUES (?, ?)";
    ...
    public static final String DELETE_POLICY_ATTACHMENT_RUN_FOR_ARTIFACT_AND_POLICY_ATTACHMENT = "DELETE FROM GOV_POLICY_ATTACHMENT_RUN " +
    ...
    public static final String DELETE_POLICY_ATTACHMENT_RUN_FOR_POLICY_ATTACHMENT = "DELETE FROM GOV_POLICY_ATTACHMENT_RUN " +
            "WHERE POLICY_ID = ?";

    public static final String GET_POLICY_ATTACHMENT_RUNS_FOR_ARTIFACT = "SELECT DISTINCT POLICY_ID FROM GOV_POLICY_ATTACHMENT_RUN GPR " +
            "JOIN GOV_ARTIFACT GA ON GPR.ARTIFACT_KEY = GA.ARTIFACT_KEY " +
            "WHERE GA.ARTIFACT_REF_ID = ? AND GA.ARTIFACT_TYPE = ? AND GA.ORGANIZATION = ?";

    public static final String GET_POLICY_ATTACHMENT_RUNS = "SELECT DISTINCT POLICY_ID FROM GOV_POLICY_ATTACHMENT_RUN GPR " +
            "JOIN GOV_ARTIFACT GA ON GPR.ARTIFACT_KEY = GA.ARTIFACT_KEY " +
            "WHERE GA.ORGANIZATION = ?";

    public static final String DELETE_POLICY_ATTACHMENT_RUNS_FOR_ARTIFACT = "DELETE FROM GOV_POLICY_ATTACHMENT_RUN WHERE ARTIFACT_KEY " +
    ...
    public static final String GET_RULE_VIOLATIONS =
            "SELECT DISTINCT GV.RULE_NAME, GV.VIOLATED_PATH, GV.MESSAGE, GRULE.SEVERITY " +
                    ...
                    "JOIN GOV_POLICY_RUN GRR ON GV.POLICY_RUN_ID = GRR.POLICY_RUN_ID " +
                    "JOIN GOV_ARTIFACT GA ON GRR.ARTIFACT_KEY = GA.ARTIFACT_KEY " +
                    "JOIN GOV_POLICY_RULE GRULE ON GRR.POLICY_ID = GRULE.POLICY_ID " +
    ...
    public static final String GET_RULE_VIOLATIONS_FOR_ARTIFACT =
            "SELECT DISTINCT GV.POLICY_ID, GV.RULE_NAME, GV.VIOLATED_PATH, GV.MESSAGE, GRULE.SEVERITY " +
                    "FROM GOV_RULE_VIOLATION GV " +
                    "JOIN GOV_POLICY_RUN GRR ON GV.POLICY_RUN_ID = GRR.POLICY_RUN_ID " +
                    "JOIN GOV_ARTIFACT GA ON GRR.ARTIFACT_KEY = GA.ARTIFACT_KEY " +
                    "JOIN GOV_POLICY_RULE GRULE ON GRR.POLICY_ID = GRULE.POLICY_ID " +
    ...
    public static final String GET_ALL_EVALUTED_ARTIFACTS = "SELECT DISTINCT GA.ARTIFACT_REF_ID " +
            "FROM GOV_ARTIFACT GA " +
            "JOIN GOV_POLICY_ATTACHMENT_RUN GPR ON GA.ARTIFACT_KEY = GPR.ARTIFACT_KEY " +
    ...
    public static final String GET_NON_COMPLIANT_ARTIFACTS = "SELECT DISTINCT GA.ARTIFACT_REF_ID " +
            "FROM GOV_ARTIFACT GA " +
            "JOIN GOV_POLICY_ATTACHMENT_RUN GPR ON GA.ARTIFACT_KEY = GPR.ARTIFACT_KEY " +
            "JOIN GOV_POLICY_RUN GRR ON GA.ARTIFACT_KEY = GRR.ARTIFACT_KEY " +
            "WHERE GA.ARTIFACT_TYPE = ? AND GA.ORGANIZATION = ? AND GRR.RESULT = 0";

    public static final String GET_ARTIFACTS_FOR_POLICY_ATTACHMENT_RUN = "SELECT DISTINCT GA.ARTIFACT_REF_ID, " +
