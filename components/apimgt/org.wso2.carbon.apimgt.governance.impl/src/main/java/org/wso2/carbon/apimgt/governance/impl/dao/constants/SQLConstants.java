...
public class SQLConstants {
    ...
    public static final String GET_PROCESSING_EVALUATION_REQUEST_BY_ARTIFACT_AND_POLICY = "SELECT REQUEST_ID, " +
            "ARTIFACT_ID, ARTIFACT_TYPE, POLICY_ID FROM GOV_EVALUATION_REQUEST WHERE ARTIFACT_ID = ? AND POLICY_ID = ? " +
    ...
    public static final String GET_GOV_COMPLIANCE_EVALUATION_RESULTS_ARTIFACT_AND_RULESET = "SELECT * FROM " +
            "GOV_EVALUATION_RESULT " +
            "WHERE ARTIFACT_ID = ? AND RULESET_ID = ?";

    public static final String GET_GOV_COMPLIANCE_EVALUATION_RESULTS_FOR_POLICY =
            "SELECT GCE.ARTIFACT_ID, GAI.ARTIFACT_TYPE, GCE.POLICY_ID, GCE.RULESET_ID, GCE.EVALUATION_RESULT " +
                    "FROM GOV_EVALUATION_RESULT GCE " +
                    "LEFT JOIN GOV_ARTIFACT_INFO GAI " +
                    "ON GCE.ARTIFACT_ID = GAI.ARTIFACT_ID " +
                    "WHERE GCE.POLICY_ID = ? ";
    ...
    public static final String GET_ALL_COMP_EVALUATED_ARTIFACTS = "SELECT DISTINCT GOV_ARTIFACT_INFO.ARTIFACT_ID, " +
            "GOV_ARTIFACT_INFO.ARTIFACT_TYPE FROM " +
            "GOV_EVALUATION_RESULT LEFT JOIN GOV_ARTIFACT_INFO ON " +
            "GOV_EVALUATION_RESULT.ARTIFACT_ID = GOV_ARTIFACT_INFO.ARTIFACT_ID " +
            "WHERE GOV_ARTIFACT_INFO.ARTIFACT_TYPE LIKE ? AND GOV_ARTIFACT_INFO.ORGANIZATION = ?";
    ...
    public static final String GET_NON_COMPLIANT_ARTIFACTS = "SELECT DISTINCT GOV_ARTIFACT_INFO.ARTIFACT_ID, " +
            "GOV_ARTIFACT_INFO.ARTIFACT_TYPE FROM " +
            "GOV_EVALUATION_RESULT LEFT JOIN GOV_ARTIFACT_INFO ON " +
            "GOV_EVALUATION_RESULT.ARTIFACT_ID = GOV_ARTIFACT_INFO.ARTIFACT_ID " +
            "WHERE GOV_ARTIFACT_INFO.ARTIFACT_TYPE LIKE ? AND GOV_ARTIFACT_INFO.ORGANIZATION = ? AND " +
            "GOV_EVALUATION_RESULT.EVALUATION_RESULT = 0 ";
    ...
    public static final String DELETE_GOV_COMPLIANCE_EVALUATION_RESULT_BY_POLICY = "DELETE FROM GOV_EVALUATION_RESULT " +
            "WHERE POLICY_ID = ?";
    ...
    public static final String GET_RULE_VIOLATIONS = "SELECT DISTINCT GV.ARTIFACT_ID, " +
            "GV.RULESET_ID, GV.RULE_CODE, GV.VIOLATED_PATH, GRR.SEVERITY " +
            "FROM GOV_RULE_VIOLATION GV " +
            "LEFT JOIN GOV_RULESET_RULE GRR " +
            "ON GV.RULESET_ID = GRR.RULESET_ID AND GV.RULE_CODE = GRR.RULE_CODE " +
            "WHERE GV.ARTIFACT_ID = ? AND GV.RULESET_ID = ?";
