...
public class SQLConstants {
    ...
    public static final String GET_GOV_COMPLIANCE_EVALUATION_RESULTS_FOR_POLICY =
            "SELECT GCE.ARTIFACT_ID, GAI.ARTIFACT_TYPE, GCE.POLICY_ID, GCE.RULESET_ID, GCE.EVALUATION_RESULT " +
                    "FROM GOV_COMPLIANCE_EVALUATION_RESULT GCE " +
    ...
    public static final String GET_ALL_COMP_EVALUATED_ARTIFACTS = "SELECT DISTINCT ARTIFACT_INFO.ARTIFACT_ID FROM " +
    ...
    public static final String GET_ALL_COMP_EVALUATED_POLICIES = "SELECT DISTINCT " +
            "GOV_COMPLIANCE_EVALUATION_RESULT.POLICY_ID FROM " +
            "GOV_COMPLIANCE_EVALUATION_RESULT LEFT JOIN GOV_POLICY ON " +
            "GOV_COMPLIANCE_EVALUATION_RESULT.POLICY_ID = GOV_POLICY.POLICY_ID " +
            "WHERE GOV_POLICY.ORGANIZATION = ?";

    public static final String GET_NON_COMPLIANT_ARTIFACTS = "SELECT DISTINCT ARTIFACT_INFO.ARTIFACT_ID FROM " +
            "GOV_COMPLIANCE_EVALUATION_RESULT LEFT JOIN ARTIFACT_INFO ON " +
            "GOV_COMPLIANCE_EVALUATION_RESULT.ARTIFACT_ID = ARTIFACT_INFO.ARTIFACT_ID " +
    ...
    public static final String GET_VIOLATED_POLICIES = "SELECT DISTINCT " +
            ...
            "GOV_COMPLIANCE_EVALUATION_RESULT LEFT JOIN GOV_POLICY ON " +
            "GOV_COMPLIANCE_EVALUATION_RESULT.POLICY_ID = GOV_POLICY.POLICY_ID " +
            "WHERE GOV_POLICY.ORGANIZATION = ? AND GOV_COMPLIANCE_EVALUATION_RESULT.EVALUATION_RESULT = 0";
