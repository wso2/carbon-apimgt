...
CREATE TABLE IF NOT EXISTS GOV_RESULT (
    ...
    VALIDATION_RESULT INT NOT NULL DEFAULT 0,
    CONSTRAINT EVALUATION_RESULT_UNIQUE_CONSTRAINT UNIQUE (ARTIFACT_ID, POLICY_ID, RULESET_ID, RULE_CODE, VALIDATED_PATH),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID) ON UPDATE CASCADE ON DELETE CASCADE,
