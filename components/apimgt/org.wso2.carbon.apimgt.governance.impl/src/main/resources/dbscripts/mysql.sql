...
CREATE TABLE IF NOT EXISTS GOV_EVALUATION_RESULT (
    ...
    ORGANIZATION VARCHAR(100) NOT NULL,
    CONSTRAINT EVALUATION_RESULT_UNIQUE_CONSTRAINT UNIQUE (ARTIFACT_ID, POLICY_ID),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID) ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS GOV_RULE_VIOLATION (
    ...
    RULESET_ID VARCHAR(45) NOT NULL,
    RULE_CODE VARCHAR(200) NOT NULL,
    VALIDATED_PATH VARCHAR(1024) NOT NULL,
    ORGANIZATION VARCHAR(100) NOT NULL,
    CONSTRAINT RULE_VIOLATION_UNIQUE_CONSTRAINT UNIQUE (ARTIFACT_ID, POLICY_ID, RULESET_ID, RULE_CODE, VALIDATED_PATH),
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (RULE_CODE, RULESET_ID) REFERENCES GOV_RULESET_RULE(RULE_CODE, RULESET_ID) ON UPDATE CASCADE ON DELETE CASCADE,
