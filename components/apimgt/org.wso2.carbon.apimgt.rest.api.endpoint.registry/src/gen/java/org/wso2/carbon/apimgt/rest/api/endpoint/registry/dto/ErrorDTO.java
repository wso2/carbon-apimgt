...
import org.wso2.carbon.apimgt.rest.api.endpoint.registry.dto.ErrorListItemDTO;
...
public class ErrorDTO   {
    ...
    **/
    ...
    @Schema(description = "Preferably an url with more details about the error. ")
    ...
    **/
    ...
    @Schema(description = "If there are more than one error list them out. For example, list out validation errors by each field. ")
    @JsonProperty("error")
