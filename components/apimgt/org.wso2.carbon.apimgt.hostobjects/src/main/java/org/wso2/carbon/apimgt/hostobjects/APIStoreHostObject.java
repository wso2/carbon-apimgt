        ...
        if (args != null && args.length != 0) {
            ...
            try {
                ...
                Map<String, String> keyDetails = getAPIConsumer(thisObj).requestApprovalForApplicationRegistration(
		                username, applicationName, tokenType, callbackUrl, accessAllowDomainsArray, validityPeriod, 
		                authScopeString, groupingId);
    ...
    public static NativeObject jsFunction_createApplicationKeys(Context cx,
        ...
        if (args != null && args.length > 7) {
            try {
                ...
                String groupingId = (String) args[7];
                Map<String, String> keyDetails = getAPIConsumer(thisObj).completeApplicationRegistration(userId, applicationName, tokenType, tokenScope, groupingId);
        ...
        if (args != null && args.length != 0) {
            ...
            if (apiConsumer.isApplicationTokenExists(oldAccessToken)) {
                ...
                try {
	                ...
	                Set<SubscribedAPI> subscribedAPIs =
			                apiConsumer.getSubscribedAPIs(subscriber, applicationName, null);
	                List<APIIdentifier> identifiers = new ArrayList<APIIdentifier>();
