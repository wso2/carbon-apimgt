...
public class AdditionalSubscriptionInfoMappingUtil {
    ...
    public static AdditionalSubscriptionInfoDTO fromAdditionalSubscriptionInfoToDTO(SubscribedAPI subscription,
        ...
        if (api != null) {
            ...
            additionalSubscriptionInfoDTO.setIsSolaceAPI(
                    SolaceNotifierUtils.checkWhetherAPIDeployedToSolaceUsingRevision(api));
        }

        if (additionalSubscriptionInfoDTO.isIsSolaceAPI()) {
            //Set Solace organization details if API is a Solace API
            additionalSubscriptionInfoDTO.setSolaceOrganization(
                    SolaceNotifierUtils.getThirdPartySolaceBrokerOrganizationNameOfAPIDeployment(api));
            ...
            if (solaceEnvironment != null) {
                List<SolaceDeployedEnvironmentDTO> solaceDeployedEnvironmentsDTOS = SolaceStoreUtils
                        .getSolaceDeployedEnvsInfo(
                        solaceEnvironment, additionalSubscriptionInfoDTO.getSolaceOrganization(),
                        application.getUUID());
                ...
                for (SolaceDeployedEnvironmentDTO solaceDeployedEnvironmentEntry : solaceDeployedEnvironmentsDTOS) {
                    ...
                    solaceDeployedEnvironmentsDTO.setEnvironmentName(
                            solaceDeployedEnvironmentEntry.getEnvironmentName());
                    solaceDeployedEnvironmentsDTO.setEnvironmentDisplayName(
                            solaceDeployedEnvironmentEntry.getEnvironmentDisplayName());
                    solaceDeployedEnvironmentsDTO.setOrganizationName(
                            solaceDeployedEnvironmentEntry.getOrganizationName());
                    ...
                    for (SolaceURLsDTO entry : solaceURLsDTOS) {
                        AdditionalSubscriptionInfoSolaceURLsDTO solaceURLsDTO =
                    ...
                    solaceDeployedEnvironmentsDTO.setSolaceTopicsObject(
                            mapSolaceTopicObjects(solaceDeployedEnvironmentEntry.getSolaceTopicsObject()));
     ...
     */
    private static AdditionalSubscriptionInfoSolaceTopicsObjectDTO mapSolaceTopicObjects(
            SolaceTopicsObjectDTO solaceTopicsObject) {
    ...
    setSolaceEnvironmentDetailsForSubscription(
                ...
                if (gatewayEnvironments != null) {
                    ...
                    if (environment != null) {
                        ...
                        if (SolaceConstants.SOLACE_ENVIRONMENT.equalsIgnoreCase(environment.getProvider())) {
                            AdditionalSubscriptionInfoSolaceDeployedEnvironmentsDTO solaceEnvironmentDTO =
                                    new AdditionalSubscriptionInfoSolaceDeployedEnvironmentsDTO();
                            ...
                            solaceEnvironmentDTO.setSolaceURLs(mapSolaceURLsToStoreDTO(
    ...
    private static List<AdditionalSubscriptionInfoSolaceURLsDTO> mapSolaceURLsToStoreDTO(String organizationName,
        ...
        if (solaceEnvironment != null) {
            List<SolaceURLsDTO> solaceURLsDTOEntries = SolaceStoreUtils.getSolaceURLsInfo(solaceEnvironment,
                    organizationName, environmentName, availableProtocols);
