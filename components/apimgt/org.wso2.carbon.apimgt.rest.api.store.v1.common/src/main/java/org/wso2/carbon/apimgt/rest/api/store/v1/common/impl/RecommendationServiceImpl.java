...
/**
 * This is the service implementation class for recommendationsApi service operations
 */
public class RecommendationServiceImpl {

    private static final Log log = LogFactory.getLog(RecommendationServiceImpl.class);
    ...
    public static String getRecommendationList(String organization) throws APIManagementException {
        ...
        try {
            ...
            if (apiConsumer.isRecommendationEnabled(organization) && !APIConstants.WSO2_ANONYMOUS_USER.equals(
                    userName)) {
