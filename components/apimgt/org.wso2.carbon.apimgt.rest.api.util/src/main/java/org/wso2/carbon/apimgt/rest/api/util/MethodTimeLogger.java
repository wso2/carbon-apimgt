...
public class MethodTimeLogger
{
     ...
     * org.wso2.carbon.apimgt.rest.api.util and consist of the annotation, @MethodStats.
     *
    ...
    /**
     * This is an AspectJ pointcut defined to apply to all methods within the package,
     * org.wso2.carbon.apimgt.rest.api.util. Also, the pointcut looks for the system property to enable
    ...
    public static boolean pointCutAll() {
        if (!isLogAllSet) {
            ...
            if (StringUtils.isNotEmpty(config)) {
                logAllMethods = config.contains("org.wso2.carbon.apimgt.rest.api.util");
                isLogAllSet = true;
            }
        }
    ...
    public static boolean isConfigEnabled() {
        if (!isSet) {
            ...
            String restAPIConfig = System.getProperty(APIConstants.ENABLE_CORRELATION_LOGS);
            if (StringUtils.isNotEmpty(config)) {
