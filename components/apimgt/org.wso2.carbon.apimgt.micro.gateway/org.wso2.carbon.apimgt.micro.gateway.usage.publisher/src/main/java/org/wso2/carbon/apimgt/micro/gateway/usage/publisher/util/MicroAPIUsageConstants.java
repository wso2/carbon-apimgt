...
public class MicroAPIUsageConstants {
    ...
    public static final String INSERT_UPLOADED_FILE_INFO_QUERY = "INSERT INTO AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES "
    ...
    public static final String GET_NEXT_FILES_TO_PROCESS_QUERY_DEFAULT =
            "SELECT TENANT_DOMAIN,FILE_NAME,FILE_TIMESTAMP FROM AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES "
    ...
    public static final String GET_NEXT_FILES_TO_PROCESS_QUERY_ORACLE = "SELECT TENANT_DOMAIN,FILE_NAME,FILE_TIMESTAMP "
            + "FROM AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES WHERE rownum<=? AND "
    ...
    public static final String GET_NEXT_FILES_TO_PROCESS_QUERY_MSSQL = "SELECT TOP ? TENANT_DOMAIN,FILE_NAME,"
            + "FILE_TIMESTAMP FROM AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES WITH (UPDLOCK) "
            + "WHERE FILE_PROCESSED=0 ORDER BY FILE_TIMESTAMP";

    public static final String UPDATE_FILE_PROCESSING_STARTED_STATUS = "UPDATE AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES "
            + "SET FILE_PROCESSED=1 WHERE FILE_PROCESSED=0 AND TENANT_DOMAIN = ? AND FILE_NAME = ?";

    public static final String DELETE_OLD_UPLOAD_COMPLETED_FILES = "DELETE FROM AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES "
    ...
    public static final String GET_UPLOADED_FILE_CONTENT_QUERY = "SELECT FILE_CONTENT "
            + "FROM AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES WHERE TENANT_DOMAIN=? AND FILE_NAME=?";

    public static final String UPDATE_COMPETITION_QUERY = "UPDATE AM_USAGE_UPLOAD_SERVICE_UPLOADED_FILES "
