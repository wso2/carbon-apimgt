...
public class APIMgtUsageFileDataPublisherTest {
    ...
    @Test
    public void publishEvent_withRequestPublisherDTO() throws Exception {
        mockCommonCases();
        ...
        APIMgtUsageFileDataPublisher apiMgtUsageFileDataPublisher = new APIMgtUsageFileDataPublisher();
        apiMgtUsageFileDataPublisher.init();
        apiMgtUsageFileDataPublisher.publishEvent(requestPublisherDTO);
    }

    @Test
    public void publishEvent_withResponsePublisherDTO() throws Exception {
        mockCommonCases();
        PowerMockito.mockStatic(DataPublisherUtil.class);
        APIManagerAnalyticsConfiguration apiMngAnalyticsConfig = Mockito.mock(APIManagerAnalyticsConfiguration.class);
        PowerMockito.when(DataPublisherUtil.getApiManagerAnalyticsConfiguration()).thenReturn(apiMngAnalyticsConfig);
        Mockito.when(apiMngAnalyticsConfig.getRequestStreamName()).thenReturn("org.wso2.apimgt.statistics.response");
        Mockito.when(apiMngAnalyticsConfig.getRequestStreamVersion()).thenReturn("1.1.0");
        ResponsePublisherDTO responsePublisherDTO = new ResponsePublisherDTO();
        APIMgtUsageFileDataPublisher apiMgtUsageFileDataPublisher = new APIMgtUsageFileDataPublisher();
        apiMgtUsageFileDataPublisher.init();
        apiMgtUsageFileDataPublisher.publishEvent(responsePublisherDTO);
    }
    ...
    @Test
    public void publishEvent_withExecutionTimePublisherDTO() throws Exception {
        mockCommonCases();
        PowerMockito.mockStatic(DataPublisherUtil.class);
        APIManagerAnalyticsConfiguration apiMngAnalyticsConfig = Mockito.mock(APIManagerAnalyticsConfiguration.class);
        PowerMockito.when(DataPublisherUtil.getApiManagerAnalyticsConfiguration()).thenReturn(apiMngAnalyticsConfig);
        Mockito.when(apiMngAnalyticsConfig.getRequestStreamName())
                .thenReturn("org.wso2.apimgt.statistics.execution.time");
        Mockito.when(apiMngAnalyticsConfig.getRequestStreamVersion()).thenReturn("1.0.0");
        ExecutionTimePublisherDTO executionTimePublisherDTO = new ExecutionTimePublisherDTO();
        APIMgtUsageFileDataPublisher apiMgtUsageFileDataPublisher = new APIMgtUsageFileDataPublisher();
        apiMgtUsageFileDataPublisher.init();
        apiMgtUsageFileDataPublisher.publishEvent(executionTimePublisherDTO);
    }
