...
public class APIMGovernanceAPIConstants {
    ...
    public static final String POLICY_ATTACHMENT_PATH = "/policy-attachments";
    public static final String ARTIFACT_COMPLIANCE_PATH = "/artifact-compliance";
    public static final String POLICY_ATTACHMENT_ADHERENCE_PATH = "/policy-attachment-adherence";
    ...
    public static final String POLICY_GET_URL =
            POLICY_PATH + "?limit=" + LIMIT_PARAM + "&offset=" + OFFSET_PARAM + "&query=" + QUERY_PARAM;

    public static final String POLICY_ATTACHMENT_GET_URL =
            POLICY_ATTACHMENT_PATH + "?limit=" + LIMIT_PARAM + "&offset=" + OFFSET_PARAM + "&query=" + QUERY_PARAM;
    ...
    public static final String POLICY_ATTACHMENT_ADHERENCE_GET_URL =
            POLICY_ATTACHMENT_ADHERENCE_PATH + "?limit=" + LIMIT_PARAM + "&offset=" + OFFSET_PARAM;
