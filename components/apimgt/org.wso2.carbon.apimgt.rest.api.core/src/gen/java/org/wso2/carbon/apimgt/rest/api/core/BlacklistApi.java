...
public class BlacklistApi implements Microservice {
    ...
    @io.swagger.annotations.ApiOperation(value = "Get all blocking condtions", notes = "Get all blocking condtions ",
            response = BlockingConditionListDTO.class, tags = {"Blacklist",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200, message = "OK. Blocking conditions returned ", response =
                    BlockingConditionListDTO.class)})
    public Response blacklistGet(@ApiParam(value = "Media types acceptable for the response. Default is " +
            "application/json. ", defaultValue = "application/json") @HeaderParam("Accept") String accept
