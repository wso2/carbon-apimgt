...
public interface SubscriptionsApiService {
      public Response subscriptionsGet(String apiId, String applicationId, String apiType, String groupId, Integer offset, Integer limit, String ifNoneMatch, MessageContext messageContext);
