...
public class AdditionalSubscriptionInfoListDTO   {
    ...
    private List<AdditionalSubscriptionInfoDTO> list = new ArrayList<AdditionalSubscriptionInfoDTO>();
  ...
  /**
   **/
  public AdditionalSubscriptionInfoListDTO list(List<AdditionalSubscriptionInfoDTO> list) {
    this.list = list;
    return this;
  }
  ...
  public void setList(List<AdditionalSubscriptionInfoDTO> list) {
    this.list = list;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(count, additionalSubscriptionInfoList.count) &&
        Objects.equals(list, additionalSubscriptionInfoList.list) &&
