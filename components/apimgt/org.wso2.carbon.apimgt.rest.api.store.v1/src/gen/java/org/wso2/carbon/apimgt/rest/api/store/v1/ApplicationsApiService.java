...
public interface ApplicationsApiService {
      ...
      public Response applicationsApplicationIdOauthKeysGet(String applicationId, String organizationId, MessageContext messageContext) throws APIManagementException;
      ...
      public Response applicationsApplicationIdOauthKeysKeyMappingIdGenerateTokenPost(String applicationId, String keyMappingId, ApplicationTokenGenerateRequestDTO applicationTokenGenerateRequestDTO, String organizationId, String ifMatch, MessageContext messageContext) throws APIManagementException;
