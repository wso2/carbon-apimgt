...
public interface ApplicationsApiService {
      ...
      public Response deleteConsumerSecret(String applicationId, String keyMappingId, String secretId, MessageContext messageContext) throws APIManagementException;
