...
public interface ApplicationsApiService {
      ...
      public Response applicationsExportGet(String appName, String appOwner, Boolean withKeys, String format, Boolean all, String xWSO2Tenant, MessageContext messageContext) throws APIManagementException;
