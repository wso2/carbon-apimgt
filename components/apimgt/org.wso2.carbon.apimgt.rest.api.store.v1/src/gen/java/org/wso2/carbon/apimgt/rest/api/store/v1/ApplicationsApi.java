...
ApplicationsApiService delegate = new ApplicationsApiServiceImpl();
    ...
    @GET
    @Path("/{applicationId}/client-certificates/{UUID}/content")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    public Response applicationsApplicationIdClientCertificatesUUIDContentGet(@ApiParam(value = "Application Identifier consisting of the UUID of the Application. ",required=true) @PathParam("applicationId") String applicationId, @ApiParam(value = "",required=true) @PathParam("UUID") String UUID) throws APIManagementException{
        return delegate.applicationsApplicationIdClientCertificatesUUIDContentGet(applicationId, UUID, securityContext);
    }

    @DELETE
    @Path("/{applicationId}/client-certificates/{UUID}")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    public Response applicationsApplicationIdClientCertificatesUUIDDelete(@ApiParam(value = "The UUID of the certificate that should be deleted. ",required=true) @PathParam("UUID") String UUID, @ApiParam(value = "Application Identifier consisting of the UUID of the Application. ",required=true) @PathParam("applicationId") String applicationId) throws APIManagementException{
        return delegate.applicationsApplicationIdClientCertificatesUUIDDelete(UUID, applicationId, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    public Response applicationsApplicationIdClientCertificatesUUIDGet(@ApiParam(value = "",required=true) @PathParam("UUID") String UUID, @ApiParam(value = "Application Identifier consisting of the UUID of the Application. ",required=true) @PathParam("applicationId") String applicationId) throws APIManagementException{
        return delegate.applicationsApplicationIdClientCertificatesUUIDGet(UUID, applicationId, securityContext);
    }
