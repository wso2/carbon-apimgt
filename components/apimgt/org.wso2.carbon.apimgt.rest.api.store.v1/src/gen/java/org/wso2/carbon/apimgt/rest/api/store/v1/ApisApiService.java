...
public interface ApisApiService {
      public Response addCommentToAPI(String apiId, PostRequestBodyDTO postRequestBodyDTO, String organizationId, String replyTo, MessageContext messageContext) throws APIManagementException;
