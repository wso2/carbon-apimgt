...
public interface ApisApiService {
      ...
      public Response getAllCommentsOfAPI(String apiId, String xWSO2Tenant, Integer limit, Integer offset, Boolean commenterInfo, MessageContext messageContext) throws APIManagementException;
