...
ApiCategoriesApiService delegate = new ApiCategoriesApiServiceImpl();
    ...
    public Response apiCategoriesGet( @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId) throws APIManagementException{
        return delegate.apiCategoriesGet(organizationId, securityContext);
    }
}
