    ...
    public Response topicsSubscriptionsGet(String applicationId, String apiId, String xWSO2Tenant, MessageContext messageContext) throws APIManagementException {
        ...
        if (StringUtils.isNotEmpty(applicationId)) {
            ...
            try {
                ...
                if (apiTypeWrapper.isAPIProduct()) {
                    subscriptionSet = apiConsumer.getTopicSubscriptions(applicationId, apiTypeWrapper.getApiProduct().getUuid());
                } else {
                    subscriptionSet = apiConsumer.getTopicSubscriptions(applicationId, apiTypeWrapper.getApi().getUuid());
                }
