...
public class APIStoreImplTestCase {
    ...
    public void searchAPIs() throws APIManagementException {
        ...
        APIStore apiStore = new APIStoreImpl(USER_NAME, apiDAO, null, null, null, null, null, null, null, null);
    ...
    public void testGetApplicationByName() throws APIManagementException {
        ...
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, applicationDAO, null, null, null, null, null, null, null);
...
/*        Application application = new Application("TestApp", USER_ID);
    ...
    public void testGetAllTags() throws APIManagementException {
        ...
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, null, null, null, tagDAO, null, null, null, null);
        apiStore.getAllTags();
    ...
    public void testGetPolicies() throws APIManagementException {
        PolicyDAO policyDAO = Mockito.mock(PolicyDAO.class);
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, null, null, policyDAO, null, null, null, null, null);
    ...
    public void testGetLabelInfo() throws APIManagementException {
        ...
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, null, null, null, null, labelDAO, null, null, null);
    ...
    public void testAddApplicationCreationException() throws APIManagementException {
        ...
        PolicyDAO policyDAO = Mockito.mock(PolicyDAO.class);
        Policy policy = Mockito.mock(Policy.class);
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, applicationDAO, null, policyDAO, null, null, null, null,
                null);
        Application application = new Application(APP_NAME, USER_NAME);
        application.setTier(TIER);
        Mockito.when(applicationDAO.isApplicationNameExists(APP_NAME)).thenReturn(false);
    ...
    public void testCompleteWorkflowWithoutValidWokflowObj() throws Exception {
        ...
        APIStore apiStore = new APIStoreImpl(USER_NAME, null, null, null, null, null, null, null, null, null);
    ...
    public void testObserverRegistration() throws APIManagementException {
        ...
        APIStoreImpl apiStore = new APIStoreImpl(USER_NAME, null, null, null, null, null, null, null, null, null);
