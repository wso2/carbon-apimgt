 ...
 * Current supported Container Management System
 */
public interface ContainerBasedGatewayGenerator {
    ...
    void createContainerBasedService(String gatewayServiceTemplate, String apiId, String serviceName, String namespace,
                                     String label) throws GatewayException, IOException;
     ...
     * @throws GatewayException   If there is a failure to update API in gateway
      */
     void removeContainerBasedGateway(String label, String apiId, String namespace) throws GatewayException;
     ...
     */
    void createContainerGateway(String apiId, String label) throws GatewayException;
     ...
     */
    String getServiceAccountAccessToken() throws GatewayException;
