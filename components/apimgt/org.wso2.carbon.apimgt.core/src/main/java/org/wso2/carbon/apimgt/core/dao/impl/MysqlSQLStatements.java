...
public class MysqlSQLStatements implements ApiDAOVendorSpecificStatements {
    ...
    private static final String API_FULL_TEXT_SEARCH = "MATCH (`NAME`,`PROVIDER`,`CONTEXT`,`VERSION`,`DESCRIPTION`," +
            "`CURRENT_LC_STATUS`,`TECHNICAL_OWNER`,`BUSINESS_OWNER`) AGAINST (? IN BOOLEAN MODE)";
