...
/**
 * This class holds the constants related to workflow
 */
public class WorkflowConstants {
    ...
    public static final String CREATE_SUBSCRIPTION_WS_ACTION =
            "http://workflow.subscription.apimgt.carbon.wso2" + ".org/initiate";

    public static final String CREATE_APPLICATION_WS_ACTION =
            "http://workflow.application.apimgt.carbon.wso2" + ".org/initiate";

    public static final String CREATE_REGISTRATION_WS_ACTION =
            "http://workflow.application.apimgt.carbon.wso2" + ".org/initiate";

    public static final String DELETE_SUBSCRIPTION_WS_ACTION =
            "http://workflow.subscription.apimgt.carbon.wso2" + ".org/cancel";

    public static final String DELETE_APPLICATION_WS_ACTION =
            "http://workflow.application.apimgt.carbon.wso2" + ".org/cancel";

    public static final String DELETE_REGISTRATION_WS_ACTION =
            "http://workflow.application.apimgt.carbon.wso2" + ".org/cancel";
    ...
    /**
     * This class holds the payload constants.
     */
