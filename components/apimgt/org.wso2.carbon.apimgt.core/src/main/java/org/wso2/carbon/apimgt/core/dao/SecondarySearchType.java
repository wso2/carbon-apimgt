...
public enum SecondarySearchType {
    ...
    static { // Initialize map from constant name to enum constant
        for (SecondarySearchType searchType : values()) {
            stringToEnum.put(searchType.toString(), searchType);
        }
    }

    // Returns SecondarySearchType for string, or null if string is invalid
    @CheckForNull
    public static SecondarySearchType fromString(String symbol) {
