 ...
 */
public class APISearchDaoH2Impl implements ApiSearchDAO {

    private static final Logger log = LoggerFactory.getLogger(APISearchDaoH2Impl.class);
    ...
    public List<API> searchAPIs(String searchString) throws APIMgtDAOException {
        ...
        final String query = "SELECT T.* FROM FTL_SEARCH_DATA (?, 0, 0) FT, AM_API T "
                + "WHERE FT.TABLE='AM_API' AND T.UUID=FT.KEYS[0]";
//        final String query = "SELECT T.* FROM FullTextLucene.searchData (?, 0, 0) FTL, AM_API T WHERE FT"
//                + ".TABLE='AM_API'";
