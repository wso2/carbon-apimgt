...
/**
 * This is a simple work flow extension for api state change process
 */
public class APIStateChangeSimpleWorkflowExecutor implements WorkflowExecutor {
    ...
    public WorkflowResponse complete(Workflow workFlow) throws WorkflowException {
        if (log.isDebugEnabled()) {
            log.debug("Complete API state change Workflow..");
        }
