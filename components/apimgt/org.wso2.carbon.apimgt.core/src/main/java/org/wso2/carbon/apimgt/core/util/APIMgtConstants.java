...
public class APIMgtConstants {
    ...
    public static class WorkflowConstants {
        ...
        public static final String ATTRIBUTE_HAS_OWN_GATEWAY = "hasOwnGateway";
        ...
        public static final String ATTRIBUTE_API_NAME = "apiName";
        public static final String ATTRIBUTE_API_AUTOGEN_LABEL = "autoGeneratedLabel";
        public static final String ATTRIBUTE_API_HAS_OWN_GATEWAY = "hasOwnGateway";
