...
public class ZipkinTracerImpl implements OpenTracer {
    ...
    public Tracer getTracer(String tracerName, APIManagerConfiguration configuration, String serviceName) {
        ...
        String apiContext = configuration.getFirstProperty(Constants.DEFAULT_API_CONTEXT) != null ?
                configuration.getFirstProperty(Constants.DEFAULT_API_CONTEXT) : Constants.DEFAULT_API_CONTEXT;
