...
public class ApplicationsApi  {
   ...
   private final ApplicationsApiService delegate = ApplicationsApiServiceFactory.getApplicationsApi();
    ...
    public Response applicationsApplicationIdGet(@ApiParam(value = "Media types acceptable for the response. Should denote XML or JSON, default is JSON."  )@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-None-Match") String ifNoneMatch,
    ...
    throws NotFoundException {
    return delegate.applicationsApplicationIdGet(accept,ifNoneMatch,ifModifiedSince);
    }
    @PUT
    @Path("/{applicationId}")
    ...
    public Response applicationsApplicationIdPut(@ApiParam(value = "Application object that needs to be updated" ,required=true ) Application body,
    @ApiParam(value = "Media type of the entity in the request body. Should denote XML or JSON, default is JSON."  )@HeaderParam("Content-Type") String contentType,
    @ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-Match") String ifMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header."  )@HeaderParam("If-Unmodified-Since") String ifUnmodifiedSince)
    throws NotFoundException {
    return delegate.applicationsApplicationIdPut(body,contentType,ifMatch,ifUnmodifiedSince);
    }
    @DELETE
    @Path("/{applicationId}")
    ...
    public Response applicationsApplicationIdDelete(@ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-Match") String ifMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header."  )@HeaderParam("If-Unmodified-Since") String ifUnmodifiedSince)
    throws NotFoundException {
    return delegate.applicationsApplicationIdDelete(ifMatch,ifUnmodifiedSince);
    }
    @POST
