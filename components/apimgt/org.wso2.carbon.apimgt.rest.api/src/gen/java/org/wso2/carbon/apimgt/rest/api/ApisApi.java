...
public class ApisApi  {
   ...
   private final ApisApiService delegate = ApisApiServiceFactory.getApisApi();
    ...
    public Response apisApiIdDocumentsGet(@ApiParam(value = "Maximum size of API array to return.",required=true) @QueryParam("limit") String limit,
    @ApiParam(value = "Starting point of the item list.",required=true) @QueryParam("offset") String offset,
    @ApiParam(value = "Search condition.") @QueryParam("query") String query,
    @ApiParam(value = "Media types acceptable for the response. Should denote XML or JSON, default is JSON."  )@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-None-Match") String ifNoneMatch)
    throws NotFoundException {
    return delegate.apisApiIdDocumentsGet(limit,offset,query,accept,ifNoneMatch);
    }
    @POST
    @Path("/{apiId}/documents")
    ...
    public Response apisApiIdDocumentsPost(@ApiParam(value = "Document object that needs to be added" ,required=true ) Document body,
    @ApiParam(value = "Media type of the entity in the request body. Should denote XML or JSON, default is JSON."  )@HeaderParam("Content-Type") String contentType)
    throws NotFoundException {
    return delegate.apisApiIdDocumentsPost(body,contentType);
    }
    @GET
    ...
    public Response apisApiIdDocumentsDocumentIdGet(@ApiParam(value = "Media types acceptable for the response. Should denote XML or JSON, default is JSON."  )@HeaderParam("Accept") String accept,
    @ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-None-Match") String ifNoneMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header."  )@HeaderParam("If-Modified-Since") String ifModifiedSince)
    throws NotFoundException {
    return delegate.apisApiIdDocumentsDocumentIdGet(accept,ifNoneMatch,ifModifiedSince);
    }
    @PUT
    @Path("/{apiId}/documents/{documentId}")
    ...
    public Response apisApiIdDocumentsDocumentIdPut(@ApiParam(value = "Document object that needs to be added" ,required=true ) Document body,
    @ApiParam(value = "Media type of the entity in the request body. Should denote XML or JSON, default is JSON."  )@HeaderParam("Content-Type") String contentType,
    @ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-Match") String ifMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header."  )@HeaderParam("If-Unmodified-Since") String ifUnmodifiedSince)
    throws NotFoundException {
    return delegate.apisApiIdDocumentsDocumentIdPut(body,contentType,ifMatch,ifUnmodifiedSince);
    }
    @DELETE
    @Path("/{apiId}/documents/{documentId}")
    ...
    public Response apisApiIdDocumentsDocumentIdDelete(@ApiParam(value = "Validator for conditional requests; based on ETag."  )@HeaderParam("If-Match") String ifMatch,
    @ApiParam(value = "Validator for conditional requests; based on Last Modified header."  )@HeaderParam("If-Unmodified-Since") String ifUnmodifiedSince)
    throws NotFoundException {
    return delegate.apisApiIdDocumentsDocumentIdDelete(ifMatch,ifUnmodifiedSince);
    }
}
