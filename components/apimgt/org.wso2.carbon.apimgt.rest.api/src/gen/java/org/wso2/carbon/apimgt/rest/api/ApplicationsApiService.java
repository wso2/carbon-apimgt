...
public abstract class ApplicationsApiService {
      ...
      public abstract Response applicationsApplicationIdGet(String accept,String ifNoneMatch,String ifModifiedSince)
      throws NotFoundException;
  
      public abstract Response applicationsApplicationIdPut(Application body,String contentType,String ifMatch,String ifUnmodifiedSince)
      throws NotFoundException;
  
      public abstract Response applicationsApplicationIdDelete(String ifMatch,String ifUnmodifiedSince)
      throws NotFoundException;
