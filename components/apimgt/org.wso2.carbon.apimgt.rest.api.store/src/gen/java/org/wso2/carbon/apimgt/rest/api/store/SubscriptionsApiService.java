...
public abstract class SubscriptionsApiService {
    ...
    public abstract Response subscriptionsMultiplePost(List<SubscriptionDTO> body,String contentType);
    ...
    public abstract String subscriptionsMultiplePostGetLastUpdatedTime(List<SubscriptionDTO> body,String contentType);
