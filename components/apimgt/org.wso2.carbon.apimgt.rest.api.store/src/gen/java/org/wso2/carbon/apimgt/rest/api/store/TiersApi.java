...
public class TiersApi  {
   ...
   private final TiersApiService delegate = TiersApiServiceFactory.getTiersApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get available tiers", notes = "Get available tiers", response = TierListDTO.class, responseContainer = "List")
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get tier details", notes = "Get tier details", response = TierDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nTier returned"),
