...
public abstract class ApplicationsApiService {
    public abstract Response applicationsGet(String subscriber,String groupId,Integer limit,Integer offset,String accept,String ifNoneMatch);
    public abstract Response applicationsPost(ApplicationDTO body,String contentType);
    public abstract Response applicationsGenerateKeysPost(String applicationId,String contentType,ApplicationKeyGenerateRequestDTO body,String ifMatch,String ifUnmodifiedSince);
