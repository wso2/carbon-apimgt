...
public class TagsApi  {
   ...
   private final TagsApiService delegate = TagsApiServiceFactory.getTagsApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get a list of tags that are already added to APIs", notes = "Get a list of tags that are already added to APIs", response = TagListDTO.class)
