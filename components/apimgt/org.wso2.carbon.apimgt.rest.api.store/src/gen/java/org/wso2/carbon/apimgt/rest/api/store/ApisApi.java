...
public class ApisApi  {
   ...
   private final ApisApiService delegate = ApisApiServiceFactory.getApisApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get Details of API", notes = "Get details of an API", response = APIDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get a list of documents belonging to an API.", notes = "Get a list of documents belonging to an API.", response = DocumentListDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get a particular document associated with an API.", notes = "Get a particular document associated with an API.", response = DocumentDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nDocument returned."),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Downloads a FILE type document/get the inline content or source url of a certain document.", notes = "Downloads a FILE type document/get the inline content or source url of a certain document.", response = Void.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get the swagger of an API", notes = "Get the swagger of an API", response = Void.class)
    @io.swagger.annotations.ApiResponses(value = { 
