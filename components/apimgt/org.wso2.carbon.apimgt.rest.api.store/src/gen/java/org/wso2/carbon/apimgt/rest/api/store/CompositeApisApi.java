...
public class CompositeApisApi implements Microservice  {
   private final CompositeApisApiService delegate = CompositeApisApiServiceFactory.getCompositeApisApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Delete a Composite API", notes = "This operation can be used to delete an existing Composite API proving the Id of the Composite API. ", response = void.class, tags={ "CompositeAPI (Individual)", })
...
, @Context Request request)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get details of a Composite API", notes = "Using this operation, you can retrieve complete details of a single Composite API. You need to provide the Id of the Composite API to retrive it. ", response = CompositeAPIDTO.class, tags={ "CompositeAPI (Individual)", })
    @io.swagger.annotations.ApiResponses(value = { 
...
, @Context Request request)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update a Composite API", notes = "This operation can be used to update an existing Composite API. But the properties `name`, `version`, `context`, `provider`, `state` will not be changed by this operation. ", response = CompositeAPIDTO.class, tags={ "CompositeAPI (Individual)", })
    @io.swagger.annotations.ApiResponses(value = { 
...
, @Context Request request)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get swagger definition", notes = "This operation can be used to retrieve the swagger definition of a Composite API. ", response = void.class, tags={ "CompositeAPI (Individual)", })
    @io.swagger.annotations.ApiResponses(value = { 
...
, @Context Request request)
    throws NotFoundException {
        return delegate.compositeApisApiIdSwaggerGet(apiId,accept,ifNoneMatch,ifModifiedSince, request);
    }
    @PUT
    @Path("/{apiId}/swagger")
    @Consumes({ "multipart/form-data" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update swagger definition", notes = "This operation can be used to update the swagger definition of an existing Composite API. Swagger definition to be updated is passed as a form data parameter `apiDefinition`. ", response = void.class, tags={ "CompositeAPI (Individual)", })
    @io.swagger.annotations.ApiResponses(value = { 
...
, @Context Request request)
    throws NotFoundException {
        return delegate.compositeApisApiIdSwaggerPut(apiId,apiDefinition,contentType,ifMatch,ifUnmodifiedSince, request);
    }
    @GET
    
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Retrieve/Search Composite APIs ", notes = "This operation provides you a list of available Composite APIs qualifying under a given search condition.  Each retrieved Composite API is represented with a minimal amount of attributes. If you want to get complete details of a Composite API, you need to use **Get details of a Composite API** operation. ", response = CompositeAPIListDTO.class, tags={ "CompositeAPI (Collection)", })
    @io.swagger.annotations.ApiResponses(value = { 
