...
OperationPolicyApiService delegate = new OperationPolicyApiServiceImpl();
    ...
    public Response addCommonOperationPolicy( @Multipart(value = "policySpecFile", required = false) InputStream policySpecFileInputStream, @Multipart(value = "policySpecFile" , required = false) Attachment policySpecFileDetail,  @Multipart(value = "policyDefinitionFile", required = false) InputStream policyDefinitionFileInputStream, @Multipart(value = "policyDefinitionFile" , required = false) Attachment policyDefinitionFileDetail) throws APIManagementException{
        return delegate.addCommonOperationPolicy(policySpecFileInputStream, policySpecFileDetail, policyDefinitionFileInputStream, policyDefinitionFileDetail, securityContext);
    }
