...
EndpointCertificatesApiService delegate = new EndpointCertificatesApiServiceImpl();
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Internal Server Error ", response = ErrorDTO.class) })
    public Response endpointCertificatesGet( @ApiParam(value = "Maximum size of resource array to return. ", defaultValue="80") @DefaultValue("80") @QueryParam("limit") Integer limit,  @ApiParam(value = "Starting point within the complete list of items qualified. ", defaultValue="0") @DefaultValue("0") @QueryParam("offset") Integer offset,  @ApiParam(value = "Alias for the certificate")  @QueryParam("alias") String alias,  @ApiParam(value = "Endpoint of which the certificate is uploaded")  @QueryParam("endpoint") String endpoint) throws APIManagementException{
