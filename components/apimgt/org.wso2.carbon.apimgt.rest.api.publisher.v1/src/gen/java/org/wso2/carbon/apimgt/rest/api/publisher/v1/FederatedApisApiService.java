...
public interface FederatedApisApiService {
      ...
      public Response importFederatedAPIs(String environment, List<FederatedAPIImportRequestDTO> requestBody, MessageContext messageContext) throws APIManagementException;
      public Response updateFederatedAPIs(String environment, List<FederatedAPIImportRequestDTO> requestBody, MessageContext messageContext) throws APIManagementException;
}
