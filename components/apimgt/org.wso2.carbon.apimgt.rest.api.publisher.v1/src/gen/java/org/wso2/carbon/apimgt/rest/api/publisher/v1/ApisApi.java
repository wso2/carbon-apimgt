...
ApisApiService delegate = new ApisApiServiceImpl();
    ...
    public Response apisApiIdAsyncapiGet(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. ",required=true) @PathParam("apiId") String apiId,  @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId,  @ApiParam(value = "Validator for conditional requests; based on the ETag of the formerly retrieved variant of the resource. " )@HeaderParam("If-None-Match") String ifNoneMatch) throws APIManagementException{
        return delegate.apisApiIdAsyncapiGet(apiId, organizationId, ifNoneMatch, securityContext);
    }
    ...
    public Response apisApiIdAsyncapiPut(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. ",required=true) @PathParam("apiId") String apiId,  @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId,  @ApiParam(value = "Validator for conditional requests; based on ETag. " )@HeaderParam("If-Match") String ifMatch, @Multipart(value = "apiDefinition", required = false)  String apiDefinition, @Multipart(value = "url", required = false)  String url,  @Multipart(value = "file", required = false) InputStream fileInputStream, @Multipart(value = "file" , required = false) Attachment fileDetail) throws APIManagementException{
        return delegate.apisApiIdAsyncapiPut(apiId, organizationId, ifMatch, apiDefinition, url, fileInputStream, fileDetail, securityContext);
    }
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve API Quota ", notes = "This operation returns whether an organizations API quota is throttled or not. ", response = ApiQuotaResponseDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:api_view", description = "View API")
        })
    }, tags={ "Rate-limiting",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK. API Quota state is returned. ", response = ApiQuotaResponseDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    public Response getAPIQuota( @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId) throws APIManagementException{
        return delegate.getAPIQuota(organizationId, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden. The request must be conditional but no condition has been specified.", response = ErrorDTO.class),
        @ApiResponse(code = 415, message = "Unsupported Media Type. The entity of the request was not in a supported format.", response = ErrorDTO.class) })
    public Response importOpenAPIDefinition( @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId,  @ApiParam(value = "Decides whether we need to include the scopes in the swagger deifnition. ", defaultValue="true") @DefaultValue("true") @QueryParam("importScopes") Boolean importScopes,  @Multipart(value = "file", required = false) InputStream fileInputStream, @Multipart(value = "file" , required = false) Attachment fileDetail, @Multipart(value = "url", required = false)  String url, @Multipart(value = "additionalProperties", required = false)  String additionalProperties, @Multipart(value = "inlineAPIDefinition", required = false)  String inlineAPIDefinition) throws APIManagementException{
        return delegate.importOpenAPIDefinition(organizationId, importScopes, fileInputStream, fileDetail, url, additionalProperties, inlineAPIDefinition, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class),
        @ApiResponse(code = 412, message = "Precondition Failed. The request has not been performed because one of the preconditions is not met.", response = ErrorDTO.class) })
    public Response updateAPISwagger(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. ",required=true) @PathParam("apiId") String apiId,  @ApiParam(value = "The Organization which the API belongs to. ")  @QueryParam("organizationId") String organizationId,  @ApiParam(value = "Validator for conditional requests; based on ETag. " )@HeaderParam("If-Match") String ifMatch,  @ApiParam(value = "Decides whether we need to include the scopes in the swagger deifnition. ", defaultValue="true") @DefaultValue("true") @QueryParam("importScopes") Boolean importScopes, @Multipart(value = "apiDefinition", required = false)  String apiDefinition, @Multipart(value = "url", required = false)  String url,  @Multipart(value = "file", required = false) InputStream fileInputStream, @Multipart(value = "file" , required = false) Attachment fileDetail) throws APIManagementException{
        return delegate.updateAPISwagger(apiId, organizationId, ifMatch, importScopes, apiDefinition, url, fileInputStream, fileDetail, securityContext);
    }
