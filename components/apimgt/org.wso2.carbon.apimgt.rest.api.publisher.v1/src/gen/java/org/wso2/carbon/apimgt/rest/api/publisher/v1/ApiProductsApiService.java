...
public abstract class ApiProductsApiService {
    ...
    public abstract Response apiProductsApiProductIdPut(String apiProductId,APIProductDetailedDTO body,String ifMatch);
    ...
    public abstract Response apiProductsPost(APIProductDetailedDTO body);
}
