...
public interface ApiProductsApiService {
      ...
      public Response apiProductsGet(String organizationId, Integer limit, Integer offset, String query, String accept, String ifNoneMatch, MessageContext messageContext) throws APIManagementException;
