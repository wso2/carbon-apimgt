...
ApiArtifactApiService delegate = new ApiArtifactApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Get API artifact from the storage", notes = "This operation is used to get the local entries, sequences and endpoints from the storage. ", response = APIArtifactDTO.class, authorizations = {
