...
ApiArtifactApiService delegate = new ApiArtifactApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Get API artifact from the storage", notes = "This operation is used to get the local entries, sequences and endpoints from the storage. If the Tenant domain is not provided carbon.super will be picked as the Tenant domain. ", response = APIArtifactDTO.class, authorizations = {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 202, message = "Accepted. The request has been accepted. ", response = APIArtifactDTO.class),
    ...
    public Response apiArtifactGet(     @NotNull 
        @ApiParam(value = "Name of the API ",required=true)  @QueryParam("apiName") String apiName
,      @NotNull 
        @ApiParam(value = "version of the API ",required=true)  @QueryParam("version") String version
,      
        @ApiParam(value = "Tenant Domain of the API ")  @QueryParam("tenantDomain") String tenantDomain
