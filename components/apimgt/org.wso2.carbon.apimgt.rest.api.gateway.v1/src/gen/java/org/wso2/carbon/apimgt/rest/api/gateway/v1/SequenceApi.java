...
SequenceApiService delegate = new SequenceApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Get sequences from the storage", notes = "This operation is used to get the API sequence from the storage ", response = SequencesDTO.class, authorizations = {
