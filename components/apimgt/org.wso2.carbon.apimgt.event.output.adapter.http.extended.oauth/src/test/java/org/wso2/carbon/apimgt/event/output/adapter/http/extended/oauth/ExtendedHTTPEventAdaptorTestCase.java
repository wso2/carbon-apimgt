...
public class ExtendedHTTPEventAdaptorTestCase {
    ...
    public void testHttpPublisherFactory() {
        ...
        property = new Property("oauth.url");
        property.setRequired(false);
        property.setSecured(false);
        property.setEncrypted(false);
        property.setDisplayName("OAuth 2 authentication endpoint URL");
        property.setDefaultValue(null);
        property.setOptions(null);
        property.setHint("The OAuth 2 authentication endpoint URL, e.g. \"http://yourhost:8080/token\"");
        propertyList.add(property);

        property = new Property("oauth.consumer.key");
        property.setRequired(false);
        property.setSecured(true);
        property.setEncrypted(true);
        property.setDisplayName("Consumer Key");
        property.setDefaultValue(null);
        property.setOptions(null);
        property.setHint("HTTP OAuth2 consumer Key");
        propertyList.add(property);

        property = new Property("oauth.consumer.secret");
        property.setRequired(false);
        property.setSecured(true);
        property.setEncrypted(true);
        property.setDisplayName("Consumer Secret");
        property.setDefaultValue(null);
        property.setOptions(null);
        property.setHint("HTTP OAuth2 consumer Secret");
        propertyList.add(property);
        ...
        Assert.assertEquals(7, dyPropertyList.size());
        int i = 0;
