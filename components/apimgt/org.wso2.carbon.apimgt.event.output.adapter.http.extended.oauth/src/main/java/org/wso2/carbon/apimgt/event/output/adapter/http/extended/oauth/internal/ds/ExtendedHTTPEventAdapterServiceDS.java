...
import org.wso2.carbon.apimgt.event.output.adapter.http.extended.oauth.AccessTokenGeneratorImpl;
...
public class ExtendedHTTPEventAdapterServiceDS {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            bundleContext.registerService(AccessTokenGenerator.class,
                    AccessTokenGeneratorImpl.getInstance(), null);
