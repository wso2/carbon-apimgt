...
public class RegistryPersistenceImpl implements APIPersistence {
    ...
    public PublisherAPI updateAPI(Organization org, PublisherAPI publisherAPI) throws APIPersistenceException {
        ...
        try {
            ...
            String originalProvider = RegistryPersistenceUtil.extractProvider(artifactPath,
    ...
    public void deleteAPI(Organization org, String apiId) throws APIPersistenceException {
        ...
        try {
            ...
            String providerName = RegistryPersistenceUtil.extractProvider(artifactRegistryPath,
    ...
    public Documentation updateDocumentation(Organization org, String apiId, Documentation documentation)
        ...
        try {
            ...
            String apiName = apiArtifact.getAttribute(APIConstants.API_OVERVIEW_NAME);
            String apiVersion = apiArtifact.getAttribute(APIConstants.API_OVERVIEW_VERSION);
            String originalApiProviderName = RegistryPersistenceUtil.extractProvider(apiArtifact.getPath(),
                    apiName);
    ...
    public ResourceFile getThumbnail(Organization org, String apiId) throws ThumbnailPersistenceException {
        ...
        try {
            ...
            String apiSourcePath = RegistryPersistenceUtil.extractApiSourcePath(apiArtifact.getPath());
            String originalProvider = RegistryPersistenceUtil.extractProvider(apiArtifact.getPath(),
                    apiName);
    ...
    private BasicAPI getbasicAPIInfo(String uuid, Registry registry)
        ...
        api.originalProvider = RegistryPersistenceUtil.extractProvider(artifactPath, api.apiName);
    ...
    public void deleteAPIProduct(Organization org, String apiId) throws APIPersistenceException {
        ...
        try {
            ...
            // This avoids false matches when the product name appears in the provider
            // (e.g., secondary userstore: WSO2.COM/admin with product named "admin").
            String nameVersionSegment = RegistryConstants.PATH_SEPARATOR + identifier.getName()
                    + RegistryConstants.PATH_SEPARATOR + identifier.getVersion();
            String productProviderPath = apiSourcePath.substring(0,
                    apiSourcePath.lastIndexOf(nameVersionSegment));
