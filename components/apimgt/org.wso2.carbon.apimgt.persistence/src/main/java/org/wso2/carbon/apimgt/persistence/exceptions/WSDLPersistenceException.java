 ...
 */
public class WSDLPersistenceException extends Exception {
    ...
    public WSDLPersistenceException(String msg) {
        super(msg);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }

    public WSDLPersistenceException(String msg, Throwable e) {
        super(msg, e);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }

    public WSDLPersistenceException(Throwable throwable) {
        super(throwable);
        this.errorHandler = ExceptionCodes.INTERNAL_ERROR;
    }
     ...
     */
    public WSDLPersistenceException(String message, ErrorHandler code) {
        super(message);
     ...
     * @param code Exception code that need to pass to the error DTO
     */
    public WSDLPersistenceException(ErrorHandler code) {
     ...
     * @param code Exception code that need to pass to the error DTO
     */
    public WSDLPersistenceException(String message, Throwable cause, ErrorHandler code) {
        super(message, cause);
        this.errorHandler = code;
    }
}
