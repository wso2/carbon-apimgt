...
public class SQLConstants {
    ...
    public static String SEARCH_CONTENT_BY_CONTENT_SQL(String[] roles) {
        ...
        for (String role : roles) {
            ...
            roleCondition.append("',' || JSON_VALUE(a2.METADATA, '$.accessControlRoles') || ',' LIKE '%,").append(role.toLowerCase()).append(",%'");
        }
        roleCondition.append(" OR JSON_VALUE(a2.METADATA, '$.accessControl') = 'all' ");
