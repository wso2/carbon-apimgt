...
RedeployApiApiService delegate = new RedeployApiApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Re Deploy the API in the gateway", notes = "This operation is used to re deploy an API in the gateway. If the Tenant domain is not provided carbon.super will be picked as the Tenant domain. ", response = DeployResponseDTO.class, tags={ "Deploy API" })
    @ApiResponses(value = { 
