...
public interface SubscriptionsApiService {
      public Response getSubscriptions(String apiUUID, String applicationUUID, String tenantDomain, MessageContext messageContext) throws APIManagementException;
}
