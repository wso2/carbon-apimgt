...
NotifyGatewayApiService delegate = new NotifyGatewayApiServiceImpl();
    ...
    @ApiOperation(value = "Gateway Register or Heartbeat", notes = "Accepts a payload indicating either a gateway registration or a heartbeat update. The `payloadType` field distinguishes the operation. ", response = NotifyGatewayStatusResponseDTO.class, tags={ "Gateway Lifecycle" })
    @ApiResponses(value = { 
