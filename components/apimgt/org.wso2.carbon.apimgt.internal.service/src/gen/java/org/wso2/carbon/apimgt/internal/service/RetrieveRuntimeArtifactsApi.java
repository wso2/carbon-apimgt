...
RetrieveRuntimeArtifactsApiService delegate = new RetrieveRuntimeArtifactsApiServiceImpl();
    ...
    public Response retrieveRuntimeArtifactsGet( @NotNull @ApiParam(value = "**Search condition**.  type of gateway ",required=true)  @QueryParam("type") String type,  @NotNull @ApiParam(value = "**Search condition**.  Data-plane ID ",required=true)  @QueryParam("dataPlaneId") String dataPlaneId,  @ApiParam(value = "**Search condition**.   Gateway Accessibility type denotes whether the gateway environment is internal or external ")  @QueryParam("gatewayAccessibilityType") String gatewayAccessibilityType,  @ApiParam(value = "Whether to include system org API artifacts ")  @QueryParam("isIncludeSystemOrganizationArtifacts") Boolean isIncludeSystemOrganizationArtifacts) throws APIManagementException{
        return delegate.retrieveRuntimeArtifactsGet(type, dataPlaneId, gatewayAccessibilityType, isIncludeSystemOrganizationArtifacts, securityContext);
    }
