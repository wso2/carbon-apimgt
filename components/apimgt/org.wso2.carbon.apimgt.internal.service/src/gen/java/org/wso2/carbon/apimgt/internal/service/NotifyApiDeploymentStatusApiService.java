...
public interface NotifyApiDeploymentStatusApiService {
      public Response notifyApiDeploymentStatusPost(GatewayDeploymentStatusAcknowledgmentListDTO gatewayDeploymentStatusAcknowledgmentListDTO, MessageContext messageContext) throws APIManagementException;
}
