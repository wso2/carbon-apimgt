...
ThrottleApiService delegate = new ThrottleApiServiceImpl();
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "throttled events available", notes = "This will provide access to throttled events in database. ", response = ThrottledEventDTO.class, responseContainer = "List", tags={ "Throttling" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "An array of Throttle Events", response = ThrottledEventDTO.class, responseContainer = "List"),
