    ...
    public static ApplicationPolicyListDTO fromApplicationPolicyToApplicationPolicyListDTO(List<ApplicationPolicy> model) {
        ...
        if (model != null) {
            for (ApplicationPolicy applicationPolicyModel : model) {
                ...
                applicationPolicyDTO.setRateLimitCount(applicationPolicyModel.getRateLimitCount());
                applicationPolicyDTO.setRateLimitTimeUnit(applicationPolicyModel.getRateLimitTimeUnit());
