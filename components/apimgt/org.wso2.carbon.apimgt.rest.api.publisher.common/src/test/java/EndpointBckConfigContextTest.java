...
import org.wso2.carbon.apimgt.rest.api.publisher.common.template.EndpointBckConfigContext;
...
public class EndpointBckConfigContextTest {
    ...
    public void testEndpointBckConfigContext() throws Exception {
        ...
        String endpointConfig = "{\"production_endpoints\":{\"url\":\"" + api.getUrl() + "\", \"config\":null}," +
