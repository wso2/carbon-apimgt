...
public class ContentPublishStatusResponseDTO   {
  ...
  @ApiModelProperty(value = "UUID of the api-theme")
  @JsonProperty("id")
  public String getId() {
    return id;
  }
  ...
  /**
   * Publish status of the api-theme
   **/
  ...
  @ApiModelProperty(value = "Publish status of the api-theme")
