...
CREATE TABLE IF NOT EXISTS GOV_POLICY_APPLICABLE_STATE (
...
CREATE TABLE IF NOT EXISTS GOV_POLICY_ACTION (
    ...
    FOREIGN KEY (POLICY_ID) REFERENCES GOV_POLICY(POLICY_ID) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (POLICY_ID, STATE) REFERENCES GOV_POLICY_APPLICABLE_STATE(POLICY_ID, STATE) ON UPDATE CASCADE ON DELETE CASCADE,
