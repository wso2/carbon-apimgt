...
public class SQLConstants {
    ...
    public static final String CREATE_RULESET =
            "INSERT INTO GOV_RULESET (RULESET_ID, NAME, DESCRIPTION, " +
                    "RULESET_CONTENT, RULE_TYPE, ARTIFACT_TYPE, " +
    ...
    public static final String GET_RULESETS_BY_ID =
            "SELECT RULESET_ID, NAME, DESCRIPTION, RULESET_CONTENT, RULE_TYPE, ARTIFACT_TYPE, DOCUMENTATION_LINK, " +
    ...
    public static final String UPDATE_RULESET =
            "UPDATE GOV_RULESET SET NAME = ?, DESCRIPTION = ?, RULESET_CONTENT = ?, RULE_TYPE = ?, ARTIFACT_TYPE = " +
    ...
    public static final String CREATE_GOVERNANCE_POLICY_STATE_MAPPING =
            "INSERT INTO GOV_POLICY_APPLICABLE_STATE (POLICY_STATE_ID, POLICY_ID, STATE) VALUES (?, ?, ?)";
    ...
    public static final String DELETE_GOVERNANCE_POLICY_STATE_MAPPING =
            "DELETE FROM GOV_POLICY_APPLICABLE_STATE WHERE POLICY_ID = ? AND STATE = ?";
    ...
    public static final String GET_STATES_BY_POLICY_ID =
            "SELECT STATE FROM GOV_POLICY_APPLICABLE_STATE WHERE POLICY_ID = ?";
    ...
    public static final String GET_POLICIES_BY_LABEL_AND_STATE =
            "SELECT DISTINCT GOV_POLICY.POLICY_ID " +
                    ...
                    "LEFT JOIN GOV_POLICY_APPLICABLE_STATE ON GOV_POLICY.POLICY_ID = GOV_POLICY_APPLICABLE_STATE.POLICY_ID " +
                    "WHERE GOV_POLICY_LABEL.LABEL = ? " +
                    "AND GOV_POLICY_APPLICABLE_STATE.STATE = ? " +
