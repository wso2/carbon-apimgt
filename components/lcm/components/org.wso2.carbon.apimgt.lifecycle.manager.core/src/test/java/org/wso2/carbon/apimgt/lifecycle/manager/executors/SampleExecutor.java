...
public class SampleExecutor implements Executor {
    ...
    private static Log log = LogFactory.getLog(SampleExecutor.class);
    ...
    @Override public boolean execute(Object resource, String currentState, String targetState) {
        ManagedLifecycleImpl apI = (ManagedLifecycleImpl) resource;
        for (InputBean inputBean : apI.getCurrentLifecycleState().getInputBeanList()) {
