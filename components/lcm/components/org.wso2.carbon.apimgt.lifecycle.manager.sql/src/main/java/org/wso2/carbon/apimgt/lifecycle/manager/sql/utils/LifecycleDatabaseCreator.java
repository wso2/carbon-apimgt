...
public class LifecycleDatabaseCreator {
    ...
    private static Log log = LogFactory.getLog(LifecycleDatabaseCreator.class);
    Statement statement;
     ...
     */
    private static String getDatabaseType(Connection conn) throws SQLException, LifecycleManagerDatabaseException {
        String type = null;
     ...
     *
     * @throws LifecycleManagerDatabaseException   If error occurs during database creation.
     */
    public void createLifecycleDatabase() throws LifecycleManagerDatabaseException {
        if (!isDatabaseStructureCreated()) {
            ...
            try {
                ...
                String msg = "Failed to create database tables for Lifecycles. " + e.getMessage();
                log.error(msg, e);
                throw new LifecycleManagerDatabaseException(msg, e);
            } finally {
                try {
                    if (conn != null) {
                        conn.close();
    ...
    private void executeSQL(String sql) throws LifecycleManagerDatabaseException {
        ...
        try {
            ...
            if (e.getSQLState().equals("X0Y32") || e.getSQLState().equals("42710")) {
                ...
                throw new LifecycleManagerDatabaseException("Error occurred while executing : " + sql, e);
            }
        } finally {
            if (resultSet != null) {
                try {
