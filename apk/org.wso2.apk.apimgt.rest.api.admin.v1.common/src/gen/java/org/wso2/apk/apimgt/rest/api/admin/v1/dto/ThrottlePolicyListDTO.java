...
import org.wso2.apk.apimgt.rest.api.admin.v1.dto.PaginationDTO;
...
public class ThrottlePolicyListDTO   {
    ...
    private List<ThrottlePolicyDTO> list = new ArrayList<ThrottlePolicyDTO>();
  ...
  /**
   **/
  public ThrottlePolicyListDTO list(List<ThrottlePolicyDTO> list) {
    this.list = list;
    return this;
  }
  ...
  public void setList(List<ThrottlePolicyDTO> list) {
    this.list = list;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(count, throttlePolicyList.count) &&
        Objects.equals(list, throttlePolicyList.list) &&
