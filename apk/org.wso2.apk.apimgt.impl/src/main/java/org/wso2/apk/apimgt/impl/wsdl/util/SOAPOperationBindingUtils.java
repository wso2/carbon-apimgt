...
import org.wso2.apk.apimgt.impl.wsdl.model.WSDLOperationParam;
...
//            if (tenantDomain != null && !APIUtil.SUPER_TENANT_DOMAIN_NAME.equals(tenantDomain)) {
...
//    }
     ...
     * @return {@link WSDL11SOAPOperationExtractor}
