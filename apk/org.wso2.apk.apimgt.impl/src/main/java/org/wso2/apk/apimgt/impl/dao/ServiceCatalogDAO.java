...
import org.wso2.apk.apimgt.api.model.ServiceFilterParams;
...
public class ServiceCatalogDAO {
    ...
    public ServiceEntry getServiceByKey(String key, int tenantId) throws APIManagementException {
        try (Connection connection = APIMgtDBUtil.getConnection();
            ...
            handleExceptionWithCode("Error while executing SQL for getting service information", e,
                    ExceptionCodes.ERROR_RETRIEVE_SERVICE_INFORMATION);
        }
        return null;
    }
