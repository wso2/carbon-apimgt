...
public class PolicyDAOImpl implements PolicyDAO {
    ...
    private void addAPIPolicy(APIPolicy policy, Connection conn) throws SQLException {
        ...
        try (PreparedStatement policyStatement = conn.prepareStatement(addQuery,
            ...
            try (ResultSet resultSet = policyStatement.getGeneratedKeys()) { // Get the inserted POLICY_ID (auto incremented value)
    ...
    private boolean isPolicyExist(Connection connection, String policyType, String organization, String policyName)
        ...
        try {
            ...
            try (PreparedStatement isExistStatement = connection.prepareStatement(query)) {
    ...
    private void addPipeline(Pipeline pipeline, int policyID, Connection conn) throws SQLException {
        ...
        try (PreparedStatement conditionStatement = conn.prepareStatement(sqlAddQuery, new String[]{
            ...
            try (ResultSet rs = conditionStatement.getGeneratedKeys()) {
    ...
    private void addIPCondition(IPCondition ipCondition, int pipelineId, Connection conn) throws SQLException {
        ...
        try (PreparedStatement statementIPCondition = conn.prepareStatement(sqlQuery)) {
    ...
    private void addHeaderCondition(HeaderCondition headerCondition, int pipelineId, Connection conn)
        ...
        try (PreparedStatement psHeaderCondition = conn.prepareStatement(sqlQuery);){
    ...
    private void addQueryParameterCondition(QueryParameterCondition queryParameterCondition, int pipelineId,
        ...
        try (PreparedStatement psQueryParameterCondition = conn.prepareStatement(sqlQuery)) {
    ...
    private void addJWTClaimsCondition(JWTClaimsCondition jwtClaimsCondition, int pipelineId, Connection conn)
        ...
        try (PreparedStatement psJWTClaimsCondition = conn.prepareStatement(sqlQuery)) {
    ...
    private ArrayList<Pipeline> getPipelines(int policyId) throws APIManagementException {
        ...
        try (Connection connection = APIMgtDBUtil.getConnection()) {
            try (PreparedStatement pipelinesStatement =
                         connection.prepareStatement(SQLConstants.ThrottleSQLConstants.GET_PIPELINES_SQL)) {
                int unitTime = 0;
                int quota = 0;
                int pipelineId = -1;
                ...
                try (ResultSet resultSet = pipelinesStatement.executeQuery()) {
    ...
    private ArrayList<Condition> getConditions(int pipelineId) throws APIManagementException {
        ...
        boolean invert;
        try (Connection connection = APIMgtDBUtil.getConnection()){
            try (PreparedStatement conditionsStatement =
                         connection.prepareStatement(SQLConstants.ThrottleSQLConstants.GET_IP_CONDITIONS_SQL)) {
                conditionsStatement.setInt(1, pipelineId);
                try (ResultSet resultSet = conditionsStatement.executeQuery()) {
        ...
        try (Connection connection = APIMgtDBUtil.getConnection()) {
            ...
            try (PreparedStatement deleteStatement = connection.prepareStatement(query)) {
                ...
                if (deleteTierPermissionsQuery != null) {
                    try (PreparedStatement deleteTierPermissionsStatement = connection.prepareStatement(deleteTierPermissionsQuery)) {
                        deleteTierPermissionsStatement.setString(1, policyName);
                        deleteTierPermissionsStatement.setString(2, organization);
                        deleteTierPermissionsStatement.executeUpdate();
                    }
                }
                connection.commit();
            }
