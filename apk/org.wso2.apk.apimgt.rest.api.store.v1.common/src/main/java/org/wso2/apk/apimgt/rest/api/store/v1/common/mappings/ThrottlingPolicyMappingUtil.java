...
import org.wso2.apk.apimgt.rest.api.store.v1.dto.ThrottlingPolicyPermissionInfoDTO;
import org.wso2.apk.apimgt.api.model.Tier;
import org.wso2.apk.apimgt.impl.APIConstants;
import org.wso2.apk.apimgt.rest.api.common.RestApiCommonUtil;
import org.wso2.apk.apimgt.rest.api.common.RestApiConstants;
import org.wso2.apk.apimgt.rest.api.store.v1.dto.MonetizationInfoDTO;
...
/**
 * Utility class for throttlingPolicy related operations
 */
public class ThrottlingPolicyMappingUtil {
     ...
     */
    public static ThrottlingPolicyListDTO fromTierListToDTO(List<Tier> throttlingPolicyList, String policyLevel,
     ...
     */
    public static void setPaginationParams(ThrottlingPolicyListDTO tierListDTO, String tierLevel, int limit, int offset,
            int size) {
        ...
        if (paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_OFFSET) != null) {
            paginatedPrevious = RestApiCommonUtil.getTiersPaginatedURL(tierLevel,
                    paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_OFFSET),
                    paginatedParams.get(RestApiConstants.PAGINATION_PREVIOUS_LIMIT));
        }

        if (paginatedParams.get(RestApiConstants.PAGINATION_NEXT_OFFSET) != null) {
            paginatedNext = RestApiCommonUtil.getTiersPaginatedURL(tierLevel,
    ...
    public static ThrottlingPolicyDTO fromTierToDTO(Tier throttlingPolicy, String tierLevel) {
        ...
        if (MapUtils.isNotEmpty(monetizationAttributeMap)) {
            ...
            if (StringUtils.isNotBlank(monetizationAttributeMap.get(APIConstants.Monetization.FIXED_PRICE))) {
                ...
                monetizationInfoDTO.setPricePerRequest(
                        monetizationAttributeMap.get(APIConstants.Monetization.PRICE_PER_REQUEST));
    ...
    private static ThrottlingPolicyDTO.QuotaPolicyTypeEnum mapQuotaPolicyTypeFromModeltoDTO(String quotaPolicyType) {
        ...
        case PolicyConstants.REQUEST_COUNT_TYPE:
            return ThrottlingPolicyDTO.QuotaPolicyTypeEnum.fromValue(PolicyConstants.REQUEST_COUNT_TYPE.toUpperCase());
     ...
     */
    public static ThrottlingPolicyDTO setTierPermissions(ThrottlingPolicyDTO throttlingPolicyDTO,
            Tier throttlingPolicy) {
        ...
        if (throttlingPolicy.getTierPermission() == null || throttlingPolicy.getTierPermission()
                .getPermissionType() == null) {
