...
package org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings;
...
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIDefaultVersionURLsDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIEndpointURLsDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIInfoAdditionalPropertiesDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIListDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIMonetizationAttributesDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIMonetizationInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIOperationsDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APITiersDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIURLsDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.AdvertiseInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.PaginationDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.RatingListDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.ScopeInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.APIBusinessInformationDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.RatingDTO;
...
import org.wso2.apk.apimgt.impl.APIType;
...
//        }
        ...
        String apiTenant = APIUtil.getTenantDomain(APIUtil.replaceEmailDomainBack(model.getId().getProviderName()));
    ...
    private static APIEndpointURLsDTO fromAPIRevisionToEndpoints(APIDTO apidto, Environment environment, String host,
        ...
        boolean isGQLSubscription = StringUtils.equalsIgnoreCase(APIConstants.GRAPHQL_API,
                apidto.getType()) && isGraphQLSubscriptionsAvailable(apidto);
        if (!isWs) {
