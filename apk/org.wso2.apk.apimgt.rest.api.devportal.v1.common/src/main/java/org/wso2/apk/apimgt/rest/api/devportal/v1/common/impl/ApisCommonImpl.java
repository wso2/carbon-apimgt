...
import org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings.CommentMappingUtil;
...
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.DocumentDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.DocumentListDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.GraphQLQueryComplexityInfoDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.GraphQLSchemaTypeListDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.PaginationDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.PostRequestBodyDTO;
...
import org.wso2.apk.apimgt.rest.api.devportal.v1.dto.TopicListDTO;
import org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings.APIMappingUtil;
import org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings.AsyncAPIMappingUtil;
import org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings.DocumentationMappingUtil;
import org.wso2.apk.apimgt.rest.api.devportal.v1.common.mappings.GraphqlQueryAnalysisMappingUtil;
...
public class ApisCommonImpl {
    ...
    private static String getSwaggerForEnvironment(APIConsumer apiConsumer, API api, String environmentName)
            throws APIManagementException {
        return apiConsumer.getOpenAPIDefinitionForEnvironment(api, environmentName);
    }
